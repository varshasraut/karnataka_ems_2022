                ...
                if(empty($patientRecord)){
                    ...
                    if(!empty($patient)){
                        $this->response([
                            'data' =>  ([
                                ...
                                'bloodGroup' => ([
                                    'id' => isset($patient[0]['bldgrp_id']) ? (int) $patient[0]['bldgrp_id'] : (int) 0,
                                    'name' => isset($patient[0]['bldgrp_name']) ? $patient[0]['bldgrp_name'] : "",
                                ]),
                                'locId' => (int) 0,
                                'loc' => null,
                                ...
                                "ayushmanId" => $patient[0]['ayushman_id'],
                                "pcf" => isset($patient[0]['ptn_pcf_no']) ? $patient[0]['ptn_pcf_no'] : "",
                                'pcfRequired' => true
                            ]),
                            'error' => null
                    ...
                    $this->response([
                        'data' => ([
                            ...
                            'bloodGroup' => ([
                                'id' => isset($patientRecord[0]['bldgrp_id']) ? (int) $patientRecord[0]['bldgrp_id'] : (int) 0,
                                'name' => isset($patientRecord[0]['bldgrp_name']) ? $patientRecord[0]['bldgrp_name'] : "",
                            ]),
                            ...
                            "ayushmanId" => $patientRecord[0]['ayushman_id'],
                            "pcf" => isset( $patientRecord[0]['ptn_pcf_no']) ?  $patientRecord[0]['ptn_pcf_no'] : "",
                            'pcfRequired' => true
                        ]),
                        'error' => null
                    ],REST_Controller::HTTP_OK);
