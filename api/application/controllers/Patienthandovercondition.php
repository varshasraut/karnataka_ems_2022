...
class Patienthandovercondition extends REST_Controller {
    ...
    public function index_post(){
        if(isset($_COOKIE['cookie'])){
	        ...
	        $data['hc_con_circulation_radial'] = $this->post('hcCirRadial');
            $data['hc_con_circulation_carotid'] = $this->post('hcCirCarotid');
            $data['hc_con_circulation_brachial'] = $this->post('hcCirBrachial');
            $data['hc_con_rr'] = $this->post('hcRR');
	        $data['hc_cardiac'] = $this->post('hcCardiac');
            $data['hc_cardiac_time'] = $this->post('hcCardiacTime');
