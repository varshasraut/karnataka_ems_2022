                ...
                if($chklogindata == 1 || (empty($deviceIdLogin))){
                    ...
                    if(!empty($hanover)){
                        if(isset($hanover[0]['hc_con_gcs'])){
                            ...
                            $cgs['id'] = (int) $hanover[0]['ini_con_gcs'];
                            $cgs['name'] = (string) $hanover[0]['ini_con_gcs'];
                        }
                        ...
                        $this->response([
                            'data' => ([
                                ...
                                "hcConBsl" => isset($hanover[0]['hc_con__bsl']) ? $hanover[0]['hc_con__bsl'] : $hanover[0]['ini_con_bsl'], 
                                "hcConGcs" => $cgs,
                    "hcCirRadial" => ($hanover[0]['hc_con_circulation_radial'] == '') ? $hanover[0]['ini_con_circulation_radial'] : $hanover[0]['hc_con_circulation_radial'],
                                "hcCirCarotid" => ($hanover[0]['hc_con_circulation_carotid'] == '') ? $hanover[0]['ini_con_circulation_carotid'] : $hanover[0]['hc_con_circulation_carotid'],
                                "hcCirBrachial" => ($hanover[0]['hc_con_circulation_brachial'] == '') ? $hanover[0]['ini_con_circulation_brachial'] : $hanover[0]['hc_con_circulation_brachial'],
                                "hcRR" => ($hanover[0]['hc_con_rr'] == '') ? (int) $hanover[0]['ini_con_rr'] : (int) $hanover[0]['hc_con_rr'],
                    "hcCardiac" => ($hanover[0]['hc_cardiac']) ? $hanover[0]['hc_cardiac'] : null,
                                "hcCardiacTime" => ($hanover[0]['hc_cardiac_time']) ? $hanover[0]['hc_cardiac_time'] : null,
                                "hcdelInAmbPhoto" => ($hanover[0]['deliv_in_amb_take_photo']) ? true : false,
                            ]),
                            'error' => null
