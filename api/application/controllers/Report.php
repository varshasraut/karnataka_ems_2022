...
class Report extends REST_Controller {
    ...
    public function index_post(){
        ...
        //   }
          ...
          if($chkUploadImg == "true") {
            $imageFlag = false;
            $imageData =  $this->processImagesData($mainDir,$incidentId,$remark,$patientId);
    ...
    public function processImagesData($mainDir,$incidentId,$remark,$patientId) {
        ...
        // if($chkUploadImg == "true"){
          ...
          if(sizeof($errors)==0)
          {
            ...
            for ($i = 0; $i < $number_of_files; $i++) {
              ...
              $image = $incidentId."_".date('Y_m_d_H_i_s_') . $i . "." . $ext[1];
