...
// Authentication
class Supervisory_Logout extends REST_Controller {
    ...
    public function index_post(){
        ...
        $auth = $this->Supervisory_Login_model->checkLoginUserforAuth($data);
        if($auth == 1){
            $log = $this->Supervisory_Login_model->logoutUser($data);
            if($log == 1){
                $this->response([
                    'data' => ([
                        'code' => 1,
