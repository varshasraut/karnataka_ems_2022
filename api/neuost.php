...
$serverName = $_SERVER['HTTP_HOST'];
	    ...
	    if($serverName == '10.108.1.67'){
                $NeousURL = 'http://10.108.1.85:1111/api/ERCDash/PostData';
            }else if($serverName == '210.212.165.124'){
...
$out = mi_curl_request('http://10.108.1.85:1111/api/ERCDash/PostData', $args);
var_dump($out);
die();