                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            ...
                            <a href="#" style="text-decoration: none;"><i class="fa fa-circle text-success"></i> Online</a>
                        </div>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                         ...
                         <li>
                            <a href="<?php echo base_url()?>app/dashboard" style="text-decoration: none;">
                        ...
                        <li>
                            ...
                            <i class="fa fa-road"></i> <span>Book Now</span>
                            </a>
                        </li>  
                        <li <?php echo $editprofile_mod;?>><a href="<?php echo base_url()?>myprofile/editprofile"><i class="fa fa-user"></i>Add User</a></li>
                        <li <?php echo $editprofile_mod;?>><a href="<?php echo base_url()?>myprofile"><i class="fa fa-list"></i>User List</a></li>
