            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()?>app/patient/addPatient">Past Trip List</a></li>
                                        ...
                                        <div class="box-body table-responsive">
                                            <form>
                                                <div class="form-row">
                                                    ...
                                                    <input type="text" name="cust_name" class="form-control" id="inputEmail4" placeholder="Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Email:</label>
                                                    <input type="email" name="cust_email" class="form-control" id="inputPassword4" placeholder="Email">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Address:</label>
                                                    <textarea class="form-control" name="cust_add" rows="1" placeholder="City / State / Country"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Contact Number:</label>
                                                    <input type="number" name="cust_num" class="form-control" id="inputPassword4" placeholder="Contact Number">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Select Cab:</label>
                                                    <select class="form-control" name="cab" id="inlineFormCustomSelect">
                                                        <option selected>Choose...</option>
                                                        <option value="1">One</option>
                                                        <option value="2">Two</option>
                                                        <option value="3">Three</option>
                                                    ...
                                                    <label for="inputPassword4">No. Of Child:</label></br>
                                                    ...
                                                    <input type="number" class="form-control" id="inputPassword4" placeholder="Contact Number">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Select Drop Location:</label>
                                                    <input type="text" class="form-control" id="inputPassword4" placeholder="Contact Number">
                                                    </div>
                                                </div>
