...
class Editinspection extends REST_Controller {
    ...
    public function secondEditInspFormMainVeh_post(){
        ...
        if($auth == 1){
			...
			$video = 'http://irts.jaesmp.com/JAEms/inspection_api/insp_upload_file/'.$data1->upload_video_path;
                    }else{
                        $video = "";
                    }
                    if($data1->upload_img_path != '' || $data1->upload_img_path != null){
                        $img = 'http://irts.jaesmp.com/JAEms/inspection_api/insp_upload_file/'.$data1->upload_img_path;
                    }else{
                        $img = "";
                    }
                    $this->response([
                        'data' => [
                            'dateOfMaintenance' => isset($data1->ins_main_date) ? date('Y-m-d',strtotime($data1->ins_main_date)) : "",
        ...
        if($auth == 1){
            ...
            if(!empty($data)){
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            'ins_clean_date' => isset($data1->ins_clean_date) ? date('Y-m-d',strtotime($data1->ins_clean_date)) : "",
        ...
        if($auth == 1){
            ...
            if(!empty($data)){
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            'ac_working_date' => isset($data1->ac_working_date) ? date('Y-m-d',strtotime($data1->ac_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'tyre_working_date' => isset($data1->tyre_working_date) ? date('Y-m-d',strtotime($data1->tyre_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'siren_working_date' => isset($data1->siren_working_date) ? date('Y-m-d',strtotime($data1->siren_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'inv_working_date' => isset($data1->inv_working_date) ? date('Y-m-d',strtotime($data1->inv_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'batt_working_date' => isset($data1->batt_working_date) ? date('Y-m-d',strtotime($data1->batt_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'gps_working_date' => isset($data1->gps_working_date) ?  date('Y-m-d',strtotime($data1->gps_working_date)) : "",
                ...
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            ...
                            'ins_pcs_stock_date' => isset($data1->ins_pcs_stock_date) ? date('Y-m-d',strtotime($data1->ins_pcs_stock_date)) : "",
        ...
        if($auth == 1){
            ...
            if(!empty($data)){
                foreach($data as $data1){
                    ...
                    $this->response([
                        'data' => [
                            'ins_sign_attnd_date' => isset($data1->ins_sign_attnd_date) ? date('Y-m-d',strtotime($data1->ins_sign_attnd_date)) : "",
    ...
    public function tweleInspFormMedicineEdit_post(){
        ...
        if($auth == 1){
            ...
            $med_List = $this->Common_model->getmedicine($medTypeId);
            // print_r($med_List);
            if(isset($med_List)){
    ...
    public function thirteenInspFormEquipmentEdit_post(){
        ...
        if($auth == 1){
            ...
            $eqp_List = $this->Common_model->getequipment($eqpTypeId);
            //print_r($eqpData);
            if(isset($eqp_List)){
