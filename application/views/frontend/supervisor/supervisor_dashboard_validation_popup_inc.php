                                        ...
                                        <div class="width100 float_left">
                                            ...
                                            <div class="width20  float_left">
                                             ...
                                             <?php  if ($value=="1"){
                                                 ...
                                                 <input type="button" class="search_button float_right  mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=0_2&amp;search_empty=empty"/>
                                             </div> 
                                               <?php 
                                                } else if ($value=="2"){
                                                    ?>
                                                    <div class="width_11 float_left">
                                                    <input type="button" class="search_button float_right mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=2_6&amp;search_empty=empty"/>
                                                </div> 
                                                  <?php 
                                                   } else if ($value=="3"){
                                                    ?>
                                                    <div class="width_11 float_left">
                                                    <input type="button" class="search_button float_right mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=6_12&amp;search_empty=empty"/>
                                                </div> 
                                                  <?php 
                                                   } else if ($value=="4"){
                                                    ?>
                                                    <div class="width_11 float_left">
                                                    <input type="button" class="search_button float_right mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=12_18&amp;search_empty=empty"/>
                                                </div> 
                                                  <?php 
                                                   } else if ($value=="5"){
                                                    ?>
                                                    <div class="width_11 float_left">
                                                    <input type="button" class="search_button float_right mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=18_24&amp;search_empty=empty"/>
                                                </div> 
                                                  <?php 
                                                   } else if ($value=="6"){
                                                    ?>
                                                    <div class="width_11 float_left">
                                                    <input type="button" class="search_button float_right mainbtn2 form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/validation_pending_popup" data-qr="output_position=popup_div&amp;flt=true&amp;type=inc&amp;filter_time=24_more&amp;search_empty=empty"/>
                                                </div> 
                                                  <?php 
                                                   }?>
                        ...
                        <div id="list_table">
                            ...
                            <table class="table report_table tblclr table-responsive">
                                <tr>      
                                    ...
                                    <th nowrap>validation Pending From</th>
                                    ...
                                    foreach ($result as $key => $inc) {
                                        ...
                                        <tr>
                                            ...
                                            <a class="click-xhttp-request onpage_popup float_left btn" data-href="{base_url}supervisor/release?amb_rto_register_no=<?php echo $inc->amb_rto_register_no; ?>&inc_ref_id=<?php echo $inc->inc_ref_id; ?>" data-qr="output_position=popup_div" data-popupwidth="300" data-popupheight="300">Release</a>
                                                <?php } ?>
                                            <a class="click-xhttp-request btn float_left" data-href="{base_url}inc/show_amb_val_pending" data-qr="output_position=popup_div&amb_reg_no=<?php echo $inc->amb_rto_register_no;?>&filter_time=<?php echo $filter_time; ?>">Pending</a>         
