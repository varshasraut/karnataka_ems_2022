                    ...
                    <div class="row">
                        <div class="sub_header_top_link">
                            ...
                            <ul id="sub_incedence_steps">
                                <li class='active_sub_supervisor_nav'>
                                    <a class="click-xhttp-request "  href="{base_url}supervisor/police_incident_calls" data-qr="output_position=content">Incident Call</a>
                                </li>
                                <li>
                                    <a class="click-xhttp-request"  href="{base_url}supervisor/police_manual_calls" data-qr="output_position=content">Manual Call</a>
                                </li>
                            ...
                            <div class="row">
                                ...
                                <div class="width100 float_left">
                                    ...
                                    <div class="width_40 float_left">
                                        ...
                                        <input type="button" class="search_button  form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/police_incident_calls" data-qr="output_position=content&amp;flt=true&amp;type=inc" />
                                        <input name="" value="Reset Filters" data-href="{base_url}supervisor/police_dispatch" data-qr="output_position=content&amp;filters=reset" type="button" tabindex="3" autocomplete="off" class="search_button click-xhttp-request">
                                    </div>
                        ...
                        if (count(@$inc_info) > 0) {
                            ...
                            foreach ($inc_info as $key => $inc) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ucwords($inc->pc_added_by); ?></td>
