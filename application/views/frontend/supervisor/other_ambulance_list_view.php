                        ...
                        <div class="row">
                            ...
                            <div class="width100 float_left">
                                <div class="width20 float_left">
                                    <h3 class="txt_clr2 ">Off-road Ambulance List</h3>
                                </div>
                                <div class="width20 float_left">
								...
								<div class="width20 float_left">
                                    <input name="amb_no_search_other" class="mi_autocomplete dropdown_per_page width97" data-href="{base_url}auto/get_ambulance" placeholder="Select Ambulance" data-errors="{filter_required:'Please select state from dropdown list'}" tabindex="15" autocomplete="off" value="<?php echo $amb_reg_no; ?>" data-value="<?php echo $amb_reg_no; ?>">
                                    <input type="hidden" name="req_type" value="amb">
                                </div>

                                <div class="width_17 float_left">
                                    <input type="button" class="search_button float_right  form-xhttp-request" name="" value="Search" data-href="{base_url}supervisor/other_ambulance_list" data-qr="output_position=content&amp;flt=true&amp;type=inc" />
                                </div>
                    ...
                    if (count($result) > 0) {
                        ...
                        foreach ($result as $key => $inc) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $inc->mt_offroad_reason; ?> </td>   
                    ...
                    <div class="width33 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}supervisor/other_ambulance_list" data-qr="output_position=content&amp;flt=true&amp;type=inc">
