<div class="width100">                
    ...
    <div class="login_inner_box">                          
        ...
        <form action='#' method='post' class='break_form' id="break_function">                
            ...
            <div class="field_row">
                    ...
                    <div class="filed_input  ">
                       ...
                       <textarea name="supervisor_remark" class="form_input filter_required" rows="3"  data-errors="{filter_required:'Supervisor Remark should not be blank!'}" style="text-transform: lowercase;"><?= $medadv_info[0]->adv_cl_addinfo; ?></textarea>
                    </div>
        ...
        <div class="text_align_center button_box">                 
                            <input type="button" name="submit" value="Submit" class="btn submit_btnt form-xhttp-request" data-href='{base_url}supervisor/save_remark' data-qr='output_position=content'  TABINDEX="2" id="<?php echo @$current_data[0]->clg_ref_id; ?>">
