...
<div class="inline_fields width100">
    ...
    <div class="form_field width15">
        ...
        <input name="inc_id" tabindex="7" id="cinc_id" class="form_input inc_id_filt filter_required" placeholder="Incident Id" type="text" data-base="search_btn" data-errors="{filter_required:'Incident Id should not be blank'}">
...
<!--            <span class="md_field">*</span>-->
    ...
    <div class="form_field width_20">
        ...
        <input name="search_btn"  tabindex="12" value="SEARCH" class="base-xhttp-request common_search width40 mt-0" style="float:left;" data-href="{base_url}grievance/grivience_pt_inc_list" data-qr="output_position=inc_details" type="button">

        <input name="reset_filter" tabindex="19" value="RESET FILTER" class=" click-xhttp-request  width50 float_right mt-0" data-href="{base_url}grievance/show_inc_search" data-qr="output_position=inc_details&amp;filter=true" type="reset" style="font-weight: bold; margin-top: 5px;" autocomplete="off">
