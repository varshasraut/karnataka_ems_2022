        ...
        foreach ($pt_details as $pet) {
            ...
            <tr>
                ...
                <td id="incact">
                    ...
                    <input name="select" class="form-xhttp-request inc_act<?php echo $pet->inc_ref_id; ?> incact" data-href="{base_url}grievance/gr_manual_inc_info" data-qr="inc_ref_id=<?php echo $pet->inc_ref_id; ?>&amp;cl_purpose=<?php echo $cl_purpose; ?>&amp;freq=true" value="SELECT" type="button">
