...
<div class="width100" >
    <div class="header_top_link">
        ...
        <ul id="incedence_steps">
            <li class='active_supervisor_nav'><a class="click-xhttp-request "  href="{base_url}grievance/grievance_pre_inc_calls" data-qr="output_position=content&amp;filters=reset"> Incident Calls</a></li>
            <li><a class="click-xhttp-request"  href="{base_url}grievance/grievance_manual_calls" data-qr="output_position=content&amp;filters=reset">Manual Calls</a></li>
...
//                                    }
                            ...
                            <div class="float_left">
                                <input type="button" class="search_button float_left form-xhttp-request" name="" value="Search" data-href="{base_url}grievance" data-qr="output_position=content&amp;flt=true" />  
                                <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}grievance" data-qr="output_position=content&amp;filters=reset" type="button">
                            </div>
                        </div>
                                ...
                                <table class="table report_table">
                                    ...
                                    if (count(@$inc_info) > 0) {
                                        ...
                                        foreach ($inc_info as $key => $inc) {
                                            ...
                                            $caller_name = ucwords($inc->clr_fname . "  " . $inc->clr_lname);
...
<!--                                                <td ><a href="{base_url}calls/single_record_view" class="onpage_popup" data-qr="output_position=popup_div&inc_ref_id=<?php echo $inc->gc_pre_inc_ref_id; ?>" style="color:#000;"><?php echo $inc->gc_pre_inc_ref_id; ?></a></td>-->
                                                <td ><?php echo $inc->gc_pre_inc_ref_id; ?></a></td>
