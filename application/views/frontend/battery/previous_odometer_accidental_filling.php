...
<div class="width2 float_left">
    ...
    <div class="filed_input float_left width50" >
        ...
        <input type="text" name="in_odometer" value="" class="filter_required filter_rangelength[<?php echo $previous_odometer;?>-<?php echo $previous_odometer+300;?>] filter_maxlength[7] filter_number" id="end_odometer" onkeyup="sum();"placeholder="Current Odometer" data-errors="{filter_required:'In odometer should not be blank',filter_valuegreaterthan:'Current Odometer should greater than or equal Previous Odometer' ,filter_maxlength:'Previous Odometer at max 6 digit long.',filter_number:'number shuold be integer',filter_rangelength:'END Odometer between range  <?php echo $previous_odometer ?> - <?php echo $previous_odometer+300; ?>'}" TABINDEX="8">
    </div>
</div>
<div class="width2 float_left">
