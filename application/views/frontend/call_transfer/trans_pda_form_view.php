<div class="call_purpose_form_outer">
    ...
    <!-- <h3>Call Transfer to PDA</h3> -->
    <label class="headerlbl">Call Transfer to PDA</label>
    ...
    <form method="post" name="complnt_call_form" id="complnt_form">
       ...
       <input type="hidden" name="caller_id" id="caller_id" value="<?php echo $caller_id; ?>">
        ...
        <input type="hidden" name="incient[inc_type]" id="inc_type" value="TRANS_PDA">
        ...
        <div class="width100 float_left">
            ...
            <div class=" width2 form_field ">
                ...
                <div class=" float_left width75">
                    ...
                    <select  id="pda_standard" name="rcl_standard"  class=" filter_required "  data-errors="{filter_required:'Please select Standard from dropdown list'}">
                        <option value="" >Select</option>
                        <!--<option value="address_the_complaint">Addressed the complaint & case closed</option>-->
                        <option value="forword_to_pda">Forward to PDA for further action</option>
                    </select>   
                </div>
    ...
    <div class="width2 form_field float_left ">
        ...
        <div class="width75 float_left">
            ...
            <textarea style="height:60px;" id="sum" class="filter_required width_100" name="incient[inc_ero_summary]" placeholder="ERO Summary" data-errors="{filter_required:'Please select ERO Summary from dropdown list'}" data-callback-funct="ero_standard_summary_change" TABINDEX="8" ></textarea>
        </div>
    ...
    <div class="width2 form_field float_left">
        ...
        <div class=" float_left width75" id="ero_summary_other">
            <textarea style="height:60px;" name="incient[inc_remark]" class="width_100 " TABINDEX="16" data-maxlen="1600"  data-errors="{filter_required:'ERO Note should not be blank'}"><?= @$inc_details['inc_remark']; ?></textarea>
        </div>
    </div>
        ...
        <div class="button_field_row beforeunload text_align_center" style="width: 300px; margin: 0 auto;" id="problem_reporting_call">
            ...
            <div class="button_box enquiry_button">
                ...
                <div class="forward_button hide">
                    <input name="fwd_btn" value="FORWARD TO PDA" class="style4 form-xhttp-request" data-href="{base_url}trans_call/confirm_pda_save" data-qr="forword=yes" type="button" tabindex="8" style="position: relative;">
                </div>
                <div class="save_button hide">
                    <input name="fwd_btn" value="Save" class=" form-xhttp-request" data-href="{base_url}trans_call/confirm_pda_save" data-qr="forword=no" type="button" tabindex="8" style="position: relative;">
                </div>
