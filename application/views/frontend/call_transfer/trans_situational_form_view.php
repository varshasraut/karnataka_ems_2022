...
<label class="headerlbl">Call Transfer To Situational Desk</label>
    <!-- <h3>Call Transfer to Situational Desk</h3> -->
    ...
    <form method="post" name="complnt_call_form" id="complnt_form">
       ...
       <input type="hidden" name="caller_id" id="caller_id" value="<?php echo $caller_id; ?>">
        ...
        <input type="hidden" name="incient[inc_type]" id="inc_type" value="TRANS_SITUATIONALDESK">
        ...
        <div class="width100 float_left">
            ...
            <div class=" width2 form_field ">
                ...
                <div class=" float_left width75">
                    ...
                    <select  id="situational_standard" name="rcl_standard"  class=" filter_required "  data-errors="{filter_required:'Please select Standard from dropdown list'}">
                        <option value="" >Select</option>
                        <!--<option value="address_the_complaint">Addressed the complaint & case closed</option>-->
                        <option value="forword_to_situational">Forward to Situational for further action</option>
                    </select>
        ...
        <div class="button_field_row beforeunload text_align_center" style="width: 300px; margin: 0 auto;" id="problem_reporting_call">
            ...
            <div class="button_box enquiry_button">
                ...
                <div class="forward_button hide">
                    <input name="fwd_btn" value="FORWARD TO SITUATIONAL DESK" class="style4 form-xhttp-request" data-href="{base_url}trans_call/confirm_situational_save" data-qr="forword=yes" type="button" tabindex="8" style="position: relative;">
                </div>
                <div class="save_button hide">
                    <input name="fwd_btn" value="Save" class=" form-xhttp-request" data-href="{base_url}trans_call/confirm_situational_save" data-qr="forword=no" type="button" tabindex="8" style="position: relative;">
                </div>
