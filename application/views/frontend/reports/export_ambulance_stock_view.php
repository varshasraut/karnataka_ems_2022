        ...
        <div class="field_row float_left width75">
            ...
            <div class="filed_select">
                <div class="width30 drg float_left">
                 ...
                 <div class="width30 drg float_left">
                    <div class="width100 float_left">
                        <div class="style6 float_left">Ambulance : </div>
                    </div>
                    <div class="width100 float_left">
                        <select name="amb_reg_id" class="dropdown_per_page" data-base="search" >
                            <option value="">Select Ambulance</option>
                            <?php foreach ($amb_list as $amb) { ?>
                                <option value="<?php echo $amb->amb_rto_register_no ?>" <?php if ($sortby == $amb->amb_rto_register_no) {
                                echo 'selected';
