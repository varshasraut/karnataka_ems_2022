...
<div class="width_25 float_right" style="margin-bottom: 10px;">
            <div class="button_field_row">
                <div class="button_box">
                    <form action="<?php echo base_url(); ?>tdd_reports/ambulance_stock_report" method="post" enctype="multipart/form-data" target="form_frame">
                        <input type="hidden" value="<?php echo $report_args['from_date'];?>" name="from_date">
                        <input type="hidden" value="<?php echo $report_args['to_date'];?>" name="to_date">
                        <input type="hidden" value="<?php echo $report_args['inv_amb'];?>" name="amb_reg_id">
...
<div class="box3">    
        <table class="table report_table">
            ...
            <tr style="line-height: 25px;">
                <th>Name of Consumables</th>
                <th>Expected Stock</th>
                <th>Opening stock-48 Ambulances</th>
