            ...
            <div class="width100 float_left">                   
                ...
                <div class="search">
                    ...
                    <div class="row">
                        ...
                        <div class="width100 float_left">
                            <div class="width100 float_left">
                                <h3 class="txt_clr2 ">Escalation Call Details</h3>
                            </div>
                            <?php if($clg_senior){?>
                            ...
                            <div class="width20 float_left">
                                ...
                                <input type="button" class="search_button float_left form-xhttp-request" name="" value="Search" data-href="{base_url}escalation_calls" data-qr="output_position=content&amp;flt=true&amp;type=inc" />
                                
                                 <input type="reset" class="search_button float_left form-xhttp-request" name="" value="Reset Filter" data-href="{base_url}escalation_calls" data-qr="output_position=content&amp;flt=reset&amp;type=inc" />
...
//                        }
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="click-xhttp-request btn" data-href="{base_url}escalation_calls/view_escalation_call" data-qr="output_position=popup_div&amp;module_name=eme_professional_call&amp;ref_id=<?php echo $inc->inc_ref_id; ?>&amp;action=view">View</a>
                            </td>
                ...
                <div class="width33 float_right">
                    ...
                    <div class="record_per_pg">
                        ...
                        <div class="per_page_box_wrapper">
                            ...
                            <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}escalation_calls" data-qr="output_position=content&amp;flt=true&amp;type=inc">
