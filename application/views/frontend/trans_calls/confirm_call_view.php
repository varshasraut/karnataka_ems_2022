...
<div class="box_head text_align_center width100">
    <h3 class="txt_pro">CALL TRANSFER TO 104</h3>
</div>
...
<div class="confirm_save width100">
    ...
    <div class="save_btn_wrapper float_left beforeunload ">
        ...
        <form name="com_call_fwd" method="post" id="">
            ...
            <input name="" value="SAVE" class="accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>transfercall/save" data-qr="output_position=content" type="button" tabindex="15">
