            ...
            <div class="width100">
                ...
                <div class="field_row width100">
                    <div class="width2 float_left">
                        ...
                        <div class="filed_input float_left width50">
                            ...
                            <?= @$fuel_station[0]->f_station_name ?>

                        </div>
                    </div>   <div class="width2 float_left">
                        <div class="field_lable float_left width33 strong"> <label for="co_orportion">Oil Corporation</label></div>

                        <div class="filed_input float_left width50">
                            <?= @$fuel_station[0]->f_oil_co_orportion; ?>
                        </div>
                    </div>
                </div>
                <div class="field_row width100">
                ...
                <div class="field_row width100">
                    <div class="width2 float_left">
                        ...
                        <div class="filed_input float_left width50">
                            ...
                            <?php
                            if (@$fuel_station[0]->f_is_active == '0') {
                                echo 'Active';
                            } else {
                                echo 'Inactive';
                            }
                    ...
                    <div class="width2 float_left">
                        ...
                        <div class="filed_input float_left width50">
                            <?= @$fuel_station[0]->f_station_mobile_no; ?>
                ...
                <div class="field_row width100">
                    <div class="width2 float_left">
                        ...
                        <div class="filed_input float_left width50">
                            <?= @$fuel_station[0]->f_contact_person; ?>
