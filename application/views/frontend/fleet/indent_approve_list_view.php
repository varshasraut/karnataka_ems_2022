...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Indent Approve</span></li>
    </ul>
</div>

<div class="width2 float_right">

    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}fleet/indent_approve" data-qr="output_position=content&amp;ind_filters=reset" type="button">
 ...
 <div id="date_filter"></div>
                                <div class="filed_input float_left width_25">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search_btn1" value="Search" class="btn clg_search form-xhttp-request mt-0" data-href="{base_url}fleet/indent_approve" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                            ...
                                            <li><a class="onpage_popup action_button" data-href="{base_url}ind/view_ind_details" data-qr="output_position=popup_div&amp;ind_emt_id=<?php echo base64_encode($indent_data->req_emt_id); ?>&amp;req_id=<?php echo base64_encode($indent_data->req_id); ?>&amp;action=view&amp;req_type=<?php echo $indent_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">View</a></li>

                                            <?php // } ?>

                                            <?php
                                            if ($dispatch != '' && $indent_data->req_dis_by == '' && (@$clg_group == 'UG-ADMIN' || @$clg_group == 'UG-SupplyChainManage') && $indent_data->req_is_approve == 1) {
                                                ?>
                                            ...
                                            if ($receive != '' && $indent_data->req_dis_by != '' && $indent_data->req_rec_by == '' && $indent_data->req_is_approve == 1) {
                                                ...
                                                <li><a class="onpage_popup action_button" data-href="{base_url}ind/view_ind_details" data-qr="output_position=popup_div&amp;req_id=<?php echo base64_encode($indent_data->req_id); ?>&amp;amb_no=<?php echo base64_encode($indent_data->req_amb_reg_no); ?>&amp;action=rec&amp;req_type=<?php echo $indent_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">Receive</a></li>

                                            <?php } ?>
                                            <?php
                                            if (($clg_group != 'UG-EMT'  ) && $indent_data->req_is_approve == '0') {
                                                ?>


                                                <li><a class="onpage_popup action_button" data-href="{base_url}ind/view_ind_details" data-qr="output_position=popup_div&amp;req_id=<?php echo base64_encode($indent_data->req_id); ?>&amp;amb_no=<?php echo base64_encode($indent_data->req_amb_reg_no); ?>&amp;action=apr&amp;req_type=<?php echo $indent_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">Approve</a></li>
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}fleet/indent_approve" data-qr="output_position=content&amp;flt=true">
