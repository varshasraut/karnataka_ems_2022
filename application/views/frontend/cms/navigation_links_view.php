                                ...
                                <td>
                                    <div class="user_action_box">
                                        ...
                                        ?>   
                                            ...
                                            <li>
                                                <a data-confirmmessage="Are you sure to delete ?" data-confirm="yes" data-qr="output_position=content&id=<?= $link->lnk_id; ?>&nav_id=<?= $navigation_id ?>&delete_links=true" data-href="{base_url}ms-admin/cms/view_navigation_links" class="click-xhttp-request">Delete</a>
                                            </li>
                                        ...
                                        ?>   
                                            ...
                                            <li>
                                                <a data-qr="output_position=content&nav_id=<?= $navigation_id ?>&lnk_id=<?= $link->lnk_id; ?>" data-href="{base_url}ms-admin/cms/update_navigation_links" class="click-xhttp-request">Edit</a>
                                            </li>
