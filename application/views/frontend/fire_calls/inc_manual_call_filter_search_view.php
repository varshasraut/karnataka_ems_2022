...
<div class="width100 float_left" >
    ...
    <input type="hidden"  name="caller[mc_caller_id]" value="<?= @$caller_details->clr_id?>">
      <input type="hidden" name="caller[mc_attend_call_time]" value="<?php echo date('Y-m-d H:i:s', strtotime($attend_call_time));  ?>">
    <div class="save_btn_wrapper">
        <input name="caller" value="SUBMIT" class="style5 form-xhttp-request" data-href="{base_url}fire_calls/save_manual_fire" data-qr="" type="button" tabindex="16">
