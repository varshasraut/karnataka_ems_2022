                                    ...
                                    <div class="width100 float_left">
                                        ...
                                        <div class="filed_input float_left width_20">
                                            <label for="search_clg">
                                                <input type="button" name="search" value="Search" class="btn clg_search form-xhttp-request mt-0" data-href="{base_url}fire_calls/f_manual_call" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                            </label>
                                        </div>
                                </div>
                            </div>
                                            ...
                                            foreach ($inc_info as $key => $inc) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td ><?php echo ($inc->fi_ct_name); ?></td>
                                                     <td ><?php echo ($inc->fc_added_by); ?></td>
                                                        ...
                                                        <div class="user_action_box fire_calls">
                                                            ...
                                                            <!--
                                                                                                                        <ul class="profile_actions_list">
                                                                                                                            <li><a class="onpage_popup action_button" data-href="{base_url}fire_calls/fire_manual_records_view" data-qr="output_position=content&amp;module_name=clg&amp;tlcode=MT-CLG-EDIT&amp;fc_inc_ref_id=<?php echo base64_encode($inc->fc_inc_ref_id) ?>&amp;inc_ref_id=<?php echo base64_encode($inc->fc_pre_inc_ref_id) ?>&amp;action=view_data&amp;action_type=View"  data-popupwidth="1000" data-popupheight="700">View</a></li>          
                                                            ...
                                                            <ul class="profile_actions_list">
                                                                ...
                                                                <?php if ($inc->fc_is_close != '1') { ?>
                                                                    <li><a class="onpage_popup action_button" data-href="{base_url}fire_calls/fire_manual_records_view" data-qr="output_position=content&amp;module_name=clg&amp;tlcode=MT-CLG-EDIT&amp;fc_inc_ref_id=<?php echo base64_encode($inc->fc_inc_ref_id) ?>&amp;inc_ref_id=<?php echo base64_encode($inc->fc_pre_inc_ref_id) ?>&amp;action=view_data&amp;action_type=Update"  data-popupwidth="1000" data-popupheight="700">Update</a></li>    
