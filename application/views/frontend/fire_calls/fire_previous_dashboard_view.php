                            ...
                            <div class="width100 float_left">
                                ...
                                <div class="filed_input float_left width_20">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search" value="Search" class="btn clg_search form-xhttp-request mt-0" data-href="{base_url}fire_calls/previous_incident_calls" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
