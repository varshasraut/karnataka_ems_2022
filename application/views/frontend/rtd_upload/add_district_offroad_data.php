...
<div class="register_outer_block">
    ...
    <div class="breadcrumb float_left">
            <ul>
                <li>
                    <span>District Wise OffRoad Report</span>
                </li>
            ...
            <div class="field_row width100">
                ...
                <div class="button_field_row">
                    <div class="button_box"> 
                        ...
                        <input type="button" name="submit" value="Submit" class="btn submit_btnt form-xhttp-request" data-href='<?php echo base_url();?>rtd_upload/save_district_offroad_data' data-qr='page_no=<?php echo @$page_no; ?>&amp;output_position=content' >
