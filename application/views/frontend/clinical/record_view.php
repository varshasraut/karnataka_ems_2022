...
?>
    ...
    <div class=" width100 single_record">
                                            ...
                                            <table class="table report_table">
                                                ...
                                                ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="width_25"> <?php echo $epcr->ini_breathing_txt ?></td>
                                                                <td class="width_25">Circulation:</td>
                                                                <td class="width_25">Radial:- <?php echo $epcr->ini_con_circulation_radial ?>&nbsp;&nbsp; Carotid:- <?php echo $epcr->ini_con_circulation_carotid ?> </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="width_25"> <?php echo $epcr->ini_cir_pulse_p_txt ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width_25">RR:</td>
                                                                <td class="width_25"> <?php echo $epcr->ini_con_rr ?></td>
                                                                <td class="width_25">BP:</td>
                                                                <td class="width_25">SYS:- <?php echo $epcr->ini_bp_sysbp_txt ?>&nbsp;&nbsp; DIAST:- <?php echo $epcr->ini_bp_dysbp_txt ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width_25">BSL:</td>
                                                                <td class="width_25"> <?php echo $epcr->ini_con_bsl ?></td>
                                                                <td class="width_25">O2Sat:</td>
                                                                <td class="width_25"> <?php echo $epcr->ini_oxy_sat_get_nf_txt ?></td>
                                                            ...
                                                            <td colspan="5"><?php 
                                                                                ...
                                                                                $decoddg = json_decode('['.$epcr->titles.']');
                                                                                // var_dump($decoddg);die;
                                                                                echo $decoddg->med_title;
                                                                                ?>
                                                                </td>
                                                                <td colspan="5"><?php 
                                                                                // var_dump($epcr->inv_titles);
                                                                                $decoddg = json_decode('['.$epcr->inv_titles.']');
                                                                                // var_dump($decoddg);die;
                                                                                echo $decoddg->inv_title;
                                                                                ?>
                                                                </td>
                                                            </tr>
        ...
        <form method="post" id="FormId" action="<?= base_url() ?>Clinical/clinical_save" onsubmit="return (typeof submitted == 'undefined') ? (submitted = true) : !submitted">
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width100 float_left">
                            ...
                            <div class="filed_input float_left width80" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="consent" value="Transportation" >
                                <label class="movleft" for="">Transportation</label>
                                <input class="rad " type="radio" name="consent" value="TDT">
                                <label class="movleft" for="">Treatment During Transport</label>
                                <input class="rad " type="radio" name="consent" value="HR">
                                <label class="movleft" for="">High Risk</label>
                                <input class="rad " type="radio" name="consent" value="SP">
                    ...
                    <div class="width100 float_left" style="margin-top: 30px;">
                        ...
                        <div class="filed_input float_left width80">
                            <input name="consent_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                        </div>
                    </div>
                    ...
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="inter" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="inter" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="inter" value="NA">
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="inter_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="pro_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="pro_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="pro_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="pre_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="pre_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="pre_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="ini_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="ini_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="ini_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                    </div><br>
                    <div class="field_row width100"><br>
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="bas_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="bas_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="bas_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="ong_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="ong_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="ong_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        <div class="width30 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="han_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="han_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="han_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                    </div><br>
                    ...
                    <div class="width100 float_left" style="margin-top: 30px;">
                        <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                        <div class="filed_input float_left width80">
                            <input name="ptn_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="width100 float_left ">
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width100 float_left">
                            ...
                            <input class="rad " type="radio" name="adv_btn" value="Advice taken and followed" >
                                ...
                                <input class="rad " type="radio" name="adv_btn" value="Required but not taken" >
                                <label class="movleft" for="">Required but not taken</label>
                                <input class="rad " type="radio" name="adv_btn" value="Taken but not followed">
                                <label class="movleft" for="">Taken but not followed</label>
                                <input class="rad " type="radio" name="adv_btn" value="NA">
                                <label class="movleft" for="">NA</label>
                            </div>
                        </div>
                    ...
                    <div class="width100 float_left" style="margin-top: 30px;">
                        <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                        <div class="filed_input float_left width80">
                            <input name="ercp_adv_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                        </div>
                    </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="dc_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="dc_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="dc_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="dc_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="dh_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="dh_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="dh_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="dh_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="police" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="police" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="police" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="police_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="doc_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="doc_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="doc_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="doc_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="pg_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="pg_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="pg_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="pg_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="field_row width100"><br>
                        ...
                        <div class="width50 float_left">
                            ...
                            <div class="filed_input float_left width50" style="display: flex;flex-wrap: wrap;align-content: space-between;">
                                <input class="rad " type="radio" name="tra_btn" value="Yes" >
                                <label class="movleft" for="yes1">Yes</label>
                                <input class="rad " type="radio" name="tra_btn" value="No">
                                <label class="movleft" for="no1">No</label>
                                <input class="rad " type="radio" name="tra_btn" value="NA">
                                <label class="movleft" for="na1">NA</label>
                            </div>
                        </div>
                        ...
                        <div class="width100 float_left" style="margin-top: 30px;">
                            <div class="field_lable float_left width20"><label class="lblfont">Remark</label></div>
                            <div class="filed_input float_left width80">
                                <input name="tra_remark" tabindex="23" class="form_input " placeholder="Enter Remark" type="text" >
                            </div>
                        </div>
            ...
            <div class="width100 save_btn_wrapper" style="text-align: center;">
