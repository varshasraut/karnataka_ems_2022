                        ...
                        <div class="field_row width100">
                            <div class="width2 float_left">
                                ...
                                <div id="hp_dtl_dist" class="float_left filed_input width50">
                                    ...
                                    <?php
                                    $dt = array('dst_code' => $update[0]->wrd_district, 'st_code' => $update[0]->hp_state, 'auto' => 'hp_auto_addr', 'rel' => 'hp_dtl','disabled' => 'disabled');
                            ...
                            <div class="width2 float_left">
                                ...
                                <div id="hp_dtl_city" class="float_left filed_input width50">      
                                   ...
                                   $ct = array('cty_id' => $update[0]->	wrd_city, 'dst_code' => $update[0]->hp_district, 'auto' => 'hp_auto_addr', 'rel' => 'hp_dtl', 'disabled' => 'disabled'); 
                                   echo get_city($ct);
                                    ?>
                            ...
                            <div class="width2 float_left">
                                ...
                                <div class="field_row">
                                    ...
                                    <div class="float_left filed_input width50" id="hp_dtl_area">
                                        <input  name="hp_dtl_area" value="<?= @$update[0]->wrd_lmark ?>" class="auto_area" type="text" placeholder="Area/Locality" TABINDEX="12" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="width2 float_left">
                                ...
                                <div id="hp_dtl_lat" class="float_left filed_input width50">      
                                    ...
                                    <input name="lttd" value="<?= @$update[0]->wrd_area ?>" class="auto_area" type="text" placeholder="Area/Locality" TABINDEX="12" disabled>
