    ...
    <div class="register_outer_block">
        ...
        <div class="box3">
            ...
            <div class="width1 float_left ">
                ...
                <h2 class="txt_clr2 width1 txt_pro">Ambulance Replacement Details</h2>
                    ...
                    <div class="field_row width100">
                        ...
                        <div class="width2 float_left">
                            ...
                            <div class="filed_input float_left width50 " >
                                    ...
                                    <input  name="incident_no" class=" filter_required mi_autocomplete dropdown_per_page width97" data-href="{base_url}auto/get_incident?amb_id=<?php  echo $update[0]->amb_rto_register_no; ?>" placeholder="Select Incident Id" data-errors="{filter_required:'Please select Incident Id from dropdown list'}" tabindex="15" autocomplete="off" value="<?php echo $inc_ref_id; ?>" data-value="<?php echo $inc_ref_id; ?>" data-base="search_btn" TABINDEX="4">
        ...
        <div class="width_11 margin_auto">
            <div class="button_field_row">
                <div class="button_box">
                    ...
                    <input type="button" name="submit" value="Submit" class="form-xhttp-request" data-href='<?php echo base_url(); ?>amb/replac_amb_save'  data-qr='amb_id[0]=<?php echo base64_encode($update[0]->amb_id); ?>&amp;page_no=<?php echo $page_no; ?>&amp;output_position=content' TABINDEX="12" >
