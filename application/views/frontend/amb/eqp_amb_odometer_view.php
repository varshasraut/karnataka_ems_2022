...
<!--    <div class="width50 drg float_left">
    ...
    <div class="width50 drg float_left">
        ...
        <div class="width50 float_left">
            <input name="previous_breakdown_odmeter" tabindex="0" class="form_input filter_required" placeholder="" type="text" data-base="search_btn" value="<?php echo $previous_breakdown_odometer; ?>"  data-errors="{filter_required:'Start Odometer should not be blank!'}" readonly="readonly">
        </div>
    </div>
    <?php
    if ($amb_status == '13') {
    ...
    if ($amb_status == '13') { ?>
        <div class="width50 drg float_left">
            ...
            <div class="width50 float_left">
                <input name="start_odmeter" tabindex="1" class="filter_required form_input filter_valuegreaterthan[<?php echo $previous_odometer; ?>] filter_maxlength[8]"  placeholder="Enter Current Odometer" type="text" data-base="search_btn" value=""  data-errors="{filter_required:'End Odometer should not be blank!',filter_valuegreaterthan:'Start Odometer should not be Greater than previous odometer!',filter_maxlength:'END Odometer at max 7 digit long.'}" >
            </div>
        </div>
    <?php } ?>
    ...
    <div class="width50 drg float_left">
        ...
        <div class="width50 float_left">
            ...
            <input name="remark" id="remark_input" class="mi_autocomplete filter_required" data-href="{base_url}auto/get_eqp_standard_emark/add" data-value="" value="" type="text" tabindex="2" placeholder="Remark" data-errors="{filter_required:'Remark should not be blank!'}"  data-callback-funct="show_other_offroad_standard_remark">
        </div>
    </div>
    <div class="width50 drg float_left hide" id='show_other_offroad_standard_remark'>
        <div class="width33 float_left">
            <div class=" float_left">Other Standard Remark<span class="md_field">*</span> : </div>
        </div>
        <div class="width50 float_left">

            <input name="other_offroad_standard_remark" class=""  value="" type="text" tabindex="2" placeholder=" Remark" data-errors="{filter_required:'Remark should not be blank!'}" >
        </div>
    </div> 
    <div class="width50 drg float_left">
        <div class="width33 float_left">
