...
<!-- <div class="row text-center">
  <div class="col-md-10 offset-md-1 col-lg-10 offset-md-1">
    <div>
<label style="padding-top:20px;text-align: center;font-size:20px;color:black;padding-bottom: 20px;"><h3>Ambulance live Tracking</h3></label>
...
<div class="row">
<div class="col-md-3"> <label class="headerlbl">Select Ambulance :</label>  </div>
<div class="col-md-3">
...
<select id="amb_id" placeholder="Select Ambulance" value="<?php echo $amb_rto_register; ?>" data-qr="" data-value="<?php echo $amb_rto_register; ?>"  name="amb_reg_id"  onchange="amb_typewise_load()">
    <!--<option value="">Select Type</option>-->
    <option value="all">All Ambulance</option>
    <option value="108amb">108 Ambulance</option>
    <option value="102amb">JE Ambulance</option>
    <!--<option value="102amb">104 Ambulance</option>-->
    <option value="single_amb">Ambulance select</option>

</select>

</div>
<div class="col-md-3" id="single_amb" style="display:none">
<input name="amb_reg_id"  id="amb_id" class="mi_autocomplete dropdown_per_page width97" data-href="{base_url}auto/get_ambulance_dash" placeholder="Select Ambulance" data-errors="{filter_required:'Please select state from dropdown list'}" tabindex="2" autocomplete="off" value="<?php echo $amb_rto_register; ?>" data-qr="" data-value="<?php echo $amb_rto_register; ?>" data-callback-funct="single_ambulance_load_dash">
<input name="amb_reg_id"  id="ambulance_id" class="mi_autocomplete dropdown_per_page width97" data-href="{base_url}auto/get_ambulance" placeholder="Select Ambulance" data-errors="{filter_required:'Please select state from dropdown list'}" tabindex="2" autocomplete="off" value="" data-value="" data-callback-funct="single_ambulance_load_dash">
</div>
