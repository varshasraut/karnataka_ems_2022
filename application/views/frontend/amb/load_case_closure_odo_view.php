        ...
        <div class="box3">
            ...
            <div class="width1 float_left ">
                ...
                <div class="field_row width100">
                       ...
                       <div class="width2 float_left">
               <div class="filed_lable float_left width33"><label for="amb_number">Enter Incident Id<span class="md_field">*</span></label></div>
               
               
               <div class="filed_input float_left width50 " >
                  
                       <input  name="insident_no" id="inc_no" class=" onpage_popup action_button filter_required mi_autocomplete dropdown_per_page width97"  data-href="{base_url}auto/get_incident_odometer_change?amb_id=<?php echo $amb;?>" placeholder="Select Incident Id" data-errors="{filter_required:'Please select Insident Id from dropdown list'}" tabindex="15" autocomplete="off" value="<?php echo $inc_ref_id; ?>" data-value="<?php echo $inc_ref_id; ?>" data-base="search_btn" TABINDEX="4">
            ...
            <div class="width_11 margin_auto">
                <div class="button_field_row">
                    ...
                    <input type="hidden" name="submit_amb" value="amb_reg" />
                         ...
                         <input type="button" name="submit" value="Submit" class="form-xhttp-request" data-href='<?php echo base_url(); ?>amb/amb_odometer_save'  data-qr='amb_id[0]=<?php echo base64_encode($update[0]->amb_id); ?>&amp;page_no=<?php echo $page_no; ?>&amp;output_position=content' TABINDEX="12" >
