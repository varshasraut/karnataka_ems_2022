            ...
            <div id="list_table">
                ...
                <table class="table report_table">
                    ...
                    <tr>
                        ...
                        <td><a id="dis_<?php echo $screning['district_id'];?>" class="click-xhttp-request" data-href="{base_url}bed/district_bed_hospital" data-qr="output_position=content&district_id=<?php echo $screning['district_id'];?>"><strong><?php echo $screning['district_name'];?> </strong></a></td> 
                       <td><?php  
