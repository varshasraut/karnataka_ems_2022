...
<table class="table table-bordered NHM_Dashboard"  >
    <tr>
        <td>
<!--            <a style="cursor:pointer" id="dis_<?php echo $screning['district_id'];?>" class="click-xhttp-request" data-href="{base_url}bed/nhm_district_bed_hospital" data-qr="output_position=content&district_id=<?php echo $screning['district_id'];?>"><strong><?php echo $screning['district_name'];?> </strong></a>-->
            
            <a style="cursor:pointer" id="dis_<?php echo $screning['div_code'];?>" class="click-xhttp-request" data-href="{base_url}bed/nhm_division_bed_district" data-qr="output_position=content&div_code=<?php echo $screning['div_code'];?>"><strong><?php echo $screning['div_name'];?> </strong></a>
...
<?php } }
  ...
  <div class="row">
   <label style="padding-top:10px;text-align: center;font-size:20px;color:blue;">Data not found for division FOR COVID19 & NON COVID19</label>
  </div> 
  <?php }
  ?> <br><br><br>
