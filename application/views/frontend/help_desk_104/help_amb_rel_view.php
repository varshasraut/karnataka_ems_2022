<!-- <div class="call_purpose_form_outer">
    <label class="headerlbl">Call Transfer To 108</label>
    <div id="totalnon_div">
        <div id="nonleft_half">
            <form method="post" name="complnt_call_form" id="complnt_form">
                ...
                <div class="button_field_row  text_align_center">
                    <div class="button_box call_transfer">
                        ...
                        <input name="fwd_btn" value="Call Transfer To 108" class="style5 style10 form-xhttp-request" data-href="{base_url}transfercall/confirm_save" data-qr="forword=yes" type="button" tabindex="8">
                    </div>
                </div>
            </form>
        </div>
...
<div class="call_purpose_form_outer">
    <label class="headerlbl">Ambulance Regarding Call (108 Call Transfer)</label>
        ...
        <div id="nonright_half">
            <table id="script_table">
                <tr>
                    ...
                    <td>कॉलर द्वारा १०८ एम्बुलेंस सहायता के लिए काल किया गया !  सहायता के लिए काल १०८ एम्बुलेंस  सर्विस में कॉल ट्रांसफर किया गया |
                    </td>
                </tr>
                <tr>
