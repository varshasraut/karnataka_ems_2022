<div class="call_purpose_form_outer">
    <label class="headerlbl">Social Adjustment Related</label>
            ...
            <form method="post" name="complnt_call_form" id="complnt_form">
                ...
                <div class="button_field_row  text_align_center">
                    <div class="button_box enquiry_button">
                        ...
                        <input name="fwd_btn" value="FORWARD TO COUNSELOR" class=" form-xhttp-request" data-href="{base_url}non_eme_calls/help_104_save" data-qr="output_position=summary_div" type="button" tabindex="13" autocomplete="off">
                    </div>
                </div>
            </form>
        </div>
        <div id="nonright_half">
            <table id="script_table">
                <tr>
                    ...
                    <td>कॉलर के द्वारा समाज में अन्य लोगो से घुलने मिलने की असहजिता की समस्या से सम्बंधित समस्या के लिए कॉल किया गया, उचित परामर्श के लिए कॉल को काउंसलर अधिकारी को ट्रांसफर किया गया |
                    </td>
                ...
                <tr>
                    ...
                    <td>लाइन पर बने रहने के लिए धन्यवाद , कॉउंसलर अधिकारी लाइन पर हैं बात कीजिये ! </td>
                </tr>
                <tr>
