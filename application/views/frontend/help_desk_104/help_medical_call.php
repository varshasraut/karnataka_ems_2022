<div class="call_purpose_form_outer">
    <label class="headerlbl">Medical Call</label>
    <div id="totalnon_div">
        <div id="nonleft_half">
            <form method="post" name="complnt_call_form" id="complnt_form">
                <div class="width100 enquiry_summary">
                    <div class="width100 form_field float_left ">
                        <div class="form_field mt-1">
                            <div class="label blue float_left width_20">Chief Complaint<span class="md_field">*</span></div>
                            <div class="input nature float_left width75" id="">
                                <input type="text" name="incient[help_desk_chief_complaint]" id="" value="" class="mi_autocomplete filter_required" data-href="{base_url}auto/get_chief_complaint_help_desk" placeholder="Chief Complaint" data-errors="{filter_required:'Please select complaint from dropdown list'}" TABINDEX="8" <?php echo $autofocus; ?>>
                            </div>
                        </div>
                    </div>
                    <div class="width100 form_field float_left ">
                ...
                <div class="button_field_row  text_align_center">
                    <div class="button_box enquiry_button">
                        ...
                        <input name="fwd_btn" value="FORWARD TO ERCP" class="form-xhttp-request" data-href="{base_url}medadv/confirm_save_104" data-qr="output_position=summary_div" type="button" tabindex="8">
        ...
        <div id="nonright_half">
            <table id="script_table">
                <tr>
                    ...
                    <td>कॉलर के द्वारा बीमारी से सम्बंधित समस्या/ जानकारी के लिए कॉल किया गया | सहायता के लिए हमारे द्वारा कॉल को डॉक्टर के पास ट्रांसफर किया गया |
                    </td>
                </tr>
                <tr>
                    <td id="script_table_td">Holding Script</td>
                ...
                <tr>
                    ...
                    <td>लाइन पर बने रहने के लिए धन्यवाद , डॉक्टर अधिकारी लाइन पर हैं बात कीजिये । </td>
                </tr>
                <tr>
