<div class="call_purpose_form_outer">
    <label class="headerlbl">Other Call</label>
                ...
                <div class="width100 enquiry_summary">
                    <div class="width100 form_field float_left">
                        ...
                        <div class=" float_left width75" id="ero_summary_other">
                            <textarea style="height:60px;" name="incient[inc_ero_summary]" class="width_100 filter_required" TABINDEX="16" data-maxlen="1600" data-errors="{filter_required:'ERO Summary should not be blank'}"><?= @$inc_details['inc_ero_summary']; ?></textarea>
                        </div>
        ...
        <div id="nonright_half">
            <table id="script_table">
                <!-- <tr>
                    ...
                    <td>कॉलर द्वारा जन्म प्रमाण पत्र से सम्बंधित जानकारी के लिए काल किया गया ! इस सम्बन्ध में हमारे द्वारा सम्बंधित जानकारी  प्रदान की गई |
                    </td>
                </tr> -->
                <tr>
