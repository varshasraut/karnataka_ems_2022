...
<!--                                <td nowrap><?php echo $inc->pname; ?></td>-->
                                <td nowrap>
                                    <?php if($inc->fire_audit_status == '0'){?>
                                    <a class="click-xhttp-request action_button btn" data-href="{base_url}quality_forms/open_audit"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;inc_ref_id=<?php echo $inc->fc_inc_ref_id; ?>&ref_id=<?php echo $ref_id;?>&user_type=<?php echo $user_type;?>" data-popupwidth="1000" data-popupheight="350">Audit</a>
                                    <?php } else{ ?>
                                    <a class="click-xhttp-request action_button btn" data-href="{base_url}quality_forms/open_audit"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;inc_ref_id=<?php echo $inc->fc_inc_ref_id; ?>&ref_id=<?php echo $ref_id;?>&user_type=<?php echo $user_type;?>&type=edit" data-popupwidth="1000" data-popupheight="350">Edit</a>
                                    <?php } ?>
