...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>ERO Team</span></li>
    </ul>
</div>

<div class="width2 float_right">
    <input class="add_button_amb click-xhttp-request float_right" name="add_amb" value="Add More" data-href="{base_url}quality/ero_team" data-qr="output_position=popup_div&amp;module_name=amb_maintaince" type="button" data-popupwidth="800" data-popupheight="700"> 

    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}quality/ero_team_list" data-qr="output_position=content&amp;filters=reset" type="button">
                        ...
                        <div class="row list_actions clg_filt">
                            ...
                            <div class="search_btn_width">
                                ...
                                <div class="filed_input float_left width_20">  
                                    ...
                                    <input type="button" name="search_btn" value="Search" class="btn clg_search form-xhttp-request float_left" data-href="{base_url}quality/ero_team_list" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" style="float:left !important;" >
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}quality/ero_team_list" data-qr="output_position=content&amp;flt=true">
