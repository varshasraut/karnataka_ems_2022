...
<!--                                <td nowrap><?php echo $inc->pname; ?></td>-->
                                <td nowrap>
                                    <?php if($inc->police_audit_status == '0'){?>
                                    <a class="click-xhttp-request action_button btn" data-href="{base_url}quality_forms/open_audit"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;inc_ref_id=<?php echo $inc->pc_inc_ref_id; ?>&ref_id=<?php echo $ref_id;?>&user_type=<?php echo $user_type;?>" data-popupwidth="1000" data-popupheight="350">Audit</a>
                                    <?php } else{ ?>
                                    <a class="click-xhttp-request action_button btn" data-href="{base_url}quality_forms/open_audit"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;inc_ref_id=<?php echo $inc->pc_inc_ref_id; ?>&ref_id=<?php echo $ref_id;?>&user_type=<?php echo $user_type;?>&type=edit" data-popupwidth="1000" data-popupheight="350">Edit</a>
                                    <?php } ?>
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}quality_forms/view_ercp_incidence_quality" data-qr="output_position=content&amp;flt=true">
