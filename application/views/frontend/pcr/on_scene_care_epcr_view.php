...
<div class="float_left width100">
    ...
    ?>
    <div class="head_outer"><h3 class="txt_clr2 width1">Closure Information  : On Scene Care Patient</h3> </div>     
                    ...
                    <div class="width100">
                        ...
                        <div class="width_25 float_left drg">
                            ...
                            <?php
                                ...
                                <input class="add_button_hp click-xhttp-request float_right mipopup" id="add_button_pt" name="add_patient" value="Add" data-href="{base_url}pcr/add_patient_details?pt_count=<?php echo $pt_count; ?>&epcr_call_type=<?php echo '3';?>&pt_count_ero=<?php echo $inc_details_data[0]->inc_patient_cnt; ?>" data-qr="filter_search=search&amp;tool_code=add_patient&showprocess=yes&inc_ref_id=<?php echo $inc_ref_id; ?>&reopen=<?php echo $reopen;?>" type="button" data-popupwidth="1250" data-popupheight="1000" style="display:none;">
                    ...
                    <div class="width100">
                        ...
                        <div class="width100">
                            ...
                            <div id="ptn_form_lnk" class="width100 float_left">
                               ...
                               <a data-href='{base_url}pcr/delete_patient_details' class='click-xhttp-request style1' data-qr='ptn_id=<?php echo @$pt_info[0]->ptn_id; ?>&amp;inc_ref_id=<?php echo $inc_ref_id; ?>' data-popupwidth='1250' data-popupheight='870' data-confirm='yes' data-confirmmessage='Are you sure to delete' style="color:#f00  !important">( Delete Patient )</a>
                                <?php } ?>
...
<!--                                <input name="emt_name" tabindex="24" class="form_input filter_required" placeholder="EMT Name" type="text" data-base="search_btn" data-errors="{filter_required:'EMT Name should not be blank!'}" value="<?= $inc_emp_info[0]->pilot_name; ?>" >-->
                    ...
                    <!--<div class="width_40 drg float_left">
                        ...
                        if($user_group == 'UG-BIKE-DCO'){
                            ?>
                            <div class="width_60 float_left base_location">
                              <input name="provider_casetype" tabindex="4" class="mi_autocomplete form_input filter_required" placeholder="Case Type" type="text" data-base="search_btn" data-errors="{filter_required:'Plase select Case type from dropdown list'}" value="30" data-value="Treatment On Scene" data-href="{base_url}auto/get_providercase_type_new?epcr_call_type=<?php echo $epcr_call_type;?>&patient_gender=<?php echo $pt_info[0]->ptn_gender; ?>" data-qr="" id="provider_casetype" >
                          </div>
                            <?php  
                    ...
                    <input name="provider_casetype_other" id="provider_casetype_other_text"   class="form_input" placeholder="Other Case Type"  type="text" value="<?php echo @$inc_details[0]->provider_casetype_other; ?>" tabindex="6" data-errors="{filter_required:'should not be blank!'}">
                        ...
                        <div class="width_40 float_left">
                            <div class=" float_left">Provider Impressions<span class="md_field">*</span> : </div>
                        </div>
                        <div class="width_60 float_left base_location">
...
<div class="width100 dr_para">
    <div class=" width100 single_record_back"> 
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            <input name="start_from_base" tabindex="20" class="form_input EndDate filter_required" placeholder="H:i" type="text" value="<?php if(isset($driver_data[0]->start_from_base)){ echo date('H:i:s',strtotime($driver_data[0]->start_from_base)); }else{ echo $inc_details_data[0]->inc_datetime; } ?>"  data-errors="{filter_required:'Start From Base should not be blank!',filter_time_hm:'Please enter valid time(H:i)'}"  readonly="readonly"  >
                        </div>
                    </div>
                    ...
                    <div class="width100 float_left">
                        <div class="width50 drg float_left <?php echo $hide_remark; ?>" id="responce_time_remark">
                            ...
                            <div class="width100 float_left">
                                 <input type="text"  name="responce_time_remark"  class="mi_autocomplete" data-errors="{filter_required:'Remark should not be blank!' } " id="responce_remark" data-value="<?php echo $responce_time_remark; ?>" value="<?php echo $driver_data[0]->responce_time_remark; ?>""  data-href="{base_url}auto/get_responce_time_remark"  placeholder="Remark" data-callback-funct="responce_remark_change" TABINDEX="8">
                            </div>
                        </div>
                ...
                <div class="width100">
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            <input name="back_to_base" tabindex="19" class="filter_required form_input  " placeholder="H:i" type="text" data-base="search_btn" value="<?php if(isset($driver_data[0]->dp_back_to_loc)){ echo date('H:i',strtotime($driver_data[0]->dp_back_to_loc)); }?>" data-errors="{filter_required:'Back to base  should not be blank!',filter_time_hm:'Please enter valid time(H:i)'}" readonly="readonly">
                        </div>
                    </div>
...
<!--                    <div class="width_30 rec_hp float_left">
            ...
            <div class="width50 float_left">
                ...
                <div class="width100">
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            ...
                            if (isset($driver_data[0]->start_from_base)) {
                                ...
                                echo $inc_details_data[0]->inc_datetime; 
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            <input name="at_scene" tabindex="15" class="form_input filter_required StartDate filter_gretherthan[start_from_base]" placeholder="H:i" type="text" data-base="search_btn" data-errors="{filter_required:'At scene should not be blank!',filter_time_hm:'Please enter valid time(H:i)',filter_gretherthan:'At Scene should not be grater than Start from base'}" value="<?php
                ...
                <div class="width100">
                    ...
                    <div class="width33 drg float_left">
                        <div class="width100 float_left">
                            <div class="style6 float_left">Hand over <span class="md_field">*</span> : </div>
                        </div>
                        <div class="width100 float_left">
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            ...
                            ?>" data-errors="{filter_required:'Back to base  should not be blank!',filter_time_hm:'Please enter valid time(H:i)',filter_gretherthan:'Back to base should not be grater Hand over'}" readonly="readonly" id="back_to_base" <?php echo $disabled; ?>>
                        </div>
                    </div>
                    ...
                    <div class="width100">
                        ...
                        <div class="width50 drg float_left">
                            ...
                            <div class="width50 float_left" id="scene_view">
                                ...
                                <input name="scene_odometer" onkeyup="this.value=this.value.replace(/[^\d]/,'')" tabindex="20" class="form_input filter_maxlength[8] <?php echo $filter_rangelength;?> " placeholder="Enter Scene Odometer" type="text" data-base="search_btn" value="<?php echo $get_odometer[0]->scene_odometer; ?>"  data-errors="{filter_required:'Scene Odometer should not be blank!',filter_valuegreaterthan:'Scene Odometer should greater than or equlto Previous Odometer',filter_rangelength:'Scene Odometer should less than <?php echo $odometer_scene; ?>',filter_maxlength:'Scene Odometer number at max 7 digit long.'}" id="scene_odometer_pcr" <?php  if( $reopen != 'y'){ echo $odo_scene_disabled; } ?> >
                            </div>
                        </div>
                        <div class="width50 drg float_left">
                            <div class="width50 float_left">
                        ...
                        <!-- <div class="width50 drg float_left">
                            ...
                            <input name="gps_odmeter" onkeyup="" tabindex="21"  maxlength="7" id="" class="form_input" placeholder="Enter GPS Odometer" type="text" data-base="search_btn" value="" readonly>
                            </div>
                        </div> -->
            ...
            <input type="hidden" name="receiving_host" id="receiving_host" value="on_scene_care">
    ...
    <!--                    <input name="search_btn" value="Save" class="style3 base-xhttp-request" data-href="{base_url}/pcr/epcr" data-qr="output_position=content" type="button">-->
                    <?php //if($user_group != 'UG-DCO'){ ?>
                        ...
                        <input type="hidden" name="epcr_call_type" id="epcr_call_type" value="3">
...
//    });
    ...
    $('#at_scene').on('change',function(){
        ...
        $('#from_scene').val(start_from_base);
        if(start_from_base != null){
