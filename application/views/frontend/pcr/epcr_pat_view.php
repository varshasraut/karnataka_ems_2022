...
<!--            <select name="pat_id" tabindex="4" id="pcr_pat_id_new" class="filter_required" data-errors="{filter_required:'Patient ID should not be blank!'}"> 
                ...
                <?php foreach ($patient_info as $pt) { ?>
                    ...
                    ?>><?php echo $pt->ptn_id . " - " . $pt->ptn_fname." ".$pt->ptn_lname; ?></option>
                        <?php } ?>
                <option value="0" class="" >Other</option>
            </select>-->
             <select name="pat_id" tabindex="4" id="pcr_pat_id_new" class="filter_required" data-errors="{filter_required:'Patient ID should not be blank!'}"> 
                <option value="">Select patient id</option>
                <?php foreach ($patient_info as $pt) { ?>
    ...
    <div class="width33 float_left">
        ...
        <div class="width100 float_left">
            <input name="patient_age" tabindex="6" class="filter_required form_input" placeholder=" Age" type="text" data-base="search_btn"  value="<?= $pt_info[0]->ptn_age; ?>" readonly="readonly">
        </div>
    </div>
...
<div class="width100">
    <div class="width33 float_left">
        ...
        <div class="width100 float_left">
            <input name="ptn_fname" tabindex="5" class="form_input filter_required" placeholder="Patient First Name " type="text" data-base="search_btn" data-errors="{filter_required:'Patient Name should not be blank!'}" value="<?= $pt_info[0]->ptn_fname; ?>" readonly="readonly">
        </div>
    </div>
   <div class="width33 float_left">
        <div class="width100 float_left">
    ...
    <div class="width33 float_left">
        ...
        <div class="width100 float_left">
            <input name="ptn_lname" tabindex="5" class="form_input filter_required" placeholder="Patient Last Name " type="text" data-base="search_btn" data-errors="{filter_required:'Patient Name should not be blank!'}" value="<?= $pt_info[0]->ptn_lname; ?>" readonly="readonly">
        </div>
    </div>
