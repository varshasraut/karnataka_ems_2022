...
if($pt_count < $pt_count_ero)
{
    ...
    <div class="epcr_patient">
        ...
        <div class="width100 patient_blk display_inlne_block">
            ...
            <div class="add_pat_width">
                ...
                <input name="ptn[0][ptn_lname]" value="<?php echo $ptn[0]->ptn_lname; ?>" class="" tabindex="3" data-base="" type="text" placeholder="Last Name" >
    ...
    <div class="float_left" style="width:3.00%" data-activeerror="">
            ...
            <div class="add_pat_width">
                ...
                <input name="ptn[indx][ptn_lname]" value="" class="" tabindex="3" data-base="" type="text" placeholder="Last Name" >
...
<div class="save_btn_wrapper float_left">
        ...
        <input type="button" name="save_all_patient" value="Save All Patient" class="accept_btn form-xhttp-request" data-href='<?php echo base_url(); ?>/pcr/save_add_patient_details' data-qr="output_position=pat_details_block&showprocess=yes&reopen=<?php echo $reopen;?>"  tabindex="25">
