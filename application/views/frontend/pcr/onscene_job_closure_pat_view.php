...
<div class="single_record_back">                                     
    ...
    <div class="width33 float_left">
        ...
        <div class="width100 float_left">
            ...
            <input class="add_button_hp click-xhttp-request float_right" id="add_button_pt" name="add_patient" value="Add" data-href="{base_url}pcr/add_patient_details_onscene?pt_count=<?php echo $pt_count; ?>&epcr_call_type=<?php echo $epcr_call_type;?>&pt_count_ero=<?php echo $inc_details_data[0]->inc_patient_cnt; ?>" data-qr="filter_search=search&amp;tool_code=add_patient&reopen=<?php echo $reopen;?>" type="button" data-popupwidth="1000" data-popupheight="800" style="display:none;">
        </div>
    </div>
    <div class="width33 float_left">
        <div class="width100 float_left">
...
<div class="width100">
   ...
   <!--<div class="width33 float_left">
    ...
    <div class="width33 float_left">
        ...
        <div class="width100 float_left">
            <input name="ptn_lname" tabindex="5" class="form_input filter_required ucfirst_letter" placeholder="Patient Last Name " type="text" data-base="search_btn" data-errors="{filter_required:'Patient Name should not be blank!'}" value="<?= $pt_info[0]->ptn_lname; ?>" readonly="readonly">
        </div>
    </div>
    <div class="width33 float_left">
    <div class="width100 float_left">
