...
<form method="post" name="epcr_inc_form" id="job_closer_inc_list" class="mt-3">
    <a class="click-xhttp-request" style="visibility: hidden;" data-href="{base_url}job_closer/rtm" data-qr="output_position=content&showprocess=no">refresh</a>
    <div id="amb_filters">
...
<?php } ?>
            ...
            <div class="float_left">
                <input type="button" class="search_button float_left form-xhttp-request mainbtn2 mt-0" name="" value="Search" data-href="{base_url}job_closer/rtm" data-qr="output_position=content&amp;flt=true" id="job_closer_autoload" />
                <input class="search_button click-xhttp-request float_right mainbtn mt-0" style="color: #2F419B !important;" name="" value="Reset Filters" data-href="{base_url}job_closer/rtm" data-qr="output_position=content&amp;filters=reset" type="button">
        ...
        <table class="table report_table tblclr">
            ...
            ?>
                    ...
                    <tr id="<?php echo $inc->inc_ref_id; ?>">
                        ...
                        <td><?php echo $inc->amb_rto_register_no; ?></a></td>
                        ...
                        <?php //if($clg_senior){
                                        ...
                                        <td class="text-center"><i class='fa fa-map-marker' style='font-size:30px;cursor: pointer;' Onclick='gps_status("<?php echo $inc->inc_recive_time;?>","<?php echo $inc->inc_datetime;?>","<?php echo $inc->amb_rto_register_no;?>")'></i><br>
            ...
            <div class="width25 float_right">
                ...
                <div class="record_per_pg">
                    ...
                    <div class="per_page_box_wrapper">
                        ...
                        <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request width20" data-href="{base_url}job_closer/rtm" data-qr="output_position=content&amp;flt=true"><?php echo rec_perpg($pg_rec); ?>
                        </select>
...
<script>
  ...
  function gps_status(inc_recive_time,inc_datetime,amb_reg_no){
    ...
    // amb_reg_no = "CG04NS4267";
    // inc_recive_time = "2022-10-13 10:53:27";
    // inc_datetime = "2022-10-13 11:10:57";
