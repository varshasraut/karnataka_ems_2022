                    ...
                    <div class="width100">
                        ...
                        <div class="width_40 float_left drg">
                            ...
                            <div class="width_65 float_left">
                                ...
                                <input class="add_button_hp click-xhttp-request float_right mipopup" id="add_button_pt" name="add_patient" value="Add" data-href="{base_url}pcr/add_patient_details_onscene?pt_count=<?php echo $pt_count; ?>&epcr_call_type=<?php echo '3';?>&pt_count_ero=<?php echo $inc_details_data[0]->inc_patient_cnt; ?>" data-qr="filter_search=search&amp;tool_code=add_patient&showprocess=yes&inc_ref_id=<?php echo $inc_ref_id; ?>&reopen=<?php echo $reopen;?>" type="button" data-popupwidth="1250" data-popupheight="1000" style="display:none;">
                            </div>
                        </div>
                    ...
                    <div class="width100">
                        <div class="width100 float_left drg">
                            ...
                            <div class="width_27 float_left drg">
                                <input name="ptn_lname" tabindex="13" class="form_input ucfirst_letter" placeholder="Patient Last Name " type="text" data-base="search_btn" data-errors="{filter_required:'Patient Name should not be blank!'}" value="<?php echo $pt_info[0]->ptn_lname; ?>" readonly="readonly">
                            </div>
                            <div class="width_27 float_left">
        <!--                        <input name="gender" tabindex="13" class="form_input filter_required" placeholder=" Pilot Name " type="text" data-base="search_btn" data-errors="{filter_required:'Patient gender should not be blank!'}" value="<?= get_gen($pt_info[0]->ptn_gender); ?>">-->
                        ...
                        <div class="width100">
                            ...
                            <div id="ptn_form_lnk" class="width100 float_left">
                               ...
                               <a data-href='{base_url}pcr/add_patient_details_onscene' class='click-xhttp-request style1' data-qr='ptn_id=<?= @$pt_info[0]->ptn_id; ?>&amp;inc_ref_id=<?php echo $inc_ref_id; ?>' data-popupwidth='1250' data-popupheight='870'>( Update patient details )</a>
...
<div class="width100 dr_para">
    <div class=" width100 single_record_back"> 
                    ...
                    <div class="width33 drg float_left">
                        ...
                        <div class="width100 float_left">
                            <input name="start_from_base" tabindex="20" class="form_input EndDate filter_required" placeholder="H:i" type="text" value="<?php if(isset($driver_data[0]->start_from_base)){ echo date('H:i:s',strtotime($driver_data[0]->start_from_base)); } ?>"  data-errors="{filter_required:'Start From Base should not be blank!',filter_time_hm:'Please enter valid time(H:i)'}"  readonly="readonly"  >
                        </div>
                    </div>
                    ...
                    <div class="width100 float_left">
                        <div class="width50 drg float_left hide" id="responce_time_remark">
                            ...
                            <div class="width100 float_left">
                                 <input type="text"  name="responce_time_remark"  class="mi_autocomplete" data-errors="{filter_required:'Remark should not be blank!' } " id="responce_remark" data-value="" value=""  data-href="{base_url}auto/get_responce_time_remark"  placeholder="Remark" data-callback-funct="responce_remark_change" TABINDEX="8">
                            </div>
                        </div>
            ...
            <div class="width50 float_left">
                ...
                <div class="width100 dr_para">
                    <div class=" width100 single_record_back">                                     
                        ...
                        <div class=" float_left" style="margin-left: 10px;   margin-top: 3px;">Response Time<span id="md_field">*</span> : <span id="driver_responce_time"></span></div>
                    </div>
                    </div>
                <div class="width100">
                    <!--                    <h3>Driver Parameters : </h3>-->
                    ...
                    <div class="width100 float_left">
                        <div class="width50 drg float_left hide" id="responce_time_remark">
                            ...
                            <div class="width_60 float_left">
                                <input type="text" name="responce_time_remark" id="responce_remark" data-value="<?php echo $driver_data[0]->responce_time_remark; ?>" value="" class="mi_autocomplete"  data-href="{base_url}auto/get_responce_time_remark"  placeholder="Remark" data-callback-funct="responce_remark_change" TABINDEX="8" data-errors="{filter_required:'Remark should not be blank!'}" >
...
<!--                        <div class="width50 drg float_left">
    ...
    <!--                    <input name="search_btn" value="Save" class="style3 base-xhttp-request" data-href="{base_url}/pcr/epcr" data-qr="output_position=content" type="button">-->
                    ...
                    <input type="button" name="Save" value="SAVE PAGE" class="accept_btn form-xhttp-request" data-href='{base_url}job_closer/save_job_closure_onscene' data-qr='' TABINDEX="33"><?php // }else{           ?>
