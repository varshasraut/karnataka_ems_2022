    ...
    <div class="half_div_left epcr">
        ...
        <div class=" display_inlne_block">
            ...
            <div id= "ptn_age_outer" class="pat_width">
                ...
                <input name="ptn[ptn_age]"  onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="<?php echo $ptn[0]->ptn_age; ?>" class="filter_rangelength[0-120]" tabindex="4" data-base="" type="text" placeholder="Age" data-errors="{filter_required:'Age should not blank',filter_rangelength:'Age should be 0 to 120'}">
        ...
        <div class="row display_inlne_block">
            ...
            <div class="pat_width">
                ...
                <div id="ptn_dtl_dist">
                    ...
                    if (empty($ptn[0]->ptn_district) || $ptn[0]->ptn_district == '0' ) {
...
?>
    ...
    <div class="save_btn_wrapper float_left">
        ...
        <input type="button" name="accept" value="Accept" class="accept_btn form-xhttp-request" data-href='<?php echo base_url(); ?>/pcr/save_patient_details' data-qr="output_position=pat_details_block&showprocess=yes"  tabindex="25">
