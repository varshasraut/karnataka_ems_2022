                ...
                foreach ($corona_list as $corona) {
                   ...
                   // var_dump($corona);
                    ...
                    <tr>
                        ...
                        <td style="width:10%;"><?php echo $corona->mobile_no; ?></td>
                        <td style="width:10%;"><?php echo $corona->inc_ref_id; ?></td>
                        <td style="width:15%;">
                        ...
                        <td style="width:15%;"><?php echo $corona->address; ?></td>
                          ...
                          <td style="width:15%;"><?php echo $corona->call_count; //echo count($prev_cl_dtl[$corona->corona_id]); ?></td>
            ...
            <div class="width33 float_right">
                ...
                <div class="record_per_pg">
                    ...
                    <div class="per_page_box_wrapper">
                        ...
                        <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}corona/corona_list" data-qr="output_position=content&amp;flt=true">

                            <?php echo rec_perpg($per_page); ?>
