<div class="call_purpose_form_outer" id="general_enquiry_corona">
    <div class="width100">
        <!-- <h3>General Enquiry : Corona</h3> -->
        <label class="headerlbl">General Enquiry : Corona</label>
    </div>
     <form enctype="multipart/form-data" action="#" method="post" id="corona_enquiry_call">
        ...
        <div id="fwdcmp_btn" class="width100">
            <input type="hidden" name="patient[inc_type]" id="inc_type" value="CORONA_GENERAL_ENQUIRY">
