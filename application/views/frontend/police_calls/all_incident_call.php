                    ...
                    <div class="search">
                        ...
                        <div class="width100 float_left">
                            ...
                            <div class="filed_input float_left width_15">
                                ...
                                <input type="button" style="margin: auto; width: auto;" name="search" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}police_calls/all_police_call" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs">
                                <!-- </label> -->
                            </div>
                            <div class="filed_input float_left width10">
                                <!-- <label for="search_clg"> -->
                                <input type="reset" style="margin: auto;" class="search_button float_left form-xhttp-request" name="" value="Reset Filter" data-href="{base_url}police_calls/all_police_call" data-qr="output_position=content&amp;flt=reset&amp;type=inc" tabindex="5" autocomplete="off">
                                <!-- </label> -->
                            </div>
                        </div>
                </div>
