                            ...
                            <div class="search">
                                        ...
                                        <div class="filed_input float_left width_15">
                                            <!-- <label for="search_clg"> -->
                                                <input type="button" style="margin: auto; width: auto;" name="search" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}police_calls/previous_incident_calls" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                            <!-- </label> -->
                                        </div>
                                    ...
                                    if (count(@$inc_info) > 0) {
                                        ...
                                        foreach ($inc_info as $key => $inc) {
                                            ...
                                            <tr>
                                                ...
                                                <td ><a href="{base_url}calls/single_record_view" class="onpage_popup" data-qr="output_position=popup_div&pc_inc_ref_id=<?php echo $inc->pc_inc_ref_id; ?>" style="color:#000;"><?php echo $inc->pc_inc_ref_id; ?></td>
