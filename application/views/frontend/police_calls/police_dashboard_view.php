...
<?php
?>
<div class="margin_auto width100">
    <div class="dash_quality_marks text_align_center mt-4">
        <strong>POLICE CALL INFO</strong><br>
        <table>
            <tr>
                <th style="text-align: center;">Total Calls <br>(This month)</th>
                <th style="text-align: center;">Total PDA Informed<br> (This month)</th>
                <th style="text-align: center;">Total Calls<br> (Today)</th>
                <th style="text-align: center;">Total PDA Informed<br> (Today)</th>
                <th style="text-align: center;">Total RTA <br>(This month)</th>
                <th style="text-align: center;">Total RTA PDA Dispatch<br> (This month)</th>
                <th style="text-align: center;">Total RTA<br> (Today)</th>
                <th style="text-align: center;">Total RTA PDA Dispatch<br> (Today)</th>
            </tr>
            <tr>
                ...
                <td><?php echo $get_monday_rta_call; ?></td>
                <td><?php echo $get_all_calls_assign; ?></td>
                <td><?php echo $get_today_rta_call; ?></td>
                <td><?php echo $get_today_calls_assign; ?></td>
            </tr>
        </table>
        <!-- <table>
...
<div class="width100" style="min-height: 200px;">
    ...
    <div class="header_top_link">
        ...
        <ul id="incedence_steps">
            <li class='active_supervisor_nav'><a class="click-xhttp-request " href="{base_url}police_calls/previous_incident_calls" data-qr="output_position=content">Incident Call</a></li>
            <li><a class="click-xhttp-request" href="{base_url}police_calls/manual_calls" data-qr="output_position=content">Manual Call</a></li>
            <li><a class="click-xhttp-request" href="{base_url}police_calls/all_police_call" data-qr="output_position=content">All Incident</a></li>
                                ...
                                <div class="width100 float_left">
                                    ...
                                    <div class="filed_input float_left width_15">
                                        <label for="search_clg">
                                            <input type="button" name="search" value="Search" class="btn mt-0 clg_search form-xhttp-request" data-href="{base_url}police_calls" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs">
                                        </label>
                                    </div>
                                    <div class="filed_input float_left width10">
                                        <input type="reset" style="margin: auto;" class="search_button float_left form-xhttp-request" name="" value="Reset Filter" data-href="{base_url}police_calls/previous_incident_calls" data-qr="output_position=content&amp;flt=reset&amp;type=inc" tabindex="5" autocomplete="off">
                                    </div>
                            </div>
                                ...
                                <table class="table report_table table-bordered">
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $inc->pc_call_receiver_name; ?></td>
