    ...
    <form enctype="multipart/form-data" action="#" method="post" id="add_caller_details">
        <div class="call_bx">
            ...
            <div class=" width100">
                ...
                <div class="amb_details float_left">

                    <ul class="dtl_row">

                        <li>RTO No: <span><?php echo $emt_details->amb_rto_register_no; ?></span></li>
                        <li>Type: <span><?php echo $emt_details->ambt_name; ?></span></li>
                        <li>Mobile No:  <span> <?php echo "  " . $emt_details->amb_default_mobile; ?></span></li>
                        <li>District: <span><?php echo $emt_details->dst_name; ?></span></li>
                    </ul>

                    <ul class="dtl_row">


                        <li>Base Location: <span><?php echo $emt_details->hp_name; ?></span></li>
