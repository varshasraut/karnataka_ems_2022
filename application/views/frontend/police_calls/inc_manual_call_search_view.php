        ...
        <div class="caller_details" id="caller_details">
                ...
                <div >
                    ...
                    <div class="<?php echo $cl_class; ?> float_left input">
                        ...
                        <input id="first_name" type="text" name="caller[cl_firstname]" class="filter_required ucfirst"  data-errors="{filter_required:'Caller first name should not be blank',filter_word:'Invalid input at first name. Numbers and special characters not allowed.'}" value="<?= @$caller_details->clr_fname ?>" placeholder="First Name" TABINDEX="1.4" >
...
<!--                        <input type="button" id="caller_details_form" name="submit" data-qr="output_position=inc_details&amp;module_name=calls&amp;showprocess=no" data-href="{base_url}police_calls/save_call_details" class="form-xhttp-request" data-base="caller[cl_purpose]" style="visibility:hidden;">-->
                        <a id="caller[cl_purpose]" class="hide change-base-xhttp-request float_left" data-href="{base_url}police_calls/save_call_details" data-qr="output_position=content&module_name=calls&showprocess=no"></a>
                    </div>

                    <div  id="dis_timer_clock" class="<?php // echo $cl_class;      ?> width_17  float_left input">
                        <input type='text' id="timer_clock" style="background-color: #F3F1F1;" value="" readonly="readonly" name="incient[dispatch_time]"/>
            ...
            <div class="form_field width100 pos_rel">
                ...
                <div class="width33 float_left">
                    ...
                    <div class="filed_input float_left width50">
                        ...
                        <input type="text" name="police[pc_patient_count]" class="filter_required" placholder="Patient Count" data-errors="{filter_required:'Patient Count should not be blank'}" value="<?= @$police_station[0]->pc_patient_count ?>" TABINDEX="1"  <?php
                        echo $view;
                        if (@$update) {
                            echo"disabled";
                        }
        ...
        <div class="width33 float_left">
            ...
            <div class="field_row float_left width1">
                ...
                <div id="hp_dtl_state" class="float_left width50">
                    ...
                    <?php
                    if($update[0]->hp_state != ''){
                    $st = array('st_code' => $update[0]->hp_state, 'auto' => 'hp_auto_addr', 'rel' => 'hp_dtl', 'disabled' => $view);
                    }else{
                         $st = array('st_code' => 'MP', 'auto' => 'hp_auto_addr', 'rel' => 'hp_dtl', 'disabled' => $view);
                    }
                    echo get_state($st);
                    ?>
        ...
        <div class="width100 float_left" >
            ...
            <div class="width33 float_left">
                ...
                <div class="filed_input float_left width50">
                    ...
                    <input id="pc_call_receiver_name"   type="text" name="police[pc_call_receiver_name]" class="filter_required" placholder="Call Receiver Name" data-errors="{filter_required:'Station name should not be blank'}" value="<?= @$police_station[0]->police_station_name ?>" TABINDEX="1"  <?php
                    echo $view;
                    if (@$update) {
                        echo"disabled";
                    }
            ...
            <div class="width33 float_left">
                ...
                <div class="field_lable float_left width_25"> <label for="mobile_no"> Mobile No</label></div>
                    ...
                    <div class="filed_input float_left width50">
                    <input type="text" name="police[pc_mobile_no]" class="width90 float_left filter_required"  data-errors="{filter_required:'Mobile number should not be blank',filter_no_whitespace:'No spaces allowed', filter_number:'Mobile number should be in numeric characters only', filter_minlength:'Mobile number should be at least 10 digits long', filter_maxlength:'Mobile number should less then 11 digits.'}" value="<?= @$police_station[0]->p_station_mobile_no ?>" TABINDEX="10"  <?php echo $view; ?> id="pc_mobile_no">   
            ...
            <div class="width33 float_left">
                ...
                <div class="filed_input float_left width50">
                    ...
                    <input name="pc_assign_time" id="pc_assign_time" tabindex="20" class="form_input mi_cur_timecalender filter_required" placeholder="Assign Time" type="text"  data-errors="{filter_required:'Assign Time should not be blank!'}" value="<?= @$fuel_data[0]->ff_fuel_date_time; ?>"  <?php echo $update; ?> >
                </div>
            </div>
           <div class="width100 float_left" >
...
<!--    <div class="width33 float_left">
                ...
                <div class="width33 float_left">
                <div class=" blue float_left width_25">Police Help Complaint<span class="md_field">*</span></div>
                    <div class="input  top_left float_left width50" >
