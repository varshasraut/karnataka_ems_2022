    ...
    <div class="pan_box bottom_border float_left width100">
        ...
        <div class=" float_left width100">
            ...
            <?php if (!empty($pt_info[0])) {
                ...
                <div class="width100">
                    <div class="width100 float_left ercp ercp_table">
                                            <div class="width100 ercp ercp_table">
                        <table>
                            <tr class="single_record_back">
                                <td colspan="6" style="text-align:center;"><strong>Caller Information</strong></td>
                            </tr>

                            <tr>
                                <td  valign="center" class="width_25"><strong>Caller Name</strong></td>
                                <td  valign="center" ><?php echo ($pt_info[0]->clr_fname) ? $pt_info[0]->clr_fname . " " . $pt_info[0]->clr_lname : "-"; ?></td>
                                <td  valign="center" ><strong>Caller Mobile</strong></td>
                                <td  valign="center" >
                                ...
                                <td  valign="center" ><strong>Caller Relation</strong></td>
                                <td  valign="center" ><?php echo get_relation_by_id($pt_info[0]->clr_ralation); ?></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table>
                            <tr class="single_record_back">
                                <td colspan="6" style="text-align:center;"><strong>Patient Information</strong></td>
                            </tr>
                            <tr>
                                <td  valign="top"><strong>Patient Name</strong></td>
                                <td  valign="top"><?php echo ucwords($pt_info[0]->ptn_fname) ? $pt_info[0]->ptn_fname . " " . $pt_info[0]->ptn_lname : "-"; ?></td>
                                <td  valign="top"><strong>Age</strong></td>
                                <td  valign="top"><?php echo ($pt_info[0]->ptn_age) ? $pt_info[0]->ptn_age : "-"; ?></td>
                          
                                <td valign="top" ><strong>Gender</strong></td>
                                <td  valign="top" ><?php echo ($pt_info[0]->ptn_gender) ? get_gen($pt_info[0]->ptn_gender) : "-"; ?></td>
                            </tr>
                            <tr>
                                <td  valign="top" ><strong>ERO Note</strong></td>
                    ...
                    <div class="width100 float_right ercp ercp_table">

                        <table>
                            <tr class="single_record_back">
                                <td colspan="4" style="text-align:center;"><strong>Incident Information</strong></td>
                            </tr>
                            <tr>
                                <td  valign="top" class="width"><strong>Call Type</strong></td>
                                <td  valign="top" class="width_25"><?php echo ucwords($pname); ?></td>
                                <td  valign="top" class="width"><strong>No Of Patients</strong></td>
                            ...
                            <tr>     <?php if (trim($pt_info[0]->inc_type) == 'mci') { ?>
                                    ...
                                    <td  valign="top" class="width_25"><strong>MCI Nature</strong></td>
                                    <td  valign="top" class="width_25"><?php echo ($pt_info[0]->ntr_nature) ? $pt_info[0]->ntr_nature : '-'; ?></td>

                                <?php } else { ?>


                                    <td  valign="top"  class="width_25"><strong>Chief Complaint Name</strong></td>
                                    <td  valign="top" class="width_25"><?php echo ($pt_info[0]->ct_type) ? $pt_info[0]->ct_type : '-'; ?></td>


                                <?php } ?>
                                <td  valign="top"  class="width_25"><strong>Current Ambulance</strong></td>
                                <td  valign="top"  class="width_25"><?php echo $pt_info[0]->amb_rto_register_no; ?></td>
                            </tr>

                            <tr>
                                <td  valign="top"  class="width_25"><strong>Ambulance base location</strong></td>
                                <td  valign="top"  class="width_25"><?php echo ($pt_info[0]->hp_name); ?></td>
                                <td  valign="top"  class="width_25"><strong>Dispatch Date /Time</strong></td>
                                <td  valign="top"  class="width_25"><?php echo $pt_info[0]->inc_datetime; ?></td>
                            </tr>
                            <tr>                                  
                                <td  valign="top"  class="width"><strong>Incident Id</strong></td>
                                <td  valign="top"  class="width_25"><?php echo ($pt_info[0]->inc_ref_id); ?></td>
                                <td  valign="top" class="width_25"><strong>Incident Address</strong></td>
            ...
            <div class="field_row width100">
              ...
              <div class="field_row width100">
                ...
                <div class="save_btn_wrapper">
                    ...
                    <input name="save_btn" value="SUBMIT" class="style5 form-xhttp-request" data-href="{base_url}police_calls/save_police" data-qr="" type="button" tabindex="16">
...
<!--            <script>
                ...
                $('#current_date_timepicker').datetimepicker({
                    maxDate: new Date(),
                    dateFormat: 'yy-mm-dd',
                    timeFormat: "HH:mm:ss"
                });
