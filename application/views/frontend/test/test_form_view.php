...
<div class="call_purpose_form_outer">
    ...
    <!-- <h3> Test Call</h3> -->
    <label class="headerlbl">Test Call</label>
    <div id="totalnon_div">

<div id="nonleft_half">

    <form method="post" name="test_call_form" id="test_call_form">
        ...
        <input type="hidden" name="incient[inc_type]" id="inc_type" value="TEST_CALL">
...
<!--            <div class="form_field width50 float_left">
        ...
        <div class="button_field_row text_align_center beforeunload">
            <div class="button_box">
                ...
                <input type="button" name="submit" value="Save" class="style5 form-xhttp-request" data-href='{base_url}tstcall/confirm_save' data-qr="output_position=content;forword=true" tabindex="8">
...
<div id="nonright_half">
            <table id="script_table">
                <tr>
                    ...
                    <td>यादि कोई कॉलर, कॉल कर यह बताता है, के यह कॉल 108 संजीवनी नंबर  के जांच हेतू किया है, तोह, इ.आर.ओ इस कॉल का चयन करें !</td>

                </tr>
                <!-- <tr>
                    <td id="script_table_td">Standard Remarks Hindi</td>
                    <td>यदि कॉलर १०८ सेवाओं की उपलब्धता का परीक्षण करने के लिए कॉल करता है तो इस कॉल प्रकार का चयन करें। </td>
