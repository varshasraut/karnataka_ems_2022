            ...
            <div class="grp_actions_width">
                    ...
                    <div class="srch_box">
                       <!-- <input type="text" class="search_catalog" name="hp_data" value="" placeholder="Search"/>-->
                        <input type="button" class="search_button form-xhttp-request float_right mt-0" name="" value="Search" data-href="{base_url}base_location/bs_listing" data-qr="output_position=content&amp;flt=true"/>
                    </div>
