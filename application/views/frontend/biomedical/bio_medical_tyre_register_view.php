                ...
                <div class="field_row width100">
                            ...
                            <div class="width90 float_left">
                                ...
                                <fieldset>
                                        ...
                                        <div class="EQP_blk">
                                            ...
                                            <div class="field_row">
                                                ...
                                                <div class="filed_input">
                                                    ...
                                                    <input type="text" name="item[EQP][0][id]" tabindex="1" value="" class="mi_autocomplete filter_required" data-href="<?php echo base_url(); ?>auto/get_inv_tyre/dq/<?php echo $eqp_type; ?>" data-errors="{filter_required:'Tyre should not be blank!'}" placeholder="Tyre Name" autocomplete="off" data-auto="EQP" data-nonedit="yes" id="EQPI_0" data-callback-funct="EQPReq">
                                    ...
                                    <div class="width1 text_align_center add_more_ind">
                                        ...
                                        <a class="EQP_more">Add more tyre +</a>
                    ...
                    <div class="button_field_row  margin_auto float_left width100 text_align_center">
                        <div class="button_box">
                            ...
                            <input type="button" name="submit" value="<?php if ($update) { ?>Update<?php } else { ?>Send Request<?php } ?>" class="btn submit_btnt form-xhttp-request" data-href='<?php echo base_url(); ?>biomedical/<?php if ($update) { ?>update_oxygen_filling<?php } else { ?>send_tyre_request<?php } ?>' data-qr='output_position=content&amp;prof=<?php echo @$prof; ?>&amp;module_name=clg&amp;tlcode=<?php if ($update) { ?>MT-CLG-UPDATE<?php } else { ?>MT-CLG-ADD<?php } ?>&amp;page_no=<?php echo @$page_no; ?>' TABINDEX="23">
...
<div id="EQP_tmp" class="hide">
    ...
    <div class="EQP_blk blk ind_class">
        ...
        <div class="field_row">
            <div class="filed_input"><input type="text" name="item[EQP][indx][id]" tabindex="1" value="" class="autocls width1" data-href="<?php echo base_url() ?>auto/get_inv_tyre/dq" placeholder="Tyre Name" autocomplete="off" data-auto="EQP" data-nonedit="yes" id="EQPI_indx" data-callback-funct="EQPReq"></div>
        </div>
        <div class="field_row">
            <div class="filed_input"><input type="text" name="item[EQP][indx][qty]" tabindex="1" value="" class="filter_if_not_empty[EQPI_indx] filter_required filter_number" data-errors="{filter_if_not_empty:'Item quantity should not be blank',filter_required:'Item quantity should not be blank','filter_number':'Item quantity should be in numbers'}" placeholder="Tyre Quantity"></div>
        </div>
    </div>
