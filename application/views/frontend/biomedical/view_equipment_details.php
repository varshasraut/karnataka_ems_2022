<?php
if ($action_type == 'Receive Equipment') {

    $act_url = "biomedical/receive_equipment";

    $act = "RECEIVE";
} elseif ($action_type == 'Approve Equipment') {

    $act_url = "biomedical/approve_equip";

    $act = "APPROVE";
} else {

    $act_url = "biomedical/dispatch_equipment";
                        ...
                        if ($prev_type != $type) {
                            ...
                            <div class="field_row width100">
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                       $args = array('inv_type'=>$ind_details->ind_item_type,'inv_id'=> $ind_details->eqp_id,'inv_amb'=>$indent_data[0]->req_amb_reg_no);
...
//        echo $bal;
         ...
         $args_stock = array('inv_type'=>$ind_details->ind_item_type,'inv_id'=> $ind_details->eqp_id);
        ...
        ?>
                                            ...
                                            <input type="hidden" name="stk" id="<?php echo "stk_" . $ind_details->ind_id; ?>" value="<?php echo $bal; ?>">
                            ...
                            <div class="filed_input float_left width50">
                                ...
                                <select name="eqiup[req_dispatch_remark]" tabindex="8"  id="standard_remark" class="filter_required" data-errors="{filter_required:'Remark should not be blank!'}"  <?php echo $dis; ?>> 
                                    ...
                                    <?php if ($action == 'dis' || $action == 'view') { ?>
                                        ...
                                        ?>>Equipment request Dispatch sucessfully.</option> 
                                            <?php } ?>
                                        ...
                                        ?>>Equipment request Approve sucessfully.</option>  
                                            <?php } ?>
                                </select>
