...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Equipment Request</span></li>
    </ul> 
</div>
...
<div class="width2 float_right">
    ...
    <?php if ($send_request != '') { ?>
        <input class="add_button_amb click-xhttp-request float_right" name="add_amb" value="Add Equipment Request" data-href="{base_url}biomedical/add_equipment" data-qr="output_position=popup_div&amp;tool_code=mt_clg_add&amp;module_name=fleet" type="button" data-popupwidth="800" data-popupheight="700">
    <?php } ?>
...
<div id="date_filter"></div>
                                <div class="filed_input float_left width_25">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search_btn1" value="Search" class="btn clg_search form-xhttp-request mt-0" data-href="{base_url}biomedical/equipment" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                            <li><a class="onpage_popup action_button" data-href="{base_url}biomedical/view_eqp_details" data-qr="output_position=popup_div&amp;ind_emt_id=<?php echo base64_encode($equipment_data->req_emt_id); ?>&amp;req_id=<?php echo  base64_encode($equipment_data->req_id); ?>&amp;action=view&amp;req_type=<?php echo $equipment_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">View</a></li>
                                            ...
                                            if ($receive != '' && $equipment_data->req_dis_by != '' && $equipment_data->req_rec_by == '' && $equipment_data->req_is_approve == 1) {
                                                ...
                                                <li><a class="onpage_popup action_button" data-href="{base_url}biomedical/view_eqp_details" data-qr="output_position=popup_div&amp;ind_emt_id=<?php echo base64_encode($equipment_data->req_emt_id); ?>&amp;req_id=<?php echo base64_encode($equipment_data->req_id); ?>&amp;action=rec&amp;req_type=<?php echo $equipment_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">Receive</a></li>
