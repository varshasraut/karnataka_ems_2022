...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Equipment Dispatch</span></li>
    </ul>
</div>
...
<div id="date_filter"></div>
                                <div class="filed_input float_left width_25">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search_btn1" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}biomedical/equipment_dispatch" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                        <input class="search_button click-xhttp-request " name="" value="Reset Filters" data-href="{base_url}biomedical/equipment_dispatch" data-qr="output_position=content&amp;filters=reset" type="button">
                                    </label>
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}biomedical/equipment_dispatch" data-qr="output_position=content&amp;flt=true">
