                    ...
                    <div class="search">
                        <div class="row list_actions clg_filt">
                            ...
                            <div class="field_row width100">
                                <div class="filed_input  width_25">

                                    <input type="text"  placeholder="Search Name" value="<?php echo @$search; ?>" name="search" style="margin-right: 20px;">
                                </div> 
...
<div id="date_filter"></div>
                                <div class="filed_input float_left width_25">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search_btn1" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}biomedical/tyre_dispatch" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                                        <input class="search_button click-xhttp-request " name="" value="Reset Filters" data-href="{base_url}biomedical/tyre_dispatch" data-qr="output_position=content&amp;filters=reset" type="button">
                                    </label>
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                            <li><a class="onpage_popup action_button" data-href="{base_url}biomedical/view_tyr_details" data-qr="output_position=popup_div&amp;ind_emt_id=<?php echo base64_encode($equipment_data->req_emt_id); ?>&amp;req_id=<?php echo  base64_encode($equipment_data->req_id); ?>&amp;action=view&amp;req_type=<?php echo $equipment_data->req_type; ?>>&amp;amb_no=<?php echo base64_encode($equipment_data->req_amb_reg_no); ?>" data-popupwidth="800" data-popupheight="700">View</a></li>
                                            ...
                                            if ($receive != '' && $equipment_data->req_dis_by != '' && $equipment_data->req_rec_by == '' && $equipment_data->req_is_approve == 1) {
                                                ...
                                                <li><a class="onpage_popup action_button" data-href="{base_url}biomedical/view_tyr_details" data-qr="output_position=popup_div&amp;req_id=<?php echo  base64_encode($equipment_data->req_id); ?>&amp;amb_no=<?php echo base64_encode($equipment_data->req_amb_reg_no); ?>&amp;action=rec&amp;req_type=<?php echo $equipment_data->req_type; ?>" data-popupwidth="800" data-popupheight="700">Receive</a></li>
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}biomedical/tyre_dispatch" data-qr="output_position=content&amp;flt=true">
