...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Tyre Request Approve</span></li>
    </ul>
</div>
...
<div class="width2 float_right">
    ...
    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}biomedical/tyre_approve" data-qr="output_position=content&amp;filters=reset" type="button">
...
<!--                                <div class="filed_input float_left width33">
                                ...
                                <div class="filed_input float_left width_25">
                                    <label for="search_clg">
                                        ...
                                        <input type="button" name="search_btn1" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}biomedical/tyre_approve" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_name=search_clgs" >
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}biomedical/tyre_approve" data-qr="output_position=content&amp;flt=true">
