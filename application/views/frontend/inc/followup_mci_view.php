    ...
    <form name="com_call_fwd" method="post" id="dispatch_call_forms">
        ...
        <div class="beforeunload float_left"  style="margin-top: 0px;">
            ...
            <?php if ($cl_type["cl_type"] == '') { ?>
                <input name="" value="Follow Up call" class="accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_followup_mci_inc" data-qr="output_position=content" type="button" tabindex="20">
            <?php } else { ?>
