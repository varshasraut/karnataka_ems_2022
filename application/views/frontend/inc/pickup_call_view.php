...
<div class="call_purpose_form_outer">
    <div class="width100">
    <label class="headerlbl">Pickup Call</label>
...
<!--                    <div class="width100 form_field outer_smry">
                ...
                <div class="width100 float_left form_field rt_side">
...
<!--					<div class="width33 float_left">
                ...
                <div class="width_100">
                    ...
                    <div class="style6">Hospital address</div>  
                        ...
                        <div class="float_left width50">
                                ...
                                <div class="input width100 " id="current_facility_box">
                                  ...
                                  <input style="width:-webkit-fill-available;" name="incient[facility]" class="mi_autocomplete filter_required" placeholder="Current Facility"  data-href="{base_url}auto/get_auto_hospital_new" type="text" data-errors="{filter_required:'Please select  facility from dropdown list',filter_greater_than_zero:'New Facility should not be blank'}" data-callback-funct="facility_details" TABINDEX="16" data-value="<?php echo $inc_details['hp_name']; ?>" value="<?php echo $inc_details['inc_back_hospital']; ?>">
                                </div>
...
<!--                      <input name="ques_btn" id="previous_inc_btn" style="display: none;" value="SEARCH" class="style3 base-xhttp-request previous_inc_btn" data-href="{base_url}inc/previous_incident?lat=12.9666662&lng=79.9465841" data-qr="output_position=previous_incident_details&inc_type=non-mci" type="button">
                ...
                <div class="width2 form_field float_left outer_btn">
                    <?php //var_dump($clg_user_type); ?>
                     <div id="fwdcmp_btn">
                        <input type="button" name="submit" value="DISPATCH" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pickup_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=dispatch'  TABINDEX="21">
                         <input type="button" name="submit" value="Termination Call" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pickup_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=terminate'  TABINDEX="27">
...
<?php //var_dump($common_data_form);?>
                ...
                <input type="hidden" name="incient[inc_type]" id="inc_type" value="PICK_UP">
