...
<div class="call_purpose_form_outer">
    <div class="width100">
    <label class="headerlbl">Child Care Call</label>
        <!-- <h3>Child Care Call</h3><br> -->
...
<!--                        <input type="text" name="incient[inc_city]" TABINDEX="72" value="<?=@$inc_details['inc_city'];?>" class=" width100 stauto" data-errors="{filter_required:'City/Vilage/Town is required'}" placeholder="City/Vilage/Town" data-auto="" id="inc_city">-->
                ...
                <div class="width100 form_field outer_smry">
                        <div class="width20 label blue float_left">Select Hospital<span class="md_field"></span>&nbsp;&nbsp;&nbsp;</div>
...
<!--                         <div class="width100" id="ero_summary_other">
                    ...
                    <?php if($agent_mobile == 'yes'){?>
                             <div class="address_bar">
                                 <input id="inc_map_address" placeholder="Enter your address" type="text" class="width_100" style="border-radius:0px !important; width:100% !important; border: 1px solid #ccc; margin-bottom: 0px;" name="incient[place]" TABINDEX="17" data-ignore="ignore" data-state="yes" data-city="yes" data-thl="yes" data-dist="yes" data-rel="incient" data-auto="inc_auto_addr" value="<?=@$inc_details['inc_address'];?>">
                        </div>
                 ...
                 <div class="map_box_inner float_left" id="INCIDENT_MAP" style="height:336px;">
                    ...
                    <div class="ambulance_box float_left">
                           <?php if($agent_mobile == 'no'){?>
                             <div class="address_bar">
                                 <input id="inc_map_address" placeholder="Enter your address" type="text" class="width_100" style="border-radius:0px !important; width:100% !important; border: 1px solid #ccc;" name="incient[place]" TABINDEX="17" data-ignore="ignore" data-state="yes" data-city="yes" data-thl="yes" data-dist="yes" data-rel="incient" data-auto="inc_auto_addr" value="<?=@$inc_details['inc_address'];?>">
...
<!--                      <input name="ques_btn" id="previous_inc_btn" style="display: none;" value="SEARCH" class="style3 base-xhttp-request previous_inc_btn" data-href="{base_url}inc/previous_incident?lat=12.9666662&lng=79.9465841" data-qr="output_position=previous_incident_details&inc_type=non-mci" type="button">
                ...
                <div class="width2 form_field float_left outer_btn">
                     <div id="fwdcmp_btn">
                        <input type="button" name="submit" value="DISPATCH" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_childcare_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=dispatch'  TABINDEX="21">
                         <input type="button" name="submit" value="Terminate Call" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_childcare_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=terminate'  TABINDEX="27">
                          <?php  if($clg_user_type == '108'){ ?>
                          <!--<input type="button" name="submit" value="Call Transfer to 102" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_childcare_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=transfer_102'  TABINDEX="27">-->
                       <?php }else if($clg_user_type == '102'){ ?>
                           <!--<input type="button" name="submit" value="Call Transfer to 108" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_childcare_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=transfer_108'  TABINDEX="27">-->
                          <?php } ?>
...
<?php //var_dump($inc_details);?>
                ...
                <input type="hidden" name="incient[inc_type]" id="inc_type" value="Child_CARE_CALL">
