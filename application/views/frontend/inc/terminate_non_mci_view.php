<div class="box_head text_align_center width100">
    <h3 class="txt_pro">TERMINATE AMBULANCE</h3>
</div>
...
<div class="confirm_save width100">
    ...
    <form name="com_call_fwd" method="post" id="dispatch_call_forms">
        ...
        <br>
        <br>
        <div class="beforeunload" style="text-align: center;">
            <?php if ($cl_type["cl_type"] == '') { ?>
                <input name="" value="Terminate Call" class="accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/terminate_nonmci_inc" data-qr="output_position=content" type="button" tabindex="20">
            <?php } else { ?>

                <input type="hidden" name="fwd_com_call" value="yes">
                <input name="" value="FORWARD" class="accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_nonmci_inc?cl_type=forword" data-qr="output_position=content" type="button" tabindex="20">
            <?php } ?>
