...
<!--        <ul class="dtl_block">
    ...
    <div class="save_btn_wrapper float_left beforeunload"  style="margin-top: 0px;">
     ...
     // var_dump($cl_type);
      ...
      if($cl_type == 'dispatch'){ ?>
            <input name="" value="SUBMIT" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_nonmci_inc" data-qr="output_position=content&cl_type=dispatch" type="button" tabindex="20">
     <?php }else if($cl_type == 'transfer_108'){ ?>
            <input name="" value="Transfer To 108" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_nonmci_inc?cl_type=transfer_108" data-qr="output_position=content&cl_type=transfer_108" type="button" tabindex="20">
     <?php }else if($cl_type == 'transfer_102'){?>
         <input name="" value="Transfer To 102" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_nonmci_inc?cl_type=transfer_102" data-qr="output_position=content&cl_type=transfer_102" type="button" tabindex="20">
     <?php }else{ ?>
