...
<div class="call_purpose_form_outer">
    <div class="width100">
    <label class="headerlbl">Drop Back Call</label>
...
<!--                    <div class="width100 form_field outer_smry">
                ...
                <div class="style6">Incident address</div>         
                    <div class="float_left width100">
                        ...
                        <div class="float_left width50">
                                ...
                                <div class="input width100 " id="current_facility_box">

                                  <input style="width:-webkit-fill-available;" name="incient[facility]" class="mi_autocomplete filter_required" placeholder="Facility"  data-href="{base_url}auto/get_auto_hospital_new" type="text" data-errors="{filter_required:'Please select facility from dropdown list',filter_greater_than_zero:'Facility should not be blank'}" data-callback-funct="facility_details" TABINDEX="16" data-value="<?php echo $inc_details['hp_name']; ?>" value="<?php echo $inc_details['inc_back_hospital']; ?>">
                                </div>
                                <div id="facility_details" class="hide">
...
<!--                        <div class="width33 float_left">
    ...
    <!--                        <input type="text" name="incient[inc_city]" TABINDEX="72" value="<?=@$inc_details['inc_city'];?>" class=" width100 stauto" data-errors="{filter_required:'City/Vilage/Town is required'}" placeholder="City/Vilage/Town" data-auto="" id="inc_city">-->
                        ...
                        <div class="width33 float_left">
                            <input type="text" name="incient[landmark]" TABINDEX="74" value="<?=@$inc_details['landmark'];?>" class="stauto" data-errors="" placeholder="Landmark" id="street_number">
                        </div>
                        <!--<div class="width33 float_left">
            ...
            <div class="display_inlne_block " style="margin-bottom:35px">

            <div class="style6">Home address<span class="md_field">*</span></div>

            <div class="outer_address float_left width100">   
                <?php
               // if (empty($ptn[0]->ptn_address)) {
               //     $ptn_address = $inc['ptn_address'];
               // } else {
                    $ptn_address = $home_data[0]->home_address;
               // }

                ?>
                
                <input name="incient[home_address]" value="<?php echo $ptn_address; ?>" id="pac-input" class="home_dtl filter_required"  data-errors="{filter_required:'Address should not be blank'}"tabindex="16" type="text" placeholder="Google location map address" data-state="yes" data-dist="yes"  data-ignore="ignore" data-dist="yes" data-thl="yes"  data-city="yes" data-area="yes" data-lmark="yes" data-lane="yes" data-pin="yes" data-rel="home_dtl" data-auto="home_auto_addr"> 
                
<!--                <input name="incient[home_address]" value="<?php echo $ptn_address; ?>" id="pac-input1" class="home_dtl filter_required"  data-errors="{filter_required:'Address should not be blank'}"tabindex="16" type="text" placeholder="Address" data-ignore="ignore"> -->
            ...
            <div class="pat_width" data-activeerror="">
                ...
                <div id="home_dtl_state1">

                    <?php
                    $state = $home_data[0]->home_state_id;

                    $st = array('st_code' => 'MP', 'auto' => 'home_auto_addr', 'rel' => 'home_dtl', 'disabled' => '');

                    //echo get_state($st);
                    ?>
                    <input name="home_dtl_state" value="MP"  class=" width97 filter_required"  style="display: none;">
            ...
            <div class="pat_width">
                        <div id="home_dtl_div">
                            ...
                            $dt = array('auto' => 'inc_auto_addr', 'rel' => 'home_dtl', 'disabled' => '','div_code' => '');
                            echo get_division_tahsil($dt);
                            ?>
                        </div>
                    </div>
            <div class="pat_width">
                ...
                <div id="home_dtl_dist">
                    <?php

                    $ptn_district = $home_data[0]->home_district_id;
                    
                    $dt = array('dst_code' => $ptn_district, 'st_code' => $state, 'auto' => 'home_auto_addr', 'rel' => 'home_dtl', 'disabled' => '');
...
<div id="home_dtl_tahsil">
    <?php

    
    $ptn_tahsil = $home_data[0]->home_tahsil_id;
    
    $dt = array('thl_id' =>$ptn_tahsil,'dst_code' => $ptn_district, 'st_code' => $state, 'auto' => 'home_auto_addr', 'rel' => 'home_dtl', 'disabled' => '');
...
//                    }
                    ...
                    $ptn_city = $home_data[0]->home_city_id;
                    
                    $ct = array('cty_id' => $ptn_city, 'dst_code' => $ptn_district, 'auto' => 'home_auto_addr', 'rel' => 'home_dtl', 'disabled' => '');
                    echo get_city($ct);
                    ?>
            ...
            <div class="pat_width" id="home_dtl_area">
                <input name="incient[home_dtl_area]" value="<?php echo $home_data[0]->home_location; ?>" class="auto_area" data-base="" type="text" placeholder="Area/Location" tabindex="20">

            </div>

            <div class="pat_width" id="home_dtl_lmark">

                <input name="incient[home_dtl_lmark]" value="<?php echo $home_data[0]->home_landmark; ?>" class="auto_lmark" data-base="" type="text" placeholder="Landmark" tabindex="21">

            </div>

           <!-- <div class="pat_width" id="home_dtl_lane">            
                <input name="incient[home_dtl_lane]" value="<?php echo $home_data[0]->home_lane; ?>" class="auto_lane" data-base="" type="text" placeholder="Lane/Street" tabindex="22">
            </div>
            <div class="pat_width" id="home_dtl_hno">            
                <input name="incient[home_dtl_hno]" value="<?php echo $home_data[0]->home_houseno; ?>" class="auto_hno" data-base="" type="text" placeholder="House Number" tabindex="23">
            </div>
            <div class="pat_width" id="home_dtl_pcode">            
                <input name="incient[home_dtl_pincode]" value="<?php echo $home_data[0]->home_pin; ?>" class="auto_pcode" data-base="" type="text" placeholder="Pincode" tabindex="24">
            </div> -->
                    ...
                    <div class="width100 form_field outer_smry">
                        <div class="label width20 blue float_left">ERO Summary<span class="md_field">*</span>&nbsp;</div>
                          <div class="width80 float_left">
                              <?php //var_dump($inc_details); ?>
                         <input type="text" name="incient[inc_ero_standard_summary]" data-value="<?php if($inc_details['inc_ero_standard_summary'] != ''){ get_ero_remark($inc_details['inc_ero_standard_summary_id']); } ?>" value="<?= @$inc_details['inc_ero_standard_summary']; ?>" class="mi_autocomplete filter_required width2"  data-href="{base_url}auto/get_ero_standard_summary?call_type=DROP_BACK"  placeholder="ERO Summary" data-errors="{filter_required:'Please select ERO Summary from dropdown list'}" data-callback-funct="ero_standard_summary_change" TABINDEX="8" >
                          </div>
...
<!--                      <input name="ques_btn" id="previous_inc_btn" style="display: none;" value="SEARCH" class="style3 base-xhttp-request previous_inc_btn" data-href="{base_url}inc/previous_incident?lat=12.9666662&lng=79.9465841" data-qr="output_position=previous_incident_details&inc_type=non-mci" type="button">
                ...
                <div class="width2 form_field float_left outer_btn">
                    <?php //var_dump($clg_user_type); ?>
                     <div id="fwdcmp_btn">
                        <input type="button" name="submit" value="DISPATCH" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_dropback_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=dispatch'  TABINDEX="21">
                         <input type="button" name="submit" value="Termination Call" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_dropback_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=terminate'  TABINDEX="27">
                         <input type="button" name="submit" value="Ambulance Not Available" class="btn hheadbg submit_btnt form-xhttp-request" data-href='{base_url}inc102/app_confirm_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD'  TABINDEX="27">
...
<?php //var_dump($common_data_form);?>
                ...
                <input type="hidden" name="incient[inc_type]" id="inc_type" value="DROP_BACK">
