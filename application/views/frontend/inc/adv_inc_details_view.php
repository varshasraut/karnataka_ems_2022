...
if($resource_type){
    ...
    <input type="hidden" data-base="select" name="resource_type[<?php echo $resource;?>]" value="<?php echo $resource;?>" >
<?php
    }
}
?>
        ...
        foreach ($pt_details as $pet) {
            ...
            <tr>
                ...
                <td id="incact">
                    ...
                    <input name="select" class="base-xhttp-request inc_act<?php echo $pet->inc_ref_id; ?> incact" data-href="{base_url}patients/pt_adv_inc_info" data-qr="inc_ref_id=<?php echo $pet->inc_ref_id; ?>&amp;cl_purpose=<?php echo $cl_purpose; ?>&amp;freq=true" value="SELECT" type="button">
