...
<div class="call_purpose_form_outer">
    <div class="width100">
    <label class="headerlbl">Pregancy Care Call</label>
        <!-- <h3>Pregancy Care Call</h3><br> -->
                ...
                <div class="width100 form_field outer_smry">
                    ...
                    <div class="width100 form_field outer_smry">
                        <div class="label width20 blue float_left">ERO Summary<span class="md_field">*</span>&nbsp;</div>
                         ...
                         <input type="text" name="incient[inc_ero_standard_summary]" data-value="<?= @$inc_details['re_name']; ?>" value="<?= @$inc_details['inc_ero_standard_summary']; ?>" class="mi_autocomplete filter_required width2"  data-href="{base_url}auto/get_ero_standard_summary?call_type=PREGANCY_CALL"  placeholder="ERO Summary" data-errors="{filter_required:'Please select ERO Summary from dropdown list'}" data-callback-funct="ero_standard_summary_change" TABINDEX="8" >
                          </div>
...
<!--                                 <div id="result"><table id="sugg"></table></div>-->
                        ...
                        <a class="click-xhttp-request" name="ques_btn" style="display: none;" data-href="{base_url}inc/get_inc_ambu?lat=&lng" data-qr="module_name=inc" id="get_ambu_details">get_ambu</a>
...
<!--                      <input name="ques_btn" id="previous_inc_btn" style="display: none;" value="SEARCH" class="style3 base-xhttp-request previous_inc_btn" data-href="{base_url}inc/previous_incident?lat=12.9666662&lng=79.9465841" data-qr="output_position=previous_incident_details&inc_type=non-mci" type="button">
                ...
                <div class="width2 form_field float_left outer_btn">
                     <div id="fwdcmp_btn">
                        <input type="button" name="submit" value="DISPATCH" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pregancy_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=dispatch'  TABINDEX="21">
                         <input type="button" name="submit" value="Termination Call" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pregancy_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=terminate'  TABINDEX="27">
                           <?php  if($clg_user_type == '108'){ ?>
                          <!--<input type="button" name="submit" value="Call Transfer to 102" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pregancy_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=transfer_102'  TABINDEX="27">-->
                       <?php }else if($clg_user_type == '102'){ ?>
                           <!--<input type="button" name="submit" value="Call Transfer to 108" class="btn submit_btnt form-xhttp-request" data-href='{base_url}inc102/confirm_pregancy_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=transfer_108'  TABINDEX="27">-->
                          <?php } ?>
...
<?php //var_dump($inc_details);?>
                ...
                <input type="hidden" name="incient[inc_type]" id="inc_type" value="PREGANCY_CALL">
