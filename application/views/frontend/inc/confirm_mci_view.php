...
<div class="width100 float_right">
        ...
        <span class="font_weight600">Ambulance Information</span>
         ...
         <table class="style3"  style="margin-bottom: 10px;">
            ...
            <tr>
                ...
                <td><?php echo $amb[0]->ambs_name; ?></td>
            </tr>
   ...
   <?php if(!empty($stand_amb_id)){?>     
        ...
        <span class="font_weight600">Standby Ambulance Information</span>
         ...
         <table class="style3"  style="margin-bottom: 10px;">
            ...
            <tr>
                <td>Mobile No</td>
                 <td><?php echo $amb[0]->amb_default_mobile;?></td>
   ...
   <?php } ?>
    ...
    <div class="save_btn_wrapper float_left beforeunload"  style="margin-top: 0px;">
      ...
      if($cl_type["cl_type"] == ''){ ?>
            <input name="" value="SUBMIT" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc/save_inc" data-qr="output_position=content" type="button" tabindex="20">
     <?php }else{ ?>
