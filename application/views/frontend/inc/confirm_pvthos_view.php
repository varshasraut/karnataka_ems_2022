...
<!--        <ul class="dtl_block">
    ...
    <div class="save_btn_wrapper float_left beforeunload"  style="margin-top: 0px;">
      ...
      if($cl_type == 'dispatch'){ ?>
            <input name="" value="DISPATCH" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc102/save_pvthos_save" data-qr="output_position=content&cl_type=dispatch" type="button" tabindex="20">
     <?php }else if($cl_type == 'transfer_108'){ ?>
            
<!--            <input type="hidden" name="fwd_com_call" value="yes">-->
            <input name="" value="Transfer To 108" class="inc_confirm_button accept_btn form-xhttp-request" data-href="<?php echo base_url(); ?>inc102/save_pvthos_save?cl_type=transfer_108" data-qr="output_position=content&cl_type=transfer_108" type="button" tabindex="20">
