...
<table class="table report_table">
    <tr>                              
        ...
        <?php if($clg_group != 'UG-DM' && $clg_group != 'UG-ZM' && $clg_group != 'UG-REMOTE-SUPER-ADMIN'){
                                                        ?>
        <th style="line-height: 20px;">Closure</th>
        <?php } ?>
    </tr>
    ...
    <tr>   
        ...
        <?php if($clg_group != 'UG-DM' && $clg_group != 'UG-ZM' && $clg_group != 'UG-REMOTE-SUPER-ADMIN'){
                                                        ?>
        <td><a href="{base_url}job_closer/epcr?inc_id=<?php echo base64_encode($incident->inc_ref_id); ?>" class="btn float_left click-xhttp-request onpage_popup " data-qr="output_position=content" data-popupwidth="1500" data-popupheight="850" >Closure</a></td>
        <?php } ?>
    </tr>
    <?php } ?>
