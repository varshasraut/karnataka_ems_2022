        ...
        <div class="row list_actions">
            ...
            <div class="width2 float_right">
                ...
                <div class="width_14 float_right">
                    ...
                    <input type="button" class="search_button float_right form-xhttp-request" name="" value="Search" data-href="{base_url}prescription/prescription_list" data-qr="output_position=content&amp;flt=true" />
                </div>
