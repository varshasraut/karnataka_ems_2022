...
<div class="row">
 <label style="padding-top:10px;text-align: center;font-size:20px;color:#black;">DIVISION DETAILS</label>
    ...
    <table class="table table-bordered NHM_Dashboard" id="nhm108"> 
        ...
        <tr>
            <td><a style="cursor:pointer" id="dis_<?php echo $screning['div_code'];?>" class="click-xhttp-request" data-href="{base_url}dashboard/nhm108_district_view" data-qr="output_position=content&div_code=<?php echo $screning['div_code'];?>"><?php echo $screning['div_name'];?> </a>
            <!--<td><a  style="cursor:pointer" class="click-xhttp-request" data-href="{base_url}dashboard/nhm_division_view" data-qr="output_position=district_data&showprocess=yes" ><?php echo $screning['div_name']; ?> </a></td>-->
            <td><?php echo $screning['dispatch_today_108']; ?></td>
