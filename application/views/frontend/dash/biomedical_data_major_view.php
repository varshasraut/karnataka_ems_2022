...
<div class="page-content--bgf7 pb-5" style="min-height:550px;">
    <div class="row">
        <div class="col-md-10" id="onroadhead">
            <h5>Equipment Status Report Major</h5>
        </div>
                    ...
                    <table class="list_table_amb" id="myTable" style="text-align: center;">
                        <thead class="" style="">
                            <tr class="table-active">
                                ...
                                <th style="text-align: center" scope="col">Ambu Bag</th>
                                <th style="text-align: center" scope="col">Ambulance Cot </th>
                                <th style="text-align: center" scope="col">Scoop Stretcher </th>
                                <th style="text-align: center" scope="col">Spine Board </th>
                                <th style="text-align: center" scope="col">Wheel chair </th>
                                <th style="text-align: center" scope="col">Oxygen Flow Meter with Humidifier </th>
                                <th style="text-align: center" scope="col">BP Apparatus (Digital)</th>
                                <th style="text-align: center" scope="col">Portable Cylinder</th>
                                <th style="text-align: center" scope="col">Foetal Doppler -Handheld</th>
                                <th style="text-align: center" scope="col">Handheld Glucometer </th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if (is_array($amb_data)) {
                                foreach ($amb_data as $amb) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $amb->amb_bag; ?> </td>
                                        <td><?php echo $amb->amb_cot; ?> </td>
                                        <td><?php echo $amb->scoop; ?> </td>
                                        <td><?php echo $amb->spine; ?> </td>
                                        <td><?php echo $amb->wchair; ?> </td>
                                        <td><?php echo $amb->oxy_flow; ?> </td>
                                        <td><?php echo $amb->appr; ?> </td>
                                        <td><?php echo $amb->port; ?> </td>
                                        <td><?php echo $amb->foetal; ?> </td>
                                        <td><?php echo $amb->handheld; ?> </td>
