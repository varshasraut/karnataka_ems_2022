        ...
        <div id="dash_filters"></div>
            ...
            <div id="list_table">
                ...
                <table class="table report_table">
                    ...
                    <tr>
                         <td><a class="click-xhttp-request" data-href="{base_url}dash/<?php echo $cluster_link_atc;?>" data-qr="output_position=content&atc=<?php echo $screning['atc_id'];?>&po=<?php echo $screning['po_id'];?>"><?php echo $screning['po_name'];?></a></td>  
