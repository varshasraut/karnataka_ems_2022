...
<div class="breadcrumb float_left">
        <ul>
            ...
            <li>
                <a class="click-xhttp-request" data-href="{base_url}dash/<?php echo $link_cluster;?>" data-qr="output_position=content&po=<?php echo $po;?>&cluster=<?php echo $cluster;?>">Cluster</a>
            </li>
              <li>
                <span>School</span>
            </li>
            ...
            <div id="list_table">
                ...
                <table class="table report_table">
                    ...
                    <?php foreach ($school_data as $school) { ?>
                        <tr><td><?php echo $school->school_name; ?></td> <td> </td><td> </td><td> 	</td></tr>
                    <?php } ?>
