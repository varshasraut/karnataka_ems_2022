                ...
                <table class="table report_table">
                    ...
                    <?php if($atc_screening){
                        foreach($atc_screening as $key=>$cluster){
                            $chart_value[] = $cluster['total_inc']?$cluster['total_inc']:0;
                            $chart_label[] = $cluster['cluster_name'];
                            $chart_color[] = rand_color();
                            $chart_ids[] = $cluster['cluster_id'];?>
                        <tr>
                            <td><?php echo $cluster['cluster_name'];?></td> 
                            <td><?php echo $cluster['today_inc'];?></td>  
                            <td><?php echo $cluster['current_month_inc'];?></td>   
                            <td><?php echo $cluster['year_total_inc'];?></td> 
                            <td><?php echo $cluster['total_inc'];?></td> 
                        </tr>
                        <?php  } }else{?>
                         <tr>
