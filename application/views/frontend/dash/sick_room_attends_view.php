...
<div class="breadcrumb float_left">
        <ul>
            ...
            <li>
                <span>Sick Room Attendance</span>
            </li>
    ...
    <div class="permission_list group_list">
            ...
            <div id="list_table">
                ...
                <table class="table report_table">
                    ...
                    <tr>
                        ...
                        <td>1</td>                            
                        <td><a id="attnd_1" class="click-xhttp-request" data-href="{base_url}dash/<?php echo $bread_title_link_atc;?>" data-qr="output_position=content"><?php echo $today_sickroom;?></a></td>    
                        <td><?php echo $month_sickroom;?></td>  
                        <td><?php echo $year_sickroom;?></td> 
                        <td><?php echo $total_sickroom;?></td> 
                    </tr>
                </table>
        ...
        new Chart(document.getElementById("pie-chart"), {
            ...
            data: {
              ...
              datasets: [{
                label: "Sick Room Attendance",
                backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850"],
                data: [<?php echo $total_sickroom;?>]
              }]
            },
            options: {
              title: {
