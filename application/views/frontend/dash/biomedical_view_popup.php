...
<div class="page-content--bgf7 pb-5" style="min-height:550px;">
    <div class="row">
        <div class="col-md-10" id="onroadhead">
            <h5>Equipment Status Report Critical</h5>
        </div>
                    ...
                    <table class="list_table_amb" id="myTable" style="text-align: center;">
                        <thead class="" style="">
                            <tr class="table-active">
                                ...
                                <th style="text-align: center" scope="col">Suction Pump Electronic</th>
                                <th style="text-align: center" scope="col">Oxygen Delivery System</th>
                                <th style="text-align: center" scope="col">Bi-Phasic Defibrillator cum Cardiac Monitor with Recorder</th>
                                <th style="text-align: center" scope="col">Transport Ventilator</th>
                                <th style="text-align: center" scope="col">Volumetric Infusion Pump</th>
                                <th style="text-align: center" scope="col">Syringe Infusion Pump</th>
                                <th style="text-align: center" scope="col">Pulse Oximeter</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if (is_array($amb_data)) {
                                foreach ($amb_data as $amb) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $amb->pump; ?> </td>
                                        <td><?php echo $amb->oxy_sys; ?> </td>
                                        <td><?php echo $amb->cardiac_monitor; ?> </td>
                                        <td><?php echo $amb->transport; ?> </td>
                                        <td><?php echo $amb->volumetric; ?> </td>
                                        <td><?php echo $amb->syring; ?> </td>
                                        <td><?php echo $amb->pulse; ?> </td>
