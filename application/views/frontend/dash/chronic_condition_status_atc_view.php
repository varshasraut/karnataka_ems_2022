...
<div class="breadcrumb float_left">
        <ul>
            ...
            <li>
             ...
             <li>
                <span><?php echo $chron_type[$action];?></span>
            </li>
...
<!--                        <td><?php echo $key;?></td>                            -->
                        <td><a id="atc_<?php echo $screning['atc_id'];?>" class="click-xhttp-request" data-href="{base_url}dash/<?php echo $atc_po_linke;?>" data-qr="output_position=content&atc=<?php echo $screning['atc_id'];?>&action=<?php echo $action;?>"><?php echo $screning['atc_name'];?> ATC</a></td> 
                        ...
                        if($action == 'chronic_birth_defects'){
                        ...
                        <?php }else if($action == 'deficiencies'){ 
                              $chart_value[] = $screning['total_screening']['deficiencies']?$screning['total_screening']['birth_defect']:0;
                            ?>
