            ...
            <div id="list_table">
                ...
                <table class="table report_table">
                    ...
                    <tr>
                        ...
                        <td>1</td>                            
                        <td> <a class="click-xhttp-request" data-href="{base_url}dash/<?php echo $atc_po_linke;?>" data-qr="output_position=content&atc=1">Nashik ATC</a></td>    
                        <td>26</td>  
                        <td>25</td>   
                        <td>96</td>   
                        <td>116</td>   
                    ...
                    <tr>
                        ...
                        <td>2</td>                            
                        <td><a class="click-xhttp-request" data-href="{base_url}dash/<?php echo $atc_po_linke;?>" data-qr="output_position=content&atc=2">Amravati ATC</a></td>    
                        <td>12</td>  
                        <td>12</td>
                       <td>66</td>   
                        <td>76</td> 
                    ...
                    <tr>
                        ...
                        <td>3</td>                            
                        <td><a class="click-xhttp-request" data-href="{base_url}dash/<?php echo $atc_po_linke;?>" data-qr="output_position=content&atc=3">Nagpur ATC</a></td>    
                        <td>10</td>  
                        <td>6</td>   
                        <td>16</td> 
                       <td>16</td> 
