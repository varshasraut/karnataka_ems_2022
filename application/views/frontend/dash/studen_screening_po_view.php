                ...
                <table class="table report_table">
                    ...
                    // $color_array = array("#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850","#c45777","#158F2E","#2acfca");
                     ...
                     foreach($atc_screening as $key=>$screning){ 
                        $chart_value[] = $screning['total_screening'];
                        $chart_label[] = $screning['po_name'];
                        $chart_color[] =  rand_color();
                        $chart_ids[] = $screning['po_id'];?>
                    <tr>
                         <td><a id='po_<?php echo $screning['po_id'];?>' class="click-xhttp-request" data-href="{base_url}dash/<?php echo $cluster_link_atc;?>" data-qr="output_position=content&atc=<?php echo $screning['atc_id'];?>&po=<?php echo $screning['po_id'];?>"><?php echo $screning['po_name'];?></a></td>  

                        <td><?php echo $screning['today_screening'];?></td>  
                        <td><?php echo $screning['month_screening'];?></td>   
                        <td><?php echo $screning['year_total_screening'];?></td>   
                         <td><?php echo $screning['total_screening'];?></td>   
                    </tr>
