<div id="b12_data_block">
    ...
    <div class="row">
        <form action="" id="b12_data" class="col-md-12" method="post">
            ...
            <div class="col-md-2 float_left">
                ...
                <input type="button" name="submit" value="Submit" class="form-xhttp-request button_print2" data-href='<?php echo base_url(); ?>dashboard/B12_data_New'>
        ...
        <div class="row">
            <div class="table-responsive">
                <table class="table table-bordered NHM_Dashboard B12_report_dash">
                    ...
                    $Accident_data_today1 = 0;
                    $assault_data_today1 = 0;
                    $burn_data_today1 = 0;
                    $attack_data_today1 = 0;
                    $fall_data_today1 = 0;
                    $poision_data_today1 = 0;
                    $labour_data_today1 = 0;
                    $light_data_today1 = 0;
                    $mass_data_today1 = 0;
                    $report_data_today1 = 0;
                    $other_data_today1 = 0;
                    $trauma_data_today1 = 0;
                    $suicide_data_today1 = 0;
                    $delivery_in_amb_data_today1 = 0;
                    $pt_manage_on_veti_data_today1 = 0;
                    $unavail_call_data_today1 = 0;
                    ...
                    if (is_array($inc_data)) {
                            ...
                            <tbody>
                                <tr>
                                    <td id="righttblh">&nbsp;Accident Vehicle</td>
                                     ...
                                     <td id="righttbl"><?php echo $inc['Accident_data_today']; ?></td> 
                                    <?php  
                                    //without validation
                                    $Accident_data_today = $Accident_data_today + $inc['Accident_data_today']; 
                                    //with validate
                                    $Accident_data_today1 = $Accident_data_today1 + $inc['Accident_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['Accident_data'];
                                                        $Accident_data = $Accident_data + $inc['Accident_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['Accident_data_tm'] + $Accident_data_today1;
                                                        $Accident_data_tm = $Accident_data_tm + $inc['Accident_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['Accident_data_td'] + $Accident_data_today1;
                                                        $Accident_data_td = $Accident_data_td + $inc['Accident_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Assault</td>

                                 <td id="righttbl"><?php echo $inc['assault_data_today'];  ?></td> 
                                    <?php 
                                    $assault_data_today = $assault_data_today + $inc['assault_data_today']; 
                                    //with validate
                                    $assault_data_today1 = $assault_data_today1 + $inc['assault_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['assault_data'];
                                                        $assault_data = $assault_data + $inc['assault_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['assault_data_tm'] + $assault_data_today1;
                                                        $assault_data_tm = $assault_data_tm + $inc['assault_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['assault_data_td'] + $assault_data_today1;
                                                        $assault_data_td = $assault_data_td + $inc['assault_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Burns</td>

                                    <td id="righttbl"><?php echo $inc['burn_data_today']; ?></td>
                                    <?php $burn_data_today = $burn_data_today + $inc['burn_data_today']; 
                                    $burn_data_today1 = $burn_data_today1 + $inc['burn_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['burn_data'];
                                                        $burn_data = $burn_data + $inc['burn_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['burn_data_tm'] + $burn_data_today1 ;
                                                        $burn_data_tm = $burn_data_tm + $inc['burn_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['burn_data_td'] + $burn_data_today1;
                                                        $burn_data_td = $burn_data_td + $inc['burn_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Cardiac</td>

                                 <td id="righttbl"><?php echo $inc['attack_data_today']; ?></td>
                                    <?php  $attack_data_today = $attack_data_today + $inc['attack_data_today']; 
                                           $attack_data_today1 = $attack_data_today1 + $inc['attack_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['attack_data'];
                                                        $attack_data = $attack_data + $inc['attack_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['attack_data_tm'] + $attack_data_today1;
                                                        $attack_data_tm = $attack_data_tm + $inc['attack_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['attack_data_td'] + $attack_data_today1;
                                                        $attack_data_td = $attack_data_td + $inc['attack_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Fall</td>

                                    <td id="righttbl"><?php echo $inc['fall_data_today']; ?></td>
                                    <?php $fall_data_today = $fall_data_today + $inc['fall_data_today']; 
                                            $fall_data_today1 = $fall_data_today1 + $inc['fall_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['fall_data'];
                                                        $fall_data = $fall_data + $inc['fall_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['fall_data_tm'] + $fall_data_today1;
                                                        $fall_data_tm = $fall_data_tm + $inc['fall_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['fall_data_td'] + $fall_data_today1;
                                ...
                                <tr>
                                    ...
                                    <td id="righttbl"><?php echo $inc['poision_data_today']; ?></td>
                                    <?php $poision_data_today = $poision_data_today + $inc['poision_data_today']; 
                                    $poision_data_today1 = $poision_data_today1 + $inc['poision_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['poision_data'];
                                                        $poision_data = $poision_data + $inc['poision_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['poision_data_tm'] + $poision_data_today1;
                                                        $poision_data_tm = $poision_data_tm + $inc['poision_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['poision_data_td'] + $poision_data_today1;
                                                        $poision_data_td = $poision_data_td + $inc['poision_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Labour/Pregnancy</td>

                                    <td id="righttbl"><?php echo $inc['labour_data_today']; ?></td>
                                    <?php $labour_data_today = $labour_data_today + $inc['labour_data_today']; 
                                    $labour_data_today1 = $labour_data_today1 + $inc['labour_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['labour_data'];
                                                        $labour_data = $labour_data + $inc['labour_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['labour_data_tm'] + $labour_data_today1;
                                                        $labour_data_tm = $labour_data_tm + $inc['labour_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['labour_data_td'] + $labour_data_today1;
                                                        $labour_data_td = $labour_data_td + $inc['labour_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Lighting/Electrocution</td>

                                    <td id="righttbl"><?php echo $inc['light_data_today'];  ?></td>
                                    <?php $light_data_today = $light_data_today + $inc['light_data_today'];
                                    $light_data_today1 = $light_data_today1 + $inc['light_data_today1'];
                                     ?>
                                    <td id="righttbl"><?php echo $inc['light_data'];
                                                        $light_data = $light_data + $inc['light_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['light_data_tm'] + $light_data_today1;
                                                        $light_data_tm = $light_data_tm + $inc['light_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['light_data_td'] + $light_data_today1;
                                ...
                                <tr>
                                    ...
                                    <td id="righttbl"><?php echo $inc['mass_data_today'];  ?></td>
                                    <?php $mass_data_today = $mass_data_today + $inc['mass_data_today']; 
                                            $mass_data_today1 = $mass_data_today1 + $inc['mass_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['mass_data'];
                                                        $mass_data = $mass_data + $inc['mass_data']; ?></td>
                                    <!-- <td id="righttbl"></td> -->
                                    <td id="righttbl"><?php echo $inc['mass_data_tm'] + $mass_data_today1;
                                                        $mass_data_tm = $mass_data_tm + $inc['mass_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['mass_data_td'] + $mass_data_today1;
                                                        $mass_data_td = $mass_data_td + $inc['mass_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Medical</td>

                                    <td id="righttbl"><?php echo $inc['report_data_today'];  ?></td>
                                    
                                    <?php $report_data_today = $report_data_today + $inc['report_data_today']; 
                                    $report_data_today1 = $report_data_today1 + $inc['report_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['report_data'];
                                                        $report_data = $report_data + $inc['report_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['report_data_tm'] + $report_data_today1;
                                                        $report_data_tm = $report_data_tm + $inc['report_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['report_data_td'] + $report_data_today1;
                                ...
                                <tr>
                                    ...
                                    <td id="righttbl"><?php echo $inc['trauma_data_today']; ?></td>
                                    <?php $trauma_data_today = $trauma_data_today + $inc['trauma_data_today']; 
                                        $trauma_data_today1 = $trauma_data_today1 + $inc['trauma_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['trauma_data'];
                                                        $trauma_data = $trauma_data + $inc['trauma_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['trauma_data_tm'] + $trauma_data_today1;
                                                        $trauma_data_tm = $trauma_data_tm + $inc['trauma_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['trauma_data_td'] + $trauma_data_today1;
                                                        $trauma_data_td = $trauma_data_td + $inc['trauma_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Suicide/Self Inflicted Injury</td>

                                    <td id="righttbl"><?php echo $inc['suicide_data_today']; ?></td>
                                    <?php $suicide_data_today = $suicide_data_today + $inc['suicide_data_today'];
                                          $suicide_data_today1 = $suicide_data_today1 + $inc['suicide_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['suicide_data'];
                                                        $suicide_data = $suicide_data + $inc['suicide_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['suicide_data_tm'] + $suicide_data_today1;
                                                        $suicide_data_tm = $suicide_data_tm + $inc['suicide_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['suicide_data_td'] + $suicide_data_today1;
                                                        $suicide_data_td = $suicide_data_td + $inc['suicide_data_td']; ?></td>
                                </tr>
                                <tr>
                                    <td id="righttblh">&nbsp;Others</td>

                                    <td id="righttbl"><?php echo $inc['other_data_today']; ?></td>
                                    <?php $other_data_today = $other_data_today + $inc['other_data_today'];
                                    $other_data_today1 = $other_data_today1 + $inc['other_data_today1'];
                                    ?>
                                    <td id="righttbl"><?php echo $inc['other_data'];
                                                        $other_data = $other_data + $inc['other_data']; ?></td>
                                    <td id="righttbl"><?php echo $inc['other_data_tm'] + $other_data_today1;
                                                        $other_data_tm = $other_data_tm + $inc['other_data_tm']; ?></td>
                                    <td id="righttbl"><?php echo $inc['other_data_td'] + $other_data_today1;
                        ...
                        <tr>
                            ...
                            <?php $today = $Accident_data_today1 + $assault_data_today1 + $burn_data_today1 + $attack_data_today1 + $fall_data_today1 + $poision_data_today1 + $labour_data_today1 + $light_data_today1 + $mass_data_today1 + $report_data_today1 + $other_data_today1 + $trauma_data_today1 + $suicide_data_today1; ?>
    ...
    <div class="right-half">
        <div style="padding-left:50px;">
            <div id="ETWPS">
                ...
                <button type="button" id="frmbtm1" onclick="funto();" class="btn-outline-primary"><?php echo $date_before ?></button>
                <button type="button" id="frmbtm2" onclick="funto2()" class="btn-outline-primary">Till Month</button>
                <button type="button" id="frmbtm3" onclick="funto3()" class="btn-outline-primary">Till Date</button>
            </div>
            <div id="pie11">
                <canvas id="pieChart11" style="max-width:500px;display:inline;"></canvas>
            </div>
            <div id="pie22">
                <canvas id="pieChart22" style="max-width:500px;display:inline;"></canvas>
            </div>
            <div id="pie33">
                <canvas id="pieChart33" style="max-width:500px;display:inline;"></canvas>
            </div>
        </div>
        <div class="desctbl">
            <table class="table table-bordered NHM_Dashboard B12_report_dash">
                ...
                $delivery_in_amb_data1 = 0;
                $pt_manage_on_veti_data1 = 0;
                    ...
                    foreach ($inc_data as $inc) { ?>
                        <tbody>
                            <tr>
                                ...
                                <td id="lefttbltd" style="padding: 0px;"><?php echo $inc['delivery_in_amb_data_today'];  ?></td>
                                
                                <?php $delivery_in_amb_data_today = $delivery_in_amb_data_today + $inc['delivery_in_amb_data_today'];
                                $delivery_in_amb_data_today1 = $delivery_in_amb_data_today1 + $inc['delivery_in_amb_data_today1'];
                                ?>
                                ...
                                <td id="lefttbltd" style="padding: 0px;"><?php echo $inc['delivery_in_amb_data_tm'] + $delivery_in_amb_data_today1;
                                                                            $delivery_in_amb_data_tm = $delivery_in_amb_data_tm + $inc['delivery_in_amb_data_tm']; ?></td>
                                <td id="lefttbltd" style="padding: 0px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $inc['delivery_in_amb_data_td'] + $delivery_in_amb_data_today1;
                            ...
                            <tr>
                                ...
                                <td id="lefttbltd" style="padding: 0px;"><?php echo $inc['pt_manage_on_veti_data_today']; ?></td>
                                
                                <?php $pt_manage_on_veti_data_today = $pt_manage_on_veti_data_today + $inc['pt_manage_on_veti_data_today'];
                                $pt_manage_on_veti_data_today1 = $pt_manage_on_veti_data_today1 + $inc['pt_manage_on_veti_data_today1'];
                                ?> 
                                ...
                                <td id="lefttbltd" style="padding: 0px;"><?php echo $inc['pt_manage_on_veti_data_tm'] + $pt_manage_on_veti_data_today1;
                                                                            $pt_manage_on_veti_data_tm = $pt_manage_on_veti_data_tm + $inc['pt_manage_on_veti_data_tm']; ?></td>
                                <td id="lefttbltd" style="padding: 0px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $inc['pt_manage_on_veti_data_td'] + $pt_manage_on_veti_data_today1;
             ...
             <tr>
                ...
                <th id="lefttbl"><b><?php echo $pt_manage_on_veti_data_today1 + $delivery_in_amb_data_today1 + $delivery_in_amb_data_tm + $pt_manage_on_veti_data_tm; ?></b></th>
                <th id="lefttbl"><b>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $pt_manage_on_veti_data_today1 + $delivery_in_amb_data_today1 + $delivery_in_amb_data_td + $pt_manage_on_veti_data_td; ?>&nbsp;&nbsp;&nbsp;&nbsp;</b></th>
            </tr> 
            </table>
        </div>
        <div>
    ...
    <script>
        ...
        var ctxP = document.getElementById("pieChart11").getContext('2d');
        //alert();
    ...
    <script>
        function funto() {
            document.getElementById('pie11').style.display = 'block';
            document.getElementById('pie22').style.display = 'none';
            document.getElementById('pie33').style.display = 'none';

        }

        function funto2() {
            document.getElementById('pie22').style.display = 'block';
            document.getElementById('pie33').style.display = 'none';
            document.getElementById('pie11').style.display = 'none';
        }

        function funto3() {
            document.getElementById('pie33').style.display = 'block';
            document.getElementById('pie22').style.display = 'none';
            document.getElementById('pie11').style.display = 'none';
        }
    </script>
