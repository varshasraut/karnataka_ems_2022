...
<div class="row">
 <label style="padding-top:10px;text-align: center;font-size:20px;color:#black;">DIVISION DETAILS</label>
    ...
    <?php foreach($div_data as $key=>$screning){ ?>
        <tr>
        <td><a style="cursor:pointer" id="dis_<?php echo $screning['div_code'];?>" class="click-xhttp-request" data-href="{base_url}dashboard/nhm102_district_view" data-qr="output_position=content&div_code=<?php echo $screning['div_code'];?>"><?php echo $screning['div_name'];?></a>
