                ...
                <div class="field_row drg float_left">
                    ...
                    <div class="width100 float_left">  
                        <select name="report_type" class="change-base-xhttp-request" data-base="report_type" data-href="{base_url}reports/load_NHM8_summeryreport" data-qr="output_position=content">
                            ...
                            <option value="1">1. C - I Distance travelled by Ambulance </option>
                            <option value="2">2. C - II Ambulance EMT </option>
<!--                        <option value="3">3. C- III Utilization of Ambulances </option>
                            <option value="4">4. D-I Ambulance Response time - Golden Hour</option>
							<option value="5">4. D - II calls details</option>-->
							<option value="6">D - III Vehicle Status Information report For Ambulance</option>
							<option value="7">( E )  Formats for Performance Appraisal</option>
                           <!-- <option value="8">E - II Equipment report</option>
                            <option value="9">E - III EMSO performance report</option>-->
                        </select>
                    </div>
                </div>
            </div>
