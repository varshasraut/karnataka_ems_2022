...
echo $rerequest; ?>>
                ...
                <div class="width2 float_left">
                    <div class="field_lable float_left width33"><label for="off_road_date">Expected Onroad Date/Time<span class="md_field">*</span></label></div>
                    <div class="filed_input float_left width50" >
                        <input type="text" name="maintaince[mt_ontime_onroad_date]"  value="<?= @$preventive[0]->mt_ontime_onroad_date; ?>" class="mi_timecalender_month filter_required"  placeholder="Expected Onroad  Date/Time" data-errors="{filter_required:'Expected Onroad Date/Time should not be blank'}" TABINDEX="8" <?php echo $update; echo $approve;?>>
                    </div>
                </div>
                <div class="width2 float_left">
                    <div class="field_lable float_left width33"><label for="off_road_date">Off-Road Date/Time<span class="md_field">*</span></label></div>
                    <div class="filed_input float_left width50" >
                        <input type="text" name="maintaince[mt_offroad_date]"  value="<?= @$preventive[0]->mt_offroad_date; ?>" class="mi_timecalender_month filter_required" placeholder="Off-Road Date/Time" data-errors="{filter_required:'Off-Road  Date/Time should not be blank'}" TABINDEX="8" <?php echo $update; echo $approve;?>>
                    </div>
                </div>
                   ...
                   <div class="filed_input float_left width2">
                        ...
                        <div class="field_lable float_left width33"> <label for="mt_stnd_remark">Manpower issue for<span class="md_field">*</span></label></div>


                        <div class="filed_input float_left width50">

                            <select name="maintaince[mt_manpower_issue_for]" tabindex="8" class="filter_required" data-errors="{filter_required:'Standard Remark should not be blank!'}" <?php echo $update; echo $approve;?> > 
                                
                                <option value="Pilot" <?php if (@$preventive[0]->mt_manpower_issue_for == 'Pilot') { echo "selected=selected"; }?> >Pilot</option>
                                 <option value="EMT" <?php if (@$preventive[0]->mt_manpower_issue_for == 'EMT') { echo "selected=selected"; }?> >EMT</option>
                                  <option value="Both" <?php if (@$preventive[0]->mt_manpower_issue_for == 'Both') { echo "selected=selected"; }?> >Both</option>
...
//     $previous_odo_end =$preventive[0]->mt_in_odometer+300;
    ?>
                ...
                <div class="field_row width100">
                    ...
                    <div class="filed_input float_left width50" >
                        <input type="text" name="mt_end_odometer" value="<?php if ($preventive[0]->mt_end_odometer != 0) { echo $preventive[0]->mt_end_odometer; } ?>" class="filter_required" placeholder="End Odometer" data-errors="{filter_required:'End Odometer should not be blank',filter_valuegreaterthan:'In Odometer should greater than or equlto Previous Odometer'}" TABINDEX="8" <?php if ($preventive[0]->mt_end_odometer != 0) {
            echo "disabled";
        } ?>>
                ...
                <div class="width2 float_left">
                    <div class="field_lable float_left width33"><label for="off_road_date">Onroad Date/Time<span class="md_field">*</span></label></div>
                    <div class="filed_input float_left width50" >
                        <input type="text" name="maintaince[mt_ex_onroad_datetime]"  value="" class="mi_timecalender_month filter_required"  placeholder="Onroad Date/Time" data-errors="{filter_required:'Onroad Date/Time should not be blank'}" TABINDEX="8" >
                    </div>
                </div>
                    <div class="width2 float_left">
