...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Scrap Ambulance</span></li>
    </ul>
</div>
...
<div class="width2 float_right">
    ...
    <input class="add_button_amb click-xhttp-request float_right" name="add_amb" value="Add More" data-href="{base_url}ambulance_maintaince/scrape_vahicle_add" data-qr="output_position=popup_div&amp;module_name=amb_maintaince" type="button" data-popupwidth="800" data-popupheight="700"> 
     <?php } ?>

    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}ambulance_maintaince/scrape_vahicle" data-qr="output_position=content&amp;filters=reset" type="button">
                    ...
                    if (count($maintance_data) > 0) {
                        ...
                        foreach ($maintance_data as $stat_data) { ?>
                            ...
                            <td><?php echo $count; ?></td> 
                                ...
                                <td><?php echo $stat_data->mt_scrape_vahicle; ?></td> 
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                            ...
                                            <?php if ($CI->modules->get_tool_config('MT-SCRP-VHC-VIEW', 'M-AMB-MAINT', $this->active_module, true) != '') { ?>   
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/scrape_vahicle_view"  data-qr="output_position=popup_div&amp;tlcode=MT-PREV-MANT-VIEW&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=View" data-popupwidth="1000" data-popupheight="350">View</a></li>

                                                <?php
                                            }
                                           if ($CI->modules->get_tool_config('MT-SCRP-VHC-UPDATE', 'M-AMB-MAINT', $this->active_module, true) != '' && $stat_data->mt_isupdated == 0 &&  $stat_data->mt_approval == 1 ) {
                                               // if ($stat_data->mt_isupdated == 0 &&  $stat_data->mt_approval == 1 ) {
                                                ?>   


<!--                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/scrape_vahicle_add" data-qr="output_position=content&amp;module_name=amb_maintaince&amp;tlcode=MT-PREV-MANT-UPDATE&amp;mt_id=<?php echo $stat_data->mt_id; ?>&action_type=Update" data-popupwidth="1000" data-popupheight="450">Update</a></li>          -->
                                             ...
                                             ?>
                                             <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/scrape_vahicle_add"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-APP&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=Approve" data-popupwidth="1000" data-popupheight="350">Approve</a></li>
