...
<div class="width2 float_left">
    ...
    <div class="filed_input float_left width50" >
        <input type="text" name="breakdown[mt_accidental_previos_odometer]" id="filling_previous_odometer" value="<?= @$current_odometer; ?>"  class="filter_required filter_maxlength[7] filter_number" placeholder="Previous Odometer" data-errors="{filter_required:'Please select Previous Odometer',filter_maxlength:'Fuel Filling Previous Odometer at max 6 digit long.',filter_number:'number shuold be integer'}" TABINDEX="8" readonly='readonly' onkeyup="sum(this);">
 ...
 <div class="width2 float_left">
                        ...
                        <div class="filed_input float_left width50" >
                              <input type="text" name="previous_odometer" id="previous_odometer" value="<?=@$previous_odometer;?>" class="filter_required" placeholder="Previous Odometer" data-errors="{filter_required:'Previous Odometer should not be blank'}" TABINDEX="8" <?php echo $update; echo $approve; echo $rerequest;?> readonly='readonly'>
...
<div class="width2 float_left">
    ...
    <div class="filed_input float_left width50" >
        ...
        <input type="text" name="in_odometer" value="" class="filter_required filter_maxlength[7] filter_number filter_valuegreaterthan[<?=@$previous_odometer;?>]" id="end_odometer" onkeyup="sum(this);"placeholder="Current Odometer" data-errors="{filter_required:'In odometer should not be blank',filter_valuegreaterthan:'Current Odometer should greater than or equal Previous Odometer' ,filter_maxlength:'Previous Odometer at max 6 digit long.',filter_number:'number shuold be integer'}" TABINDEX="8">
    </div>
</div>
<div class="width2 float_left">
