            ...
            <div class="width100">
                ...
                <div class="field_row width100">
                    ...
                    <div class="field_row width100">
                        ...
                        <div class="width2 float_left">
                            <div class="field_lable float_left width33 strong"><label for="end_odometer">Scrap Ambulance Inactive<span class="md_field">*</span></label></div>

                            <div class="filed_input float_left width50" >
                                <?=@$preventive[0]->mt_inactive;?>
                    ...
                    <div class="field_row width100">
                    <div class="width2 float_left">
                            <div class="field_lable float_left width33 strong"><label for="end_odometer">Scrap Added Date/Time<span class="md_field">*</span></label></div>

                            <div class="filed_input float_left width50" >
                                <?=@$preventive[0]->mt_scrap_added_date;?>
