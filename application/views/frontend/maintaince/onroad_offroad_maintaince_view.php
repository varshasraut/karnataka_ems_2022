    ...
    <div class="filed_input float_left width50">
        <?= @$preventive[0]->mt_pilot_name; ?>
                ...
                <div class="field_row width100" id="maintance_previous_odometer">
                    ...
                    <!-- <div class="width2 float_left">
                        <div class="field_lable float_left width33 strong"><label for="in_odometer">In Odometer<span class="md_field">*</span></label></div>
                ...
                <div class="field_row width100">
                    <div class="width2 float_left">
                        ...
                        <div class="field_lable float_left width33 strong"><label for="off_road_date">Estimate Cost<span class="md_field">*</span></label></div>
                    ...
                    <div class="width2 float_left">
                        ...
                        <div class="field_lable float_left width33 strong"><label for="mt_ex_onroad_datetime">On-road Date/Time<span class="md_field">*</span></label></div>
...
<div class="filed_input float_left width50" >
  ...
  <?php echo "On-road / Off-road Approval Information"; ?>
</div>
    ...
    <div class="filed_input float_left width2"> 
        ...
        <div class="filed_input float_left width50">
            <?php if (@$preventive[0]->mt_approval == '1') {
                        echo "On-road / Off-road Approved";
                    }else{
                        echo "On-road / Off-road Approval Pending";
                    }
            ?>
