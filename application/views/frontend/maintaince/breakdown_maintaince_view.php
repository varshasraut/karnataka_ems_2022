    ...
    <div class="filed_input float_left width50">
        <?= @$fuel_data[0]->ff_emso_name; ?>
                    ...
                    <div class="width100">
                        ...
                        <div class="width2 float_left">
                            <div class="field_lable float_left width33 strong"><label for="mt_estimatecost">Approved Estimate Amount<span class="md_field"></span></label></div>
                            <div class="filed_input float_left width50">
                                <?= @$preventive[0]->mt_app_est_amt; ?>
                            </div>
                        </div>
                    </div>
                    <div class="field_row width100">
                ...
                <div class="field_row width100">
                    ...
                    <div class="width2 float_left">
                        ...
                        <div class="field_lable float_left width33 strong"><label for="city">Breakdown Date/Time<span class="md_field"></span></label></div>

                        <div class="filed_input float_left width50">

                            <?php echo $preventive[0]->mt_breakdown_datetime; ?>
                    ...
                    <div class="width2 float_left">
                        ...
                        <div class="field_lable float_left width33 strong"><label for="city">Breakdown type<span class="md_field"></span></label></div>

                        <div class="filed_input float_left width50">
                            <?php if ($preventive[0]->mt_breakdown_type != "Others") {
                                echo $preventive[0]->mt_breakdown_type;
                            } else {
                                echo $preventive[0]->mt_breakdown_type . "(" . $preventive[0]->other_break_type . ")";
                            } ?>
                        </div>
                    </div>
                </div>
                <div class="field_row width100">
                    <div class="width2 float_left">
                        ...
                        <div class="field_lable float_left width33 strong"><label for="off_road_date">Material used<span class="md_field"></span></label></div>

                        <div class="filed_input float_left width50">
                            <?= @$preventive[0]->mt_material_used; ?>

                        </div>
                    </div>
                    <div class="width2 float_left">

                        <div class="field_lable float_left width33 strong"><label for="mt_ex_onroad_datetime">Local Purchase<span class="md_field"></span></label></div>

                        <div class="filed_input float_left width50">
                            <?= @$preventive[0]->mt_local_purchase; ?>
                        </div>
                    </div>
                    <div class="width2 float_left">

                        <div class="field_lable float_left width33 strong"><label for="mt_ex_onroad_datetime">Local Purchase Cost<span class="md_field"></span></label></div>
                ...
                <div class="field_row width100">
                    <?php if ($preventive[0]->mt_offroad_datetime != '' || $preventive[0]->mt_offroad_datetime != '0000-00-00 00:00:00') { ?>
                        <div class="width2 float_left">
                    ...
                    <div class="filed_input float_left width2">
                        ...
                        <div class="filed_input float_left width50">
                            ...
                            if (trim($preventive[0]->mt_stnd_remark) == 'Ambulance_breakdown_maintaince') {
                                echo "Breakdown Ambulance Off-road";
                            }
                            ?>
                        </div>
                    </div>
        ...
        <div class="field_row width100">
            ...
            <div class="width2 float_left">
                ...
                <div class="filed_input float_left width50">
                    <?php if ($preventive[0]->mt_onroad_datetime != '0000-00-00 00:00:00' && $preventive[0]->mt_onroad_datetime != '' && $preventive[0]->mt_onroad_datetime != '1970-01-01 00:00:00') {
        ...
        <div class="field_row width100">
            <div class="filed_input float_left width2">
                ...
                <div class="field_lable float_left width33 strong"> <label for="mt_on_stnd_remark">Standard Remark<span class="md_field"></span></label></div>


                <div class="filed_input float_left width50">
                    <?php
                    if (trim($preventive[0]->mt_on_stnd_remark) == 'Ambulance_breakdown_maintaince_onroad') {
                        echo "Breakdown Ambulance On-road";
                    }
                    ?>
                </div>
            </div>
                    ...
                    foreach ($vendor_job_card as $img) {
                        ...
                        if (file_exists($pic_path)) {
                            ...
                            if (in_array($ext, $haystack)) {
                                $bk_blank_pic_path = base_url() . "themes/backend/images/allinone.png";
                            } else {
                                $bk_blank_pic_path = base_url() . "uploads/ambulance/" . $name;
                            }
                        }
                        // $bk_blank_pic_path = base_url() . "themes/backend/images/allinone.png";
                ?>
                        <div class="images_block" id="image_<?php echo $img->id; ?>">
                            ...
                            <?php }
                            ?>
                            <a class="ambulance_photo float_left" target="blank" href="<?php echo $pic_path1; ?>" style="background: url('<?php
                                                                                                                                            if (file_exists($pic_path)) {
                                                                                                                                                echo $bk_blank_pic_path;
                                                                                                                                            } else {
                                                                                                                                                echo $blank_pic_path;
                                                                                                                                            }
