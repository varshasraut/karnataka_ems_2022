...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>General Offroad/Standby</span></li>
    </ul>
</div>

<div class="width2 float_right">
     <?php if ($CI->modules->get_tool_config('MT-OFFROAD-MANT-ADD', 'M-AMB-MAINT', $this->active_module, true) != '') { ?>
    <input class="add_button_amb click-xhttp-request float_right" name="add_amb" value="Add More" data-href="{base_url}ambulance_maintaince/onroad_offroad_maintaince_registrartion" data-qr="output_position=popup_div&amp;module_name=amb_maintaince" type="button" data-popupwidth="800" data-popupheight="700"> 
    <?php } ?>
    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}ambulance_maintaince/onraod_offroad_maintaince" data-qr="output_position=content&amp;filters=reset" type="button">
                    ...
                    if (count($maintance_data) > 0) {
                        ...
                        foreach ($maintance_data as $stat_data) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $stat_data->mt_onoffroad_id; ?></td> 
                                ...
                                <!--<td><?php echo show_amb_status_name($stat_data->amb_status); ?></td>-->
                                    <td><?php echo $stat_data->mt_ambulance_status; if($stat_data->mt_ambulance_status == "In Maintenance-OFF Road" || $stat_data->mt_ambulance_status == "OFF Road"){ ?> for <?php if($stat_data->mt_offroad_reason != '') { echo show_amb_offroad_reason($stat_data->mt_offroad_reason); } } ?> </td> 
                                <td><?php echo $stat_data->mt_remark; ?> </td>  
                                ...
                                <td><?php
                                    if ($stat_data->mt_onroad_datetime != '' && $stat_data->mt_onroad_datetime != '1970-01-01 05:30:00' && $stat_data->mt_onroad_datetime != '0000-00-00 00:00:00') {
                                        echo $stat_data->mt_onroad_datetime;
                                    } else {
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                             ...
                                             <?php if ($CI->modules->get_tool_config('MT-OFFROAD-MANT-VIEW', 'M-AMB-MAINT', $this->active_module, true) != '') { ?>   
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/onroad_offroad_maintaince_view"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=View" data-popupwidth="1000" data-popupheight="350">View</a></li>

                                                <?php
                                            }
                                            if ($CI->modules->get_tool_config('MT-OFFROAD-MANT-UPDATE', 'M-AMB-MAINT', $this->active_module, true) != '' && $stat_data->mt_isupdated == 0 && $stat_data->mt_approval == 1) {
                                                ?>   


                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/onroad_offroad_maintaince_registrartion" data-qr="output_position=content&amp;module_name=amb_maintaince&amp;tlcode=MT-PREV-MANT-UPDATE&amp;mt_id=<?php echo base64_encode($stat_data->mt_id); ?>&action_type=Update" data-popupwidth="1000" data-popupheight="450">Closure</a></li>          


                                            <?php }
                                            if ($CI->modules->get_tool_config('MT-ONOFFROAD-MANT-APP', 'M-AMB-MAINT', $this->active_module, true) != '' &&  $stat_data->mt_approval == 0) {
                                                ?>
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/approve_onroad_offroad_maintaince"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-APP&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=Approve" data-popupwidth="1000" data-popupheight="350">Approve</a></li>
    
                                                <?php
                                                } ?>
                                            <?php if($CI->modules->get_tool_config('MT-ONOFFROAD-MANT-RE', 'M-AMB-MAINT', $this->active_module, true) != '' &&  ($stat_data->mt_approval == 0 || $stat_data->mt_approval == 3) ){ ?>
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/onroad_offroad_re_request"  data-qr="output_position=content&amp;tlcode=MT-ONOFFROAD-MANT-RE&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=Rerequest" data-popupwidth="1000" data-popupheight="350">Re-Request</a></li>
                                            <?php } ?>
                    ...
                    <div class="width38 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}ambulance_maintaince/onraod_offroad_maintaince" data-qr="output_position=content&amp;flt=true&search=<?php echo $search; ?>&search_status=<?php echo $search_status;?>&to_date=<?php echo $to_date ;?>&from_date=<?php echo $from_date;?>">
