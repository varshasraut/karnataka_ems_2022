...
<div class="breadcrumb float_left">
    <ul>
        ...
        <li><span>Accidental Maintenance</span></li>
    </ul>
</div>

<div class="width2 float_right">
    <?php if ($CI->modules->get_tool_config('MT-ADD-ACCI-MTNS', 'M-AMB-MAINT', $this->active_module, true) != '') { ?>   
    <input class="add_button_amb click-xhttp-request float_right" name="add_amb" value="Add More" data-href="{base_url}ambulance_maintaince/accidental_maintaince_registrartion" data-qr="output_position=popup_div&amp;module_name=amb_maintaince" type="button" data-popupwidth="800" data-popupheight="700"> 
    <?php } ?>

    <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}ambulance_maintaince/accidental_maintaince" data-qr="output_position=content&amp;filters=reset" type="button">
                    ...
                    if (count($maintance_data) > 0) {
                        ...
                        foreach ($maintance_data as $stat_data) { ?>
                            ...
                            <td><?php echo $count; ?></td> 
                                <td><?php echo $stat_data->mt_accidental_id; ?></td> 
                             <td><?php echo $stat_data->dst_name; ?></td> 
                                ...
                                <!-- <td><?php echo show_amb_status_name($stat_data->amb_status); ?></td> -->
                                 ...
                                 <td><?php echo $stat_data->mt_accidentdate; ?> </td>
                                ...
                                <td> 
                                    ...
                                    <div class="user_action_box">
                                        ...
                                        <ul class="profile_actions_list">
                                            ...
                                            <?php if ($CI->modules->get_tool_config('MT-VIEW-ACCI-MTNS', 'M-AMB-MAINT', $this->active_module, true) != '') { ?>   
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/accidental_maintaince_view"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-VIEW&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=View" data-popupwidth="1000" data-popupheight="350">View</a></li>

                                                <?php
                                            }
                                            if ($CI->modules->get_tool_config('MT-UPDATE-ACCI-MTNS', 'M-AMB-MAINT', $this->active_module, true) != '' && $stat_data->mt_isupdated == 0 &&  $stat_data->mt_approval == 1 ) {
                                                ?>   


                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/accidental_maintaince_registrartion" data-qr="output_position=content&amp;module_name=amb_maintaince&amp;tlcode=MT-PREV-MANT-UPDATE&amp;mt_id=<?php echo base64_encode($stat_data->mt_id); ?>&action_type=Update" data-popupwidth="1000" data-popupheight="450">Closure</a></li>          


                                            <?php }
                                            if ($CI->modules->get_tool_config('MT-ACCI-MTNS-APP', 'M-AMB-MAINT', $this->active_module, true) != '' &&  $stat_data->mt_approval == 0) {
                                            ?>
                                            <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/approve_accidental_maintaince"  data-qr="output_position=content&amp;tlcode=MT-PREV-MANT-APP&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id;?>&amp;re_request_id=<?php echo $stat_data->re_request_id;?>&amp;action_type=Approve" data-popupwidth="1000" data-popupheight="350">Approve</a></li>

                                            <?php
                                            } 
                                            ?>
                                            <?php if(($CI->modules->get_tool_config('MT-ACCI-MANT-RE-R', 'M-AMB-MAINT', $this->active_module, true) != '' &&  $stat_data->mt_approval == 0 ) ){?>
                                                <li><a class="click-xhttp-request action_button" data-href="{base_url}ambulance_maintaince/accidental_re_request"  data-qr="output_position=content&amp;tlcode=MT-ACCI-MANT-RE-R&amp;module_name=amb_maintaince&amp;mt_id=<?php echo $stat_data->mt_id; ?>&amp;action_type=Rerequest" data-popupwidth="1000" data-popupheight="350">Re-Request</a></li>
                                            <?php } ?>
