        ...
        <div class="width100 dialer_outer_block">
            ...
            <!--                <span class="dialer_delete"></span>-->
                    ...
                    <div class="dia_botton_block">
                        <ul>
                            <li class="dial_button"><a class="form-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/soft_dial"></a></li>

                            <li class="disconnect_button disabledbutton" ><a class="form-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/soft_dial_disconnect" data-qr='output_position=content'></a></li>
                        </ul>
                    </div>
