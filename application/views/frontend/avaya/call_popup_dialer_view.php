                ...
                <div class="width100 dialer_numbers" id="dialer_box">
                    <div class="dialer_msg">
                        ...
                        <div class="width100 dial_no" id="dial_no_box">
                            <input class="no" type="text" value="12<?php
                            if (!empty($mobile_no)) {
                                echo $mobile_no;
                            } else {
                                echo '0';
...
<!--                                <a class="form-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/soft_dial"></a>-->
                            <a data-href="<?php echo base_url();?>calls/atnd_cls" data-qr="output_position=content&tool_code=mt_atnd_calls&m_no=<?php echo $m_no;?>&ext_no=<?php echo $ext_no;?>&CallUniqueID=<?php echo $CallUniqueID;?>" class="click-xhttp-request"></a>
                            </li>

<!--                            <li class="disconnect_button" ><a class="click-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/disconnect_call" data-qr='output_position=content&ActionID=<?php echo time();?>&AgentID=<?php echo $ext_no;?>'></a></li>-->
                        </ul>
                    </div>
                    ...
                    <!--            <div class="after_call_connect">
                                    <div class="dia_botton_block">
                                        <ul>
                                            <li class="conference_button"><a class="form-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/conference_call"></a></li>
                                            <li class="call_transfer_button"><a class="form-xhttp-request" data-href="<?php echo base_url(); ?>coral_avaya_api/transfter_call"></a></li>
                                        </ul>
                                    </div>
                                </div>-->
