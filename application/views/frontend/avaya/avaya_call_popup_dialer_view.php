...
<!--                                <a class="form-xhttp-request" data-href="<?php echo base_url(); ?>avaya_api/soft_dial"></a>-->
                                <a data-href="<?php echo base_url();?>calls/atnd_cls" data-qr="output_position=content&tool_code=mt_atnd_calls&m_no=<?php echo $m_no;?>&ext_no=<?php echo $ext_no;?>&CallUniqueID=<?php echo $CallUniqueID;?>" class="click-xhttp-request" title="Attend Call"></a>
                            </li>
