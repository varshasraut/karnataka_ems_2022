...
<div class="box_head text_align_center width100">
    <h3 class="txt_pro">APPRICIATION CALL </h3>
</div>
...
<div class="confirm_save width100">
    ...
    <div class="summary_info">
        ...
        <ul class="dtl_block">
            ...
            <li><span> Standard Remark :</span><?php echo $re_name; ?> <?php echo $appriciation; ?></li>
            <li><span>ERO Note : </span><?php echo $inc_ero_summary; ?></li>
<!--            <li><span>Appriciation : </span><?php echo $appriciation; ?></li>-->
        </ul>
