<div class="call_purpose_form_outer">
    ...
    <!-- <h3>Silent Call</h3> -->
    <label class="headerlbl">Silent Call</label>
    <div id="totalnon_div">
...
<div id="nonright_half">
            <table id="script_table">
                <!--<tr>
                    ...
                    <td>कॉलवर कॉलर कडून काहीच प्रतिउत्तर न आल्यास व आजूबाजूचा आवाज ही येत नसल्यास इ.आर.ओ ने कॉलर ला विनंती करावी कि पुन्हा १०८ ला कॉल करावा आणि क्लोजिंग स्क्रिप्ट वापरून कॉल संपवावा.</td>

                </tr>-->
                <tr>
                    <td id="script_table_td">Standard Remarks Hindi</td>
                    <td>यदि कॉलर की ओर से कॉल पर कोई प्रतिक्रिया नहीं आ रही  है और आसपास की आवाज आ भी नहीं आ पा रही है, तो इ.आर.ओ ने कॉलर को अनुरोध करना चाहिए की वो फिर से 108 संजीवनी पर कॉल करे और क्लोजिंग स्क्रिप्ट का उपयोग करके कॉल को समाप्त करना चाहिए।</td>
