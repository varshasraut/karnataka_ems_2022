<div class="call_purpose_form_outer">
    ...
    <!-- <h3>Unattended Call</h3> -->
    <label class="headerlbl">Unattended Call</label>
...
<div id="nonright_half">
            <table id="script_table">
                <tr>
                    ...
                    <td>अनअटेंडेड कॉल / कॉल आने के बावजूद भी यदि इ.आर.ओ द्वारा कॉल का जवाब न देने पर यह कॉल टाइप ऑटोमॅटिक सेव किया जाता है !</td>
