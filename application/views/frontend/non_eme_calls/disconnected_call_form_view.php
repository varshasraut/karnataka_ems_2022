<div class="call_purpose_form_outer">
    ...
    <!-- <h3>Disconnected call</h3> -->
    <label class="headerlbl">Disconnected call</label>
    <div id="totalnon_div">
...
<div id="nonright_half">
            <table id="script_table">
                <!--<tr>
                    ...
                    <td>कॉलर शी बोलताना जर कॉल डिस्कनेक्ट झाल्यास इ.आर.ओ (ERO) ने प्रथम कॉलर ला कॉल बॅक करावा आणि ३ प्रयत्नानं नंतर ही कॉल कनेक्ट होऊ शकला नाही तर हा कॉल टाइप सिलेक्ट करावा.</td>

                </tr>-->
                <tr>
                    <td id="script_table_td">Standard Remarks Hindi</td>
                    <td>यदि कॉलर से बात करते समय कॉल डिस्कनेक्ट हो जाती है, तो इ.आर.ओ ने पहले कॉलर को वापस कॉल करना चाहिए और 3 प्रयासों के बाद भी यदि कॉल कनेक्ट नहीं हो पा रही है तो फिर इस कॉल प्रकार का चयन करिये|</td>
