...
<form method="post" name="" id="sick_room">
    ...
    <div class="width2 float_left">
        <div class="width100">
            <div class="form_field width100 select float_left">
                    ...
                    <div class="label">Sick Room Name</div>

                    <div class="input top_left">
                        <input name="sickroom_id" value="<?=@$sickroom[0]->school_id;?>" class="mi_autocomplete width99 filter_required" data-href="{base_url}auto/get_school_by_healthsupervisor"  data-base="" tabindex="7" data-value="<?php echo $sickroom[0]->school_name; ?>" data-nonedit="yes" readonly="readonly" data-errors="{filter_required:'Sick should not be blank'}"  >
                    </div>
            </div>
            <div class="form_field width100 select float_left">
                    ...
                    <div class="input top_left">
                        <input id="school_id" name="school_id" value="<?=@$school[0]->school_id;?>" class="mi_autocomplete width99 filter_required" data-href="{base_url}auto/get_auto_school"  data-base="" tabindex="7" data-value="<?php echo $school[0]->school_name; ?>" data-nonedit="yes" readonly="readonly" data-errors="{filter_required:'School should not be blank'}" data-callback-funct="get_student_by_school" >
                    </div>
            </div>   
            <div class="form_field width100 select float_left" >
                    ...
                    <div class="input top_left" id="school_student_data">
                        <input name="student_id" value="<?=@$students[0]->stud_id;?>" class="mi_autocomplete width99 filter_required" data-href="{base_url}auto/get_auto_student"  data-base="" tabindex="7" data-value="<?php echo $students[0]->stud_first_name; ?> <?php echo $students[0]->stud_middle_name; ?>" <?php echo $students[0]->stud_last_name; ?> data-nonedit="yes" readonly="readonly" data-errors="{filter_required:'Student should not be blank'}">
                    </div>
            </div>   
        </div>
    </div>
    <div class="width2 float_left">
        ...
        <?php if($view != 'view'){?>
        <input type="button" name="save" value="Save" class="accept_btn form-xhttp-request" data-href='{base_url}sickroom/save_add_sickroom' data-qr="output_position=content&amp;action=1"  tabindex="25">
        
        <input type="button" name="discharge" value="Discharge" class="accept_btn form-xhttp-request" data-href='{base_url}sickroom/save_add_sickroom' data-qr="output_position=content&amp;action=2"  tabindex="25">
        <input type="button" name="shift_to_hospital" value="Shift to hopsital" class="accept_btn form-xhttp-request" data-href='{base_url}sickroom/save_add_sickroom' data-qr="output_position=content&amp;action=3"  tabindex="25">
        <?php }?>
