...
<div class="call_purpose_form_outer ercp_table" id="call_purpose_form_outer" >
    <div class="head_outer"><h3 class="txt_clr2 width1">ShiftManager Form</h3></div>
...
//     var_dump($cl_dtl);
    ...
    <form method="post" name="police_call_form" id="supervisor_call_form">
        ...
        <input name="sf[sf_pre_inc_ref_id]"  type="hidden"  value="<?= @$grievance_data[0]->gc_inc_ref_id; ?>" >
        
        <div class="field_row width100">


            <div class="width2 form_field outer_smry">
                    <div class="label blue float_left">ShiftManager Summary</div>

                     <div class="width100" id="ero_summary_other">
                         <textarea style="height:60px;" name="sf[sf_summary]" class="width_100 filter_required" TABINDEX="16" data-maxlen="1600"  data-errors="{filter_required:'ShiftManager Summary should not be blank'}"><?=@$inc_details['sf_summary'];?></textarea>
                    </div>
            </div>
            <div class="width2 form_field float_left outer_btn">
                <div id="fwdcmp_btn">
                    <input type="button" name="submit" value="Save" class="btn submit_btnt form-xhttp-request" data-href='{base_url}shiftmanager/save_shift_call' data-qr='output_position=content'  TABINDEX="27">
                </div>
            </div>
        </div>
