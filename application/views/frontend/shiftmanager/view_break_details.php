                    ...
                    <div class="width100 drg float_left">
                        ...
                        <div class="filed_input float_left width_25">
                            <label for="search_clg">
                                ...
                                <input type="button" name="search" value="Search" class="btn clg_search form-xhttp-request" data-href="{base_url}shiftmanager/search_break_details" data-qr="output_position=content&amp;filter_search=search&amp;module_name=clg&amp;tlcode=MT-CLG-ACTION-MULTI&amp;action_type=View" >
