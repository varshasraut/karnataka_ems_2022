                    ...
                    <div class="search">
                        ...
                        <div class="width100 mt-2">
                            <div class="width15 float_left">
                                <label class="headerlbl">Call Details</label>
                            </div>
                        ...
                        <div class="width10 float_left">
                            <input type="text" class="controls amb_search" id="mob_no" name="call_search" value="<?php echo @$rg_no; ?>" placeholder="Enter Caller No " />
                        </div>
    ...
    <table class="table report_table table-bordered">
        ...
        ?>
                ...
                <tr>
                    ...
                    <td>
                        <!--                                    <a href="{base_url}calls/single_record_view" class="onpage_popup" data-qr="output_position=popup_div&inc_ref_id=<?php echo $inc->inc_ref_id; ?>" style="color:#000;" data-popupwidth="1300"  data-popupheight="600"><?php echo $inc->inc_ref_id; ?></a>-->
                        <a class="" style="margin-right:10px; color:#000;" href="#" onclick="open_extend_map('{base_url}calls/single_record_view?inc_ref_id=<?php echo $inc->inc_ref_id; ?>');return false;"><?php echo $inc->inc_ref_id; ?></a>
                    </td>
                    ...
                    <td><?php
                        if ($inc->flw_reason == 'Other') {
                            echo $inc->flw_reason . '-' . $inc->followup_reason_other;
                        } else {
                            echo $inc->flw_reason;
                        }
                        ?>
                    </td>
                    <td><?php echo $inc->followup_schedule_datetime ; ?> </td>
                    <td style="text-align: center;">
                        <a href="{base_url}calls/atnd_cls?inc_ref_no=<?php echo $inc->inc_ref_id; ?>" class="btn click-xhttp-request" data-qr="output_position=content&inc_ref_id=<?php echo $inc->inc_ref_id; ?>" data-popupwidth="1400" data-popupheight="900"> Dispatch </a>
                        ...
                        ?>
                            <br><br><a href="{base_url}calls/followupactionpopup" class="btn onpage_popup" data-qr="output_position=content&inc_ref_id=<?php echo $inc->inc_ref_id; ?>&followup_reason=<?php echo $inc->followup_reason; ?>" data-popupwidth="1200" data-popupheight="800"> Action </a>
                        <?php
                        } ?>
