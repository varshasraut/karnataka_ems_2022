    ...
    <ul>
        ...
        <li><span>All Call Details</span></li>
    </ul> 
</div>
    <!-- <h3 class="txt_clr2 width1">All Call Details</h3> -->
...
<!--                    <input type="submit" name="submit" value="Submit" TABINDEX="3">  -->
                    <input type="button" name="submit"  value="Submit" data-qr="output_position=content&amp;reports=view&amp;module_name=reports&amp;showprocess=yes&action=view" data-href="<?php echo base_url(); ?>calls/all_listing_filter" class="form-xhttp-request btn clg_search float_left" >
                    <input type="reset" class="search_button btn float_left form-xhttp-request" name="" value="Reset Filter" data-href="{base_url}calls/all_listing" data-qr="output_position=content&amp;flt=reset&amp;type=inc" />
                </div>
            </div>
        </div>
</div> 
                            ...
                            <td>
                                    <?php  
                                     ...
                                     <audio controls controlsList="nodownload" style="width: 185px;">
                                      <source src="<?php echo $inc['inc_audio_file'];?>" type="audio/wav">
                    ...
                    <div class="width33 float_right">
                        ...
                        <div class="record_per_pg">
                            ...
                            <div class="per_page_box_wrapper">
                                ...
                                <select name="pg_rec" class="dropdown_per_page float_left change-xhttp-request" data-href="{base_url}calls/all_listing_filter" data-qr="output_position=content&amp;flt=true&amp;type=inc&amp;action=view&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>&pg_rec=<?php echo $pg_rec;?>">
