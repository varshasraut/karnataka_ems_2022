...
<form name="followup_dispatch_view" method="post" id="followup_dispatch_view_forms">
        ...
        <div class="width_100 add_outer">
            <div class="width_16 float_left">
                <div id="incient_state">
                    <?php
                    //var_dump($inc_details[0]->inc_lat);
                    $st = array('st_code' => $inc_details[0]->inc_state_id, 'auto' => 'inc_auto_addr', 'rel' => 'incient', 'disabled' => '');
...
<!--                <div id="fwdcmp_btn"><input name="search_btn" value="FORWARD TO SUPERVISER" class="style4 form-xhttp-request" data-href="{base_url}inc/save_inc?cl_type=forword" data-qr="output_position=content" tabindex="22" type="button"></div>-->
    ...
    <input type="button" name="submit" value="DISPATCH" class="btn submit_btnt form-xhttp-request" data-href='{base_url}resource/confirm_followup_save' data-qr='output_position=content&amp;module_name=inc&amp;tlcode=MT-INC-ADD&amp;call_type=dispatch'  TABINDEX="27" >
