...
<ul class="incoming_calls">
    ...
    <?php foreach ($ERO_data as $data) {
        ...
        <li>
            ...
            <a class="incoming_call_anchor click-xhttp-request" data-href="{base_url}grievance/griviance_call_details" data-qr="output_position=content&amp;tool_code=mt_atnd_calls&amp;opt_id=<?php echo $data->operator_id; ?>&amp;sub_id=<?php echo $data->sub_id; ?>&amp;inc_ref_id=<?php echo $data->inc_ref_id; ?>"><span style="color:white;"> <?php echo $data->inc_ref_id; ?></span></a>
        </li>
