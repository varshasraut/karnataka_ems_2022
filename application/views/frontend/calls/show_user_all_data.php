...
<div class="width100 single_record">
    ...
    <div id="list_table">
        ...
        <!--        <th style="line-height: 20px;">Date</th>-->
                    ...
                    <th style="line-height: 20px;">Call Total(Today)</th>
                    <th style="line-height: 20px;">Call Total(This Month)</th>
                </tr>
                <?php
                ...
                foreach ($call_details as $calls) { //var_dump($calls);?>
                    <tr>         
                        ...
                        <td><?php $calls_total = get_total_by_call_type($clg_data[0]->clg_ref_id,$calls->pcode,$dur="to",$fr="",$to="",$inc_system_type=""); 
                        if($calls_total){
                            echo $calls_total;
                        }else{
                            echo "0";
                        ...
                        ?></td>
                        <td><?php $calls_total = get_total_by_call_type($clg_data[0]->clg_ref_id,$calls->pcode,$dur="tm",$fr="",$to="",$inc_system_type=""); 
                        if($calls_total){
                            echo $calls_total;
                        }else{
                            echo "0";
