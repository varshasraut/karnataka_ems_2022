        ...
        <div class="inline_fields width100">
            ...
            <div class="form_field width100 pos_rel">
                ...
                <div class="outer_id width100">
                    ...
                    <div class="input float_left width10">
                        <input type="text" class="form_input" name="search_caller_details" data-base="search_btn" placeholder="Enter Caller Details" tabindex="6" autocomplete="off">
                    </div>
                    ...
                    <div class="float_left width_20 ">
                        ...
                        <!--                    <div class="label">&nbsp;</div>-->
                        <input name="search_btn" value="SEARCH" class="style3 base-xhttp-request float_left" data-href="<?php echo base_url(); ?>calls/single_caller_history" data-qr="output_position=single_record_details" type="button" style="float:left; margin-top: 0px;">
                        ...
                        <input name="reset_filter" tabindex="19" value="RESET FILTER" class=" click-xhttp-request style3 float_left" data-href="<?php echo base_url(); ?>calls/caller_record" data-qr="output_position=inc_details&amp;filter=true" type="reset" style=" margin-top: 0px;" autocomplete="off">
