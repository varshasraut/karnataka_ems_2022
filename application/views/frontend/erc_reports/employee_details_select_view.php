        ...
        <div class="width_25 ">
            ...
            <div class="filed_select">
                <div class="field_row drg float_left">
                    ...
                    <div class="width100 float_left">  
                        <select name="emp_report_type"  class="change-base-xhttp-request"  data-href="{base_url}erc_reports/load_employee_group_wise_details_form" data-qr="output_position=content">
