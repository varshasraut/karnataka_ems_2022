...
<table class="table report_table">
    ...
    <tr>  
        ...
        <td><?php echo $main_data->st_name;?></td>
        ...
        <td><?php //echo $main_data->mt_tyre_type ;
        $mt_tyre_type = json_decode($main_data->mt_tyre_type); 
       // var_dump($mt_tyre_type);
        ...
        ?></td>
        <td><?php echo $main_data->mt_uid_no; ?></td>
        <td><?php echo $main_data->mt_tyre_model; ?></td>
        <td><?php echo $main_data->mt_tyre_remark; ?></td>
        <td><?php echo $main_data->mt_reported_date ; ?></td>
        <td><?php echo $main_data->mt_district_manager ; ?></td>
        ...
        <td><?php echo $main_data->approved_by; ?></td>
           ...
           <td><?php //if($main_data->mt_approval == 0){ echo "Approval Pending"; }else if($main_data->mt_approval == 1){ echo "Approved"; }else if($main_data->mt_approval == 2){ echo "Not Approve"; }
            echo $main_data->mt_ambulance_status;
           ?></td> 
        <td><?php echo $main_data->mt_onroad_datetime; ?></td>
         <td><?php echo $main_data->mt_app_remark; ?></td> 
