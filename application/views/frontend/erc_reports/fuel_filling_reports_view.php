        ...
        <div class="width_25 ">
            ...
            <div class="filed_select">
                <div class="field_row drg float_left">
                    ...
                    <div class="width100 float_left">  
                        <select name="report_type" class="change-base-xhttp-request filter_required" data-base="report_type" data-href="{base_url}erc_reports/fuel_filling" data-qr="output_position=content" data-errors="{filter_required:'Report Type should not be blank!'}">
