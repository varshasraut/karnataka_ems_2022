...
<form enctype="multipart/form-data" method="post">
        <div class="filed_select">
                <div class="field_row drg float_left">
                    ...
                    <div class="width100 float_left">  
                        <select name="emp_report_type"  class="change-base-xhttp-request"  data-href="{base_url}pending_reports/load_all_cases_filter_form" data-qr="output_position=content">
                            <option value="">Select Report</option>
                            <option value="1">Zone Wise</option>
                            <option value="2">District Wise</option>
                            <option value="3">Ambulance Wise</option>
                        </select>
                    </div>
                </div>
            </div> 
