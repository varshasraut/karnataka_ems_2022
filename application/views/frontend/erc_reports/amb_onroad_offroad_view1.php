<div class="width100">
        ...
        <div class="filed_select">
            <div class="width100 field_row drg float_left">
                ...
                <div class="width100 float_left">  
                    <select name="offroad_report_type"  class="change-base-xhttp-request"  data-href="{base_url}erc_reports/amb_onroad_report_form1" data-qr="output_position=content">
