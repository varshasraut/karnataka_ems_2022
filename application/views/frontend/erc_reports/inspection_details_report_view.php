...
<div class="width100">
    ...
    <!-- <form enctype="multipart/form-data" action="<?php echo base_url(); ?>erc_reports/save_export_inspection_report" method="post" method="post"> -->
    <div class="width_10 float_left ">
            <div class="filed_select width100">
                <div class="width100 field_row">
                    ...
                    <div class="width100">  
                        <select name="onroad_report_type"  class="change-base-xhttp-request"  data-href="{base_url}erc_reports/load_inspection_details" data-qr="output_position=content">
                            <option value="">Select Report</option>
                            <option value="1">Inspection Report</option>
                            <option value="2">Grievance Report</option>
    ...
    <div class="width_10 drg float_left">
                ...
                <div class="width100 float_left">  
                    <select name="onroad_report_type_divs" id="divs" class="change-base-xhttp-request"  data-href="{base_url}erc_reports/load_inspection_details" data-qr="output_position=content">
        ...
        <!-- <div class="width_20 float_left" style="margin-top: 12px;">
