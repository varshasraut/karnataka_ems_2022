...
<table class="table report_table">
    ...
    <?php
    $total = 0;$als = 0;$bls = 0;$je = 0;
    foreach ($inc_data as $inc) {
        // print_r($inc); 
        ?>
        <tr>
            <td style="text-align:center"><?php echo $inc['count']; ?></td>
            <td style="text-align:center"><?php echo $inc['div_name']; ?></td>
    ...
    ?>
         ...
         <td style="text-align:center"></td>
            ...
            <td style="text-align:center"></td>
            <td style="text-align:center"><?php echo $als; ?></td>
            <td style="text-align:center"><?php echo $bls; ?></td>
            <td style="text-align:center"><?php echo $je; ?></td>
