...
<div class="width100">
    ...
    <form enctype="multipart/form-data" action="<?php echo base_url(); ?>erc_reports/load_datafilter_disclo_summary" method="post" method="post">
        <div class="width_10 drg float_left">
                <div class="width100 float_left">
                    <div class="style6 float_left">Select Zonewise : </div>
                </div>
                <div class="width100 float_left">  
                    <select name="disclo_report_type_divs" id="divs"  class="change-base-xhttp-request" data-base='disclo_summary_report_type'  >
        ...
        <div class="width_10 input float_left" id="dist_blck">
            <div class="width100 ">
                <div class="style6 ">Select District : </div>
            </div>
            <div class="width100 ">  
                <select name="disclo_report_type_dist" id="dist" data-base='disclo_summary_report_type' class="change-base-xhttp-request"  >
                <option value="All">All</option>
                </select>
            </div>
        </div> 
        <div class="width_10 float_left " id="Report_Type">
            <div class="filed_select width100">
                <div class="width100 field_row">
                    ...
                    <div class="width100">  
                        <select name="disclo_summary_report_type"  class="change-base-xhttp-request"  data-href="{base_url}erc_reports/load_datafilter_disclo_summary" data-qr="output_position=content">
                            <option value="">Select Report</option>
                            <option value="1">Dispatch Closure Summary Count</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
     $("#dist").on('change', function postinput(){
        $('#Report_Type option').prop('selected', function() {
                return this.defaultSelected;
            });
            $('#Sub_date_report_block_fields').html('');
            $('#Sub_report_block_fields').html('');
     });
