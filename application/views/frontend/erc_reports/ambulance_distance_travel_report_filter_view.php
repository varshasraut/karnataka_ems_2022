    ...
    <form  method="post" enctype="multipart/form-data"
        ...
        <div class="width_50 float_left" style="margin-top: 10px;">
            <div class="button_field_row">
                ...
                <input type="button" name="submit"  value="Submit" data-qr="output_position=list_table&amp;reports=view&amp;module_name=reports&amp;showprocess=no" data-href="<?php echo base_url(); ?>master_report/<?php echo $submit_function; ?>" class="form-xhttp-request btn clg_search" >                    <input type="reset"  value="Reset Filters">
                </div>
