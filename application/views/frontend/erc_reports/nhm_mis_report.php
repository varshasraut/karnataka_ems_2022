...
<!--                    <input type="submit" name="submit" value="Submit" TABINDEX="3">  -->
                    <input type="submit" name="submit"  value="Submit" data-qr="output_position=list_table&amp;reports=view1&amp;module_name=reports&amp;showprocess=yes" data-href="<?php echo base_url(); ?>erc_reports/<?php echo $submit_function; ?>" class="form-xhttp-request1 btn clg_search float_left" >
...
<!-- <script>;
    ...
    $("#to_date").datepicker({
        ...
        onSelect: function (selected) {
            var dt = new Date(selected);
            dt.setDate(dt.getDate() - 1);
            $("#to_date").datepicker("option", "maxDate", dt);
        }
    });
});
</script> -->
