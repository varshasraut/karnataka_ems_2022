        ...
        <div class="width_25 ">
            ...
            <div class="filed_select">
                <div class="field_row drg float_left width50">
                    ...
                    <div class="width100 float_left">  
                        <select name="amb_report_type"  class="change-base-xhttp-request"  data-href="{base_url}erc_reports/ambulance_master_report_form" data-qr="output_position=content">
