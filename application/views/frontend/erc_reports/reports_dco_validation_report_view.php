            ...
            <div class="filed_select">
                ...
                <div class="width30 drg float_left">
                 ...
                 <div class="width30 drg float_left">
                    ...
                    <div class="width100 float_left">
                        <input name="to_date" tabindex="1" class="form_input filter_required" placeholder="To Date" type="text" data-base="search_btn" data-errors="{filter_required:'To Date should not be blank!',filter_time_hm:'Please enter valid time(H:i)'}" value="" readonly="readonly" id="to_date">
                    </div>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function () {
        ...
        var dateFormat = "mm/dd/yy",
            from = jQuery("#from_date").datetimepicker({
            ...
            to = jQuery("#to_date").datetimepicker({
            defaultDate:  new Date(),
            changeMonth: true,
            changeYear: true,
            numberOfMonths: 1
