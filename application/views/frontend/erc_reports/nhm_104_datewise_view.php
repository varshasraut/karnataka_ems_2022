...
<div class="width69 field_row float_left">
    ...
    <div class="filed_select">
        ...
        <div class="width50 drg float_left">
            ...
            <div class="width100 float_left">
                <input name="to_date" tabindex="2" class="form_input filter_required StartDate" placeholder="To Date"
                    type="text" data-base="search_btn"
     ...
     <div class="button_field_row">
           <div class="button_box">
            ...
            <input type="button" name="submit" value="Submit"
                data-qr="output_position=list_table&amp;reports=view&amp;module_name=reports&amp;showprocess=yes"
                data-href="<?php echo base_url(); ?>erc_reports/<?php echo $submit_function; ?>"
                class="form-xhttp-request btn clg_search float_left">
            <?php if( $submit_function == 'incident_weekly_hourly_report'){ ?>
            <input type="reset" class="search_button float_left form-xhttp-request" name="" value="Reset Filter"
                data-href="{base_url}erc_reports/<?php echo $submit_function; ?>"
                data-qr="output_position=content&amp;flt=reset&reports=view" />
            <?php } ?>
        </div>
    </div>
