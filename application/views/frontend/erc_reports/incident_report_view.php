        ...
        <div class="width_25 ">
            ...
            <div class="filed_select">
                <div class="field_row drg float_left">
                    ...
                    <div class="width100 float_left">  
                        <select name="report_type_name" class="change-base-xhttp-request" data-base="report_type" data-href="{base_url}erc_reports/load_incident_subreport_form" data-qr="output_position=content">
                            <option value="">Select Report</option>
                            <option value="1">Dispatch Incident Report </option>
                            <?php if($clg_group != "UG-NHM"){ ?>
                            <option value="2">Other Incident Report</option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
