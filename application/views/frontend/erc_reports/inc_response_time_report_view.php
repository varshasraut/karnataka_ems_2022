...
<table class="table report_table">
    ...
    foreach ($inc_data as $inc) {
        ...
        <tr>         
            ...
            <td><?php echo date("Y-m-d H:i:s", strtotime($inc['inc_recive_time'])); ?></td> 
            <td><?php echo date("Y-m-d H:i:s", strtotime($inc['inc_datetime'])); ?></td> 
            <td><?php
                if ($inc['start_from_base'] != '' && $inc['start_from_base'] != '0000-00-00 00:00:00') {
                   // echo $inc['start_from_base'];
                    echo date("Y-m-d H:i:s", strtotime($inc['start_from_base']));
                } else {
                    //echo '-';
                }
                ?>
            ...
            <td><?php  echo strtoupper($inc['amb_area_name']); ?></td> 
            <td><?php echo $inc['thirdparty']; ?></td>
            <td><?php echo strtoupper($inc['operate_by']); ?></td> 
            <td><?php echo $inc['epcr_operate_by_Name']; ?></td> 
           <td><?php echo strtoupper($inc['inc_added_by']); ?></td> 
           <td><?php echo $inc['inc_added_by_Name']; ?></td> 
           <td><?php echo strtoupper($inc['validate_by']); ?></td> 
           <td><?php echo $inc['epcr_validate_by_Name']; ?></td> 
