<div class="width_25 float_right" style="margin-bottom: 10px;">
    <div class="button_field_row">
        <div class="button_box">
            <form action="<?php echo base_url(); ?>erc_reports/hosp_cl_type_dist_report" method="post" enctype="multipart/form-data" target="form_frame">
...
<table class="table report_table">
    ...
    foreach ($inc_data as $inc) {
        ...
        <tr>  
            ...
            <td><?php echo $inc['hosp_patient'];
                     $hosp_patient= $hosp_patient + $inc['hosp_patient'];?></td>
...
<td><strong><?php echo $hosp_patient; ?></strong></td>
