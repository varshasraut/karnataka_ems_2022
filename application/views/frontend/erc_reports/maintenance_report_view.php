...
<table class="table report_table">
    ...
    <tr>  
        ...
        <td><?php echo $main_data->mt_ex_onroad_datetime; ?></td>
         <td><?php echo $main_data->mt_schedule_service; ?></td>
        <td><?php echo $main_data->mt_service_name; ?></td>
        <td><?php echo $main_data->mt_offroad_datetime; ?></td> 
        <td><?php echo $main_data->mt_stnd_remark; ?></td>
        <td><?php echo $main_data->mt_remark; ?></td>
           <td><?php 
           //if($main_data->mt_approval == 0){ echo "Approval Pending"; }else if($main_data->mt_approval == 1){ echo "Approved"; }else if($main_data->mt_approval == 2){ echo "Not Approve"; }else if($main_data->mt_approval == 3){ echo "Under process"; } 
        ...
        <td><?php echo $main_data->mt_app_work_shop; ?></td> 
