        ...
        <div class="field_row float_left width50">
         ...
         <div class="width30 drg float_left">
                   ...
                   <!-- <select name="hpcl_amb" class="filter_required" data-errors="{filter_required:'District should not be blank!'}">
                    ...
                    <div class="col-md-3">
<input name="hpcl_amb"  id="hpcl_amb" class="mi_autocomplete dropdown_per_page width97" data-href="{base_url}auto/get_ambulance" placeholder="Select Ambulance" data-errors="{filter_required:'Please select state from dropdown list'}" tabindex="2" autocomplete="off" value="" data-value="" >
</div>
                   </div>
                </div>
