      ...
      <div class="width_25 float_left">
            <div class="filed_select">
                ...
                <div class="width100 drg float_left">
                    ...
                    <select id="system" name="system"  class="change-base-xhttp-request" data-href="{base_url}erc_reports/" data-qr="output_position=content" data-errors="{filter_required:'Team should not blank'}" TABINDEX="7"  >
...
<!--                    <input type="submit" name="submit" value="Submit" TABINDEX="3">  -->
                    <input type="button" name="submit"  value="Submit" data-qr="output_position=list_table&amp;reports=view&amp;module_name=reports&amp;showprocess=yes" data-href="<?php echo base_url(); ?>erc_reports/<?php echo $submit_function; ?>" class="form-xhttp-request btn clg_search float_left" style="margin-top: 3px;">
