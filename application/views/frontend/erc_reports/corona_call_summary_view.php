        ...
        <div class="field_row float_left width50">
            ...
            <div class="filed_select">
                <div class="width50 drg float_left">
                    ...
                    <div class="width100 float_left">
                        <input name="from_date" tabindex="1" class="form_input filter_required" placeholder="From Date" type="text" data-base="search_btn" data-errors="{filter_required:'From Date should not be blank!'}" value="" readonly="readonly" id="from_date">
                    </div>
                </div>
<!--                <div class="width50 drg float_left">
                    <div class="width100 float_left">
