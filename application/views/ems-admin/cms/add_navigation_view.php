                    ...
                    <form method="post" method="post" enctype="multipart/form-data" id="ms_add_english_navigations">
                        ...
                        <div class="width2 float_right">
                            ...
                            <div class="row">  
                                ...
                                <input type="button" name="submit_type" id="btnsave" value="Submit" class="btn submit_btn form-xhttp-request" data-href="{base_url}cms/add_navigation" data-qr="output_position=content">
                           </div>
                        </div>
                    </form>
                </div>
