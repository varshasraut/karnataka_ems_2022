                        ...
                        foreach ($navigation_list as $navigation) {
                            ...
                            <tr>
                             ...
                             <!--///////////////////////////////////////////////////////////////////////////////-->   
                                ...
                                <a href="{base_url}cms/update_nav_status"  class="click-xhttp-request block_status" data-qr="status=<?php echo $navigation->nav_status;?>&nav_id=<?php echo base64_encode($navigation->nav_id); ?>&amp;output_position=status<?php echo $navigation->nav_id;?>">
                                ...
                                <td>
                                    <div class="user_action_box">
                                       ...
                                       <?php
                                        ...
                                        ?>
                                            <li>
                                                <a data-qr="output_position=ms_add_navigations&nav_id=<?= $navigation->nav_id; ?>" data-href="{base_url}cms/add_navigation" class="click-xhttp-request">Edit</a>
                                            </li>
                                        ...
                                        ?>   
                                            <li>
                                                <a data-qr="output_position=content&id=<?= $navigation->nav_id; ?>&delete_navigation=true" data-href="{base_url}cms/manage_navigation" class="click-xhttp-request" data-confirmmessage="Are you sure to delete ?" data-confirm="yes">Delete</a>
                                            </li>
                                        ...
                                        ?>      
                                            <li>
                                                <a data-qr="output_position=content&nav_id=<?= $navigation->nav_id; ?>&nav_title=<?= $navigation->nav_tite;?>" data-href="{base_url}cms/add_navigation_links" class="click-xhttp-request">Add Links</a>
                                            </li>
                                              <?php } ?>      
                                        ...
                                        ?>  
                                            ...
                                            <li>
                                                <a data-qr="output_position=content&nav_id=<?= $navigation->nav_id; ?>&nav_title=<?= $navigation->nav_tite;?>" data-href="{base_url}cms/view_navigation_links" class="click-xhttp-request">View Links</a>
                                            </li>
