...
<div class="breadcrumb">
    <ul>
        <li class="goods">
            <a href="{base_url}cms/list_pages">Cms and Widgets</a>
        </li>
        <li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="user_action_box">
                                        ...
                                        ?>
                                            <li>
                                                <a data-qr="output_position=content&page_id=<?= $page->id; ?>" data-href="{base_url}cms/add_pages" class="click-xhttp-request orange">Edit</a>
                                            </li>
                                              <?php } ?>
                                        ...
                                        ?>
                                            ...
                                            <li>
                                                <a data-confirmmessage="Are you sure to delete ?" data-confirm="yes" data-qr="output_position=content&id=<?= $page->id; ?>&delete_page=true" data-href="{base_url}cms/list_pages" class="click-xhttp-request orange">Delete</a>
                                            </li>
