        ...
        <div id="ms_cms_add_page_container">
                            ...
                            <form method="post" method="post" enctype="multipart/form-data" id="ms_add_navigation_links">
                                ...
                                <div class="field_row cms_btn_container">  
                                    <input type="button" name="add_links" value="Submit" class="btn submit_btn form-xhttp-request" data-href="{base_url}cms/update_navigation_links" data-qr="output_position=content">
                                </div>
                            </form>
                        </div>
