...
<?php if(@$view_clg=='view'){ $view='disabled'; }?>
    ...
    <form enctype="multipart/form-data" action="#" method="post" id="add_colleague_registration_form">
        <div class="width1">
                ...
                <div class="width1">
                    ...
                    <h4 class="txt_clr2">Joining Details:</h4>
                        ...
                        <div class="filed_input">
                            ...
                            <select id="group" name="clg[clg_group]" data-base="<?=@$current_data[0]->clg_ref_id?>"  class="filter_required change-xhttp-request" data-href="{base_url}clg/add_commission_view" data-qr="output_position=sales_commission&amp;module_name=clg " data-errors="{filter_required:'Group name should not blank'}" TABINDEX="5"  <?php echo $view;?>>
            ...
            <?php if(!@$view_clg){ ?>
                <div class="button_field_row width_20 margin_auto">
