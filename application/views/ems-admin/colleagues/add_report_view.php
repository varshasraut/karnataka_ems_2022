                    ...
                    <div class="right_text discount_right_text">
                        <div class="text_box">
                            <div class="input">
                              ...
                              <input type="text" name="date_of_report" value="<?php echo $result[0]->date_of_report;?>" id="date_of_report" data-href="{base_url}ms-admin/clg/get_distance_from" data-qr="output_position=report_distance_from&amp;<?php if(@$condition=='add'){ ?>action=add<?php }else{ ?>action-edit<?php }?>" class="change-xhttp-request mi_calender filter_required filter_lessthan[<?=$date?>]"  data-errors="{filter_required:'To Date should not be blank',filter_lessthan:'Date should be less than today'}">
                            </div>
                        </div>
                    </div> 
                </div>
