...
<div class="width2 float_right">
    <input class="add_button_amb onpage_popup float_right" name="add_amb" value="Register Colleagues" data-href="{base_url}Clg/registration" data-qr="output_position=popup_div&amp;tool_code=mt_clg_add&amp;module_name=clg" type="button" data-popupwidth="1000" data-popupheight="800"> 
     ...
     <input class="search_button click-xhttp-request float_right" name="" value="Reset Filters" data-href="{base_url}clg/colleagues" data-qr="filters=reset" type="button">
                        ...
                        <td> 
                            ...
                            <div class="user_action_box">
                                ...
                                <ul class="profile_actions_list">
                                   ...
                                   <?php
                                   if($CI->modules->get_tool_config('MT-CLG-VIEW',$this->active_module,true)!=''){ ?>   
                                    <li><a class="onpage_popup action_button" data-href="{base_url}clg/edit_clg" data-qr="output_position=popup_div&amp;module_name=clg&amp;tlcode=MT-CLG-VIEW&amp;ref_id=<?php echo base64_encode($colleague->clg_ref_id); ?>&amp;action=edit_data&amp;clg_view=view" data-popupwidth="900" data-popupheight="850">View</a></li>
                                    
                                 <?php } 
                                 if($CI->modules->get_tool_config('MT-CLG-EDIT',$this->active_module,true)!='' ||  $CI->session->userdata('current_user')->clg_ref_id == $colleague->clg_ref_id ){ ?>   
                       

                                 <li><a class="change-base-xhttp-request action_button" data-href="{base_url}clg/edit_clg" data-qr="output_position=content&amp;module_name=clg&amp;tlcode=MT-CLG-EDIT&amp;ref_id=<?php echo base64_encode($colleague->clg_ref_id);?>&amp;action=edit_data&amp;page_no=<?php echo @$page_no;?>" name="<?php echo $colleague->clg_ref_id;?>">Edit</a></li>          
