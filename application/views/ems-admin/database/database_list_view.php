...
<div class="breadcrumb">
  <ul>
    <li class="backup"><a href="{base_url}ms-admin/database/backup">Database</a></li>
...
<div class="box3">
  <div class="permission_list group_list">
   ...
   <form method="post" action="#" class="">
      ...
      <div class="row">
      <?=$CI->modules->get_tool_html('MT-BKUP-DELETE',$CI->active_module,'form-xhttp-request delete_button');?>
      <?=$CI->modules->get_tool_html('MT-BKUP-GENERATE',$CI->active_module,'form-xhttp-request top_ancher');?>
    </div>
    <table class="table report_table">
     ...
     <?php foreach ($files_list as $key=>$filename):
