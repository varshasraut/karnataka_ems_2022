...
<body class="animsition">
    ...
    <div class="row" style="background-color: #085B80;" >
        ...
        <div class="col-md-8 align-items-right" style="text-align: center"> 
            <label style="padding-top:10px;text-align:center;font-weight:bold;font-size:30px;color:#F4F6F7;">MP EMERGENCY MEDICAL SERVICES</label> 
        </div>
        <div class="col-md-2" style="padding-top:15px"> 
            <span style="padding-top:50px;color: #F4F6F7;font-size:20px;" class="clock" id='ct' > </span>
        </div>
        ...
        <div class="col-md-1 align-items-right"> 
         ...
         <!-- END HEADER DESKTOP -->
         <nav class="navbar navbar-expand-md justify-content-center" style="background-color: #eeeeee;">
               <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
    <span class="navbar-toggler-icon"></span>
  </button>
             <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="nav navbar-nav">
                    <li class="nav-item"><a class="nav-link" style="font-weight: bold;" href="<?php echo base_url(); ?>Dashboard/" >Home</a></li>
                   <li class="nav-item"><a class="nav-link" style="font-weight: bold;" href="<?php echo base_url(); ?>Dashboard/all_amb/" >Live Ambulance Map</a></li>
                   <li><a class="nav-link" style="font-weight: bold;" href="<?php echo base_url(); ?>Dashboard/amb_tracking/">Ambulance Tracking</a></li> 
<!--                  <li class="nav-item">
