...
<div class="row" >
  ...
  <h5>Total Off-Road Ambulances <?php echo date('d', strtotime($current_date));?> <?php echo date('F', strtotime($current_date));?> <?php echo date('Y', strtotime($current_date));?> @ <?php echo $select_time_name;?></h5>
</div>
  <div class="col-md-2" id="print">
   ...
   <div class="row">
      <form enctype="multipart/form-data"  id="date_filter" method="post" action="<?php echo base_url(); ?>dashboard/ambulance_status_popup_datefilter" style="height: 100px;">   
            <div class="width100" style="display:flex">
            
                <div class="width_30 " style="margin-left:50px;">
                
                  <input  type="text" id="select_date" name="select_date" class="filter_required mi_calender datepicker"  value="<?php echo $report_args['select_date'];?>" type="text" tabindex="1" placeholder="Select Date" data-errors="{filter_required:'Register Number should not blank'}">
                </div>&nbsp;&nbsp;&nbsp;
                <div class="width_30 float_left">
                    ...
                    <div class="shift width100 float_left">
                      ...
                      <option value="">Select Time</option>
                       <option value="1" <?php if($report_args['select_time'] == '1'){ echo "selected"; }?> > 9AM</option>
                       <option value="2" <?php if($report_args['select_time'] == '2'){ echo "selected"; }?>> 12PM</option>
                       <option value="3" <?php if($report_args['select_time'] == '3'){ echo "selected"; }?>> 3PM</option>
                       <option value="4" <?php if($report_args['select_time'] == '4'){ echo "selected"; }?>> 6PM</option>
                  </select>
                    </div>
                </div>
                <div class="width20 "> 
