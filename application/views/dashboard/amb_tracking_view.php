...
<div class="page-content--bgf7 pb-5" style="min-height:550px;">
    ...
    <div class="container-fluid">
        <section class="statistic statistic2">
            ...
            <div class="row pb-5">
                <div class="col-md-12 "><!---->
                    <select name="system" id="system" class="" data-errors="{filter_required:'Team should not blank'}" TABINDEX="7"  >
                        <option value="">Select System Type</option>
                        <!-- <option value="all">All</option> -->
                        <option value="104"> 104</option>
                        <option value="108"> 108</option>
                    </select>
                    <select name="amb_district" id="amb_district"  class="" data-errors="{filter_required:'Team should not blank'}" TABINDEX="7"  >
                            <option value="">Select District</option>
                            <option value="all">All</option>
                            <?php foreach($dist as $dst){?>
                               <option value="<?php echo $dst->dst_code;?>" <?php if($dst->dst_code == '518'){ echo "selected"; }?>><?php echo $dst->dst_name;?></option>
                            <?php } ?>     
                    </select>
                    <input type="button" name="submit" value="Submit" class="btn btn-primary submit_btnt Submit">                     
                    <input type="button" name="Refresh" value="Refresh" class="btn btn-primary submit_btnt form-xhttp-request float_right" data-href='<?php echo base_url();?>dashboard/show_ambulance_tracking' data-qr='page_no=<?php echo @$page_no; ?>&amp;output_position=content' >
                    <b style="margin-left: 30px;">Total Ambulance : </b><label id="totalAmb"></label>
                    <b style="margin-left: 30px;">Ignition Status : </b><label id="totalAvls"></label>
                    <b style="margin-left: 30px;">MDT Login : </b><label id="totalMdt"></label>
                    <b style="margin-left: 30px;">Total Pilot Login : </b><label id="loginDRIVER"></label>
                    <b style="margin-left: 30px;">Total EMT Login : </b><label id="loginEMSO"></label>
...
<!-- Modal -->
<div class="modal loginmodal" tabindex="-1" role="dialog" id="logindetails_bike">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin: 17px;">
        ...
        <div class="row">
            <b class="col-4">Name : </b><label class="col-8" id="emso_name1"></label><br/>
        </div>
        <div class="row">
            <b class="col-4">Contact No : </b><label class="col-8" id="emso_mob1"></label>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin: 17px;">
        ...
        <div class="row">
            <b class="col-4">Name : </b> <label class="col-8" id="driver_name1"></label><br/>
        </div>
        <div class="row">
            <b class="col-4">Contact No : </b><label class="col-8" id="driver_mob1"></label>
        </div>
