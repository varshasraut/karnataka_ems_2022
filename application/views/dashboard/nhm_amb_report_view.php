  ...
  #myTable tr:hover {
           ...
           <form enctype="multipart/form-data" action="#" method="post" id="mdt_tracking" class="col-md-12">
             ...
             <div class="col-md-3" style="float:left;">
               <div class="button_box" style="padding-top:40px;">
                 <input type="button" name="submit" value="Submit" class="btn btn-primary submit_btnt form-xhttp- pb-2" data-href='<?php echo base_url(); ?>dashboard/nhm_amb_report1' data-qr='page_no=<?php echo @$page_no; ?>&amp;output_position=content'>
                 <!--            <input type="button" name="submit" value="Submit" class="btn btn-primary submit_btnt Submit">-->
               </div>
             </div>
           </form>
         </div>
         <div class="sticky" id="live_tracking_view">
           <div class="row" style="padding-top: 10px;">
             ...
             <!-- <div class="col-md-3">
               <b>Base Location With Network Challenges : </b><label id="totalNonNetworkAmb">123</label><a id="nonnetwork" href="<?php echo base_url(); ?>dashboard/ambulance_nonnetwork_popup" target="_blank">(View List)</a>
             </div> -->
           </div>
           <div class="row pb-5">
   ...
   <script>
     ...
     function mdtloadmap() {
       ...
       var myLatLng = {
         lat: 23.23979546250735,
         lng: 77.39215854006432
       };
