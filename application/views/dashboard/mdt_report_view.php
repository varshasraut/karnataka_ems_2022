...
<div class="page-content--bgf7 pb-5" style="min-height:550px;">
  ...
  <div class="container-fluid">
    <section class="statistic statistic2">
      ...
      <div class="row pb-5" id="div_main">
  ...
  $('.Submit').on('click', function() {
    ...
    // }
      ...
      for (var i = 0; i < new_var.length; i++) {
        if(new_var[i].ambt_name == 'ALS' && (new_var[i].amb_status == "7")){
          als_off++;
        }else if(new_var[i].ambt_name == 'ALS' && (new_var[i].amb_status != "7")){
          als_on++;
        }
        if(new_var[i].ambt_name == 'BLS' && (new_var[i].amb_status == "7")){
          bls_off++;
        }
        else if(new_var[i].ambt_name == 'BLS' && (new_var[i].amb_status != "7")){
          bls_on++;
        }
        if(new_var[i].ambt_name == 'JE' && (new_var[i].amb_status == "7")){
          je_off++;
        }
        else if(new_var[i].ambt_name == 'JE' && (new_var[i].amb_status != "7")){
          je_on++;
        }
        ...
        var raw = "<tr>" +
          ...
          "</td>" +
          "<td style='display:none;' >" + new_var[i].remark + "</td>" +
...
$("#download").click(function (event) {
  ...
  if((amb_district == '') || (amb_district == 'All')  && (amb_type == '')||(amb_type == 'All')){
    generateExcel($("#list_table_amb"));
  }else if(amb_district != ''  && amb_type == ''){
    generateExcel($("#list_table_amb"));
  }else if(amb_district != ''  && amb_type == ''){
    generateExcel($("#list_table_amb")); 
  }else if(amb_district != ''  && amb_type != ''){
