...
//        $this->post = $this->input->get_post(NULL);
    ...
    function download_sync() {
        ...
        $clg_ref_id = $this->input->post('clg_ref_id', TRUE);
        $cluster_ids = $this->input->post('cluster_id', TRUE);
        $sync_tables = $this->input->post('sync_tables', TRUE);
        ...
        $table_conditions = array(
            ...
            "ems_incidence_patient" => array(),
            "ems_colleague" => array(),
            "ems_ambulance" => array(),
            "ems_patient" => array(),
            "ems_mas_area_types" => array(),
            "ems_driver_pcr" => array(),
        ...
        foreach ($sync_tables as $sync_table => $sync_time) {
            ...
            foreach ($result_data as $result_item) {
                ...
                $result_data_temp[] = $result_item_temp;
            }
            $result_data = $result_data_temp;

            $resp_data['table_data'][$sync_table] = $result_data;
