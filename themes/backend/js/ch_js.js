...
jQuery(document).ready(function() {
    ...
    $('body').on('change', ".checklist input:checkbox", function() {
        console.log("hi");

        BindTable();
        var checkedValues = $('.checklist input:checkbox:checked').map((i, el) => el.value).get();
        console.log(checkedValues);
        $.ajax({
            url: base_url + "Non_eme_calls/get_detailed_data", // link of your "whatever" php
            type: "POST",
            async: true,
            cache: false,
            data: { ids: checkedValues }, // all data will be passed here
            success: function(data) {

                var val = JSON.parse(data);
                var t = val.length; // The data that is echoed from the ajax.php
                // console.log(val);
                for (var i = 0; i < t; i++) {
                    var d = val[i].length;
                    for (var j = 0; j < d; j++) {
                        console.log(val[i]);
                        var row = "<tr><td name='amb_rto_register_no'>" + val[i][j].amb_rto_register_no + "</td>";

                        row += "<td name='ambs_name'>" + val[i][j].ambs_name + "</td>";

                        if (val[i][j].login_type == "P") {
                            row += "<td name='clg_ref_id'>" + val[i][j].clg_ref_id + "</td>";
                        } else {
                            row += "<td>" + "-" + "</td>";
                        }

                        if (val[i][j].login_type == "D") {
                            row += "<td name='clg_ref_id'>" + val[i][j].clg_ref_id + "</td>";
                        } else {
                            row += "<td>" + "-" + "</td>";
                        }

                        row += "<td name='hp_name'>" + val[i][j].hp_name + "</td></tr>";
    ...
    jQuery('body').on("blur", "#scene_odometer_pcr", function() {
        if (document.getElementById("from_scene_odometer_pcr").readOnly == false) {

            document.getElementById("from_scene_odometer_pcr").value = "";
        }
        ...
        var $scene_odometer_pcr_limit =$scene_odometer_pcr+500;
        
        document.getElementById("from_scene_odometer_pcr").value = $scene_odometer_pcr;
        
        var $start_odometer_pcr = parseInt($("#start_odometer_pcr").val());
        $('#hospital_odometer_pcr').addClass('filter_rangelength['+$scene_odometer_pcr+'-'+$scene_odometer_pcr_limit+']');
        
        console.log($scene_odometer_pcr);
    ...
    jQuery('body').on("blur", "#from_scene_odometer_pcr", function() {
        ...
        var $from_scene_odometer_pcr = parseInt($("#from_scene_odometer_pcr").val());
        var $start_odometer_pcr = parseInt($("#start_odometer_pcr").val());
        var $scene_odometer_pcr = parseInt($("#scene_odometer_pcr").val());
        if (($start_odometer_pcr <= $from_scene_odometer_pcr && $("#scene_odometer_pcr").val().length == 0) || ($scene_odometer_pcr <= $from_scene_odometer_pcr)) {

        } else {
            //console.log('hii');
            xhttprequest($(this), base_url + 'job_closer/from_scene_odometer', "from_scene_odometer_pcr=" + $from_scene_odometer_pcr + "scene_odometer_pcr=" + $scene_odometer_pcr + "start_odometer_pcr=" + $start_odometer_pcr);
        }
    ...
    jQuery('body').on("blur", "#hospital_odometer_pcr", function() {
        ...
        document.getElementById("handover_odometer_pcr").value = $hospital_odometer;
        var $scene_odometer = parseInt($("#scene_odometer_pcr").val());
        var $start_odometer_pcr = parseInt($("#start_odometer_pcr").val());
        var $from_scene_odometer_pcr = parseInt($("#from_scene_odometer_pcr").val());

        console.log($hospital_odometer);
        var $hospital_odometer_pcr = parseInt($("#hospital_odometer_pcr").val());
        var $hospital_odometer_limit = $hospital_odometer_pcr+500;
        
        
        $('#end_odometer_input').addClass('filter_rangelength['+$hospital_odometer_pcr+'-'+$hospital_odometer_limit+']');
        
        if( ($("#from_scene_odometer_pcr").val().length == 0 && $("#scene_odometer_pcr").val().length == 0 && $start_odometer_pcr <= $hospital_odometer) || ($("#from_scene_odometer_pcr").val().length == 0 && $scene_odometer <= $hospital_odometer) || ($from_scene_odometer_pcr <= $hospital_odometer )){
            
        
        
        //if (($("#from_scene_odometer_pcr").val().length == 0 && ($start_odometer_pcr <= $scene_odometer_pcr)) || $scene_odometer_pcr <= $from_scene_odometer_pcr || $from_scene_odometer_pcr <= $hospital_odometer || $("#hospital_odometer_pcr").val().length == 0) {

        } else {
            //console.log('hiii');
            xhttprequest($(this), base_url + 'job_closer/hospital_odometer', "from_scene_odometer_pcr=" + $from_scene_odometer_pcr + "hospital_odometer=" + $hospital_odometer + "scene_odometer=" + $scene_odometer + "start_odometer_pcr=" + $start_odometer_pcr);
        }
    });
    jQuery('body').on("blur", "#handover_odometer_pcr", function() {
        ...
        var $start_odometer_pcr = parseInt($("#start_odometer_pcr").val());
        var $from_scene_odometer_pcr = parseInt($("#from_scene_odometer_pcr").val());
        var $handover_odometer = parseInt($("#handover_odometer_pcr").val());
        var $scene_odometer_pcr = parseInt($("#scene_odometer_pcr").val());
        
        if (($("#hospital_odometer_pcr").val().length == 0 && $("#from_scene_odometer_pcr").val().length == 0 && $("#scene_odometer_pcr").val().length == 0 && $start_odometer_pcr <= $handover_odometer) || ($("#hospital_odometer_pcr").val().length == 0 && $("#from_scene_odometer_pcr").val().length == 0  && $scene_odometer <= $handover_odometer) || ($("#hospital_odometer_pcr").val().length == 0 && $from_scene_odometer_pcr <= $handover_odometer) || ( $hospital_odometer <= $handover_odometer) ) {

        } else {
            //console.log('hiii');
            xhttprequest($(this), base_url + 'job_closer/handover_odometer', "start_odometer_pcr=" + $start_odometer_pcr + "handover_odometer=" + $handover_odometer + "from_scene_odometer_pcr=" + $from_scene_odometer_pcr + "hospital_odometer=" + $hospital_odometer + "scene_odometer=" + $scene_odometer);
        }
    });
    ...
    jQuery('body').on("blur", "#end_odometer_input", function() {
        var $start_odometer_pcr = parseInt($("#start_odometer_pcr").val());
        var $scene_odometer = parseInt($("#scene_odometer_pcr").val());
        var $from_scene_odometer = parseInt($("#from_scene_odometer_pcr").val());
        var $hospital_odometer = parseInt($("#hospital_odometer_pcr").val());
        var $handover_odometer = parseInt($("#handover_odometer_pcr").val());
        ...
        if (($("#hospital_odometer_pcr").val().length == 0 && $("#from_scene_odometer_pcr").val().length == 0 && $("#scene_odometer_pcr").val().length == 0 && $("#handover_odometer_pcr").val().length == 0  && $handover_odometer <= $end_odometer_input) || ($("#hospital_odometer_pcr").val().length == 0 && $("#from_scene_odometer_pcr").val().length == 0 && $("#scene_odometer_pcr").val().length == 0 && $hospital_odometer <= $end_odometer_input) || ($("#from_scene_odometer_pcr").val().length == 0 && $("#scene_odometer_pcr").val().length == 0 && $from_scene_odometer <= $end_odometer_input) || ( $("#scene_odometer_pcr").val().length == 0 && $scene_odometer <= $end_odometer_input) ||  ($handover_odometer <= $end_odometer_input)  ) {
            $("#distance_travelled_odmeter").val($distance_travelled);
        } else {
 
            $("#distance_travelled_odmeter").val('');
    ...
    $('#container').on("change", "#schedule_service_block", function() {
     ...
     $('#container').on("change", "#complaint_type", function() {
        $closing = $("#complaint_type").val();
        if ($closing == 'internal_complaint') {
            $('#internal_complaint').removeClass('hide');
            $('#external_complaint').addClass('hide');
        } else {
            $('#internal_complaint').addClass('hide');
            $('#external_complaint').removeClass('hide');
        }
        //});
    ...
    $('#container').on("change", ".addtess_type", function() {
        ...
        $('.addtess_type').each(function() {
            ...
            if ($("input[name='addtess_type']:checked").val() == 'manual_address') {
                ...
                $('#search_amb').css({ 'display': 'block' });
                $('#get_ambu_details').attr('href', base_url + 'inc/get_inc_ambu?inc_type=' + $inc_type);
                $("#get_ambu_details").click();

                //xhttprequest($(this), base_url + 'inc/get_inc_ambu?inc_ref_id='+$inc_id+'&inc_type='+$inc_type, 'data-qr=""');
    ...
    $(document).on("change", "#epcr_filter_list", function() {
        ...
        if ($filter_value == 'close_by_emt') {
            ...
            $('#provider_impression').css({ 'display': 'block' });
            $('#epcr_call_type').css({ 'display': 'block' });
            $('#provider_casetype').css({ 'display': 'block' });

        } else {
            $('#close_by_emt1').css({ 'display': 'none' });
        }

        if ($filter_value == 're_close_by_emt') {
            $('#amb_list_re').css({ 'display': 'block' });
        } else {
            $('#amb_list_re').css({ 'display': 'none' });
        }
    ...
    $(document).on("change", "#feedback_filter_list", function() {
        ...
        if ($filter_value == 'amb_id') {
            $('#vehicle_list').css({ 'display': 'block' });
        } else {
            $('#vehicle_list').css({ 'display': 'none' });
        }

        if ($filter_value == 'hp_id') {
            $('#base_location_list').css({ 'display': 'block' });
        } else {
            $('#base_location_list').css({ 'display': 'none' });
        }

        if ($filter_value == 'pt_status') {
            $('#Patient_status').css({ 'display': 'block' });
        } else {
            $('#Patient_status').css({ 'display': 'none' });
        }
    ...
    $(document).on("change", "#at_scene", function() {
        ...
        secs = (d2.getTime() - d1.getTime()) / 1000;
        ...
        var responce_time = hours + ':' + minutes + ':' + seconds;
        $("#driver_responce_time").html(responce_time);

        if ($amb_category == 'Rural') {
            if ($time_diff > 25) {
               
            $res_time = $time_diff - 25;
            var hours = ($res_time / 60);
                ...
                var sec = (minutes - rminutes) * 60;
                var rsec = Math.round(sec);
                
                responce_time_delay = rhours + ":" + rminutes +":"+rsec;
                $("#responce_time_alarm").html(responce_time_delay);
                ...
                //$( "#driver_responce_time" ).parent().append( "<span id='driver_responce_time_alarm'></span>" );
                 $("#driver_responce_time_alarm").removeClass('hide');
                ...
                $("#driver_responce_time_alarm").addClass('hide');
            }
        } else {
            if ($time_diff > 18) {

                $res_time = $time_diff - 18;
    ...
    $("#container").on("change", "#hospital_prio_dropdown", function() {
        $('#hospital_one').addClass('hide');
        $('#hospital_two').addClass('hide');
        $hospital = $("#hospital_prio_dropdown").val();

        $('.inc_one_temp_hospital input').val('');
        $('.inc_two_temp_hospital input').val('');

        if ($hospital == 'priority_one') {
            $('#hospital_one').removeClass('hide');
        } else if ($hospital == 'priority_two') {
            $('#hospital_two').removeClass('hide');
        }
...
*/
    ...
    $('#container').on("click", ".profiletab,.incoming_call_anchor", function() {
        //        $('.break_lnk').css({'display': 'none'});
        //        $('#mt_atnd_calls').css({'display': 'none'});
        $('.dash_lnk').show();
        $('#mt_atnd_calls').show();
...
function equipments_by_type() {
    ...
    xhttprequest($(this), base_url + 'biomedical/equipments_by_type', 'data-qr=output_position=show_breakdown_type&id=' + $equipments_name);
}
...
$(document).on("focus", "#at_scene", function() {
    ...
    var $stdate = new Date($st_base_dateime);
    var $stdate_limit = new Date($stdate.getTime() + 180 * 60000);



    $('#at_scene').datetimepicker({
        dateFormat: "yy-mm-dd",
        timeFormat: "HH:mm:ss",
        minDate: $stdate,
        //maxDate: 0,
        maxDate: $stdate_limit,
...
$(document).on("focus", "#from_scene", function() {
    ...
    var $st_base_dateime = $("#start_from_base").val();
    var $stdate = new Date($fmdate);
    var $stdate_limit = new Date($stdate.getTime() + 10 * 60000);

    // $("#from_scene" ).datepicker( "destroy" );
    //$('#from_scene').last().datepicker('refresh');
    $('#from_scene').datetimepicker({
        dateFormat: "yy-mm-dd",
        timeFormat: "HH:mm:ss",
        minDate: $fmdate,
        maxDate: $stdate_limit
...
$(document).on("focus", "#at_hospitals_ambulance1", function() {
    ...
    $("#hand_over").val($at_hosp_dateime);
    
    var $at_scene_dateime = $("#at_scene").val();

    var $athospdate = new Date($at_scene_dateime);
    var $athospdate_limit = new Date($athospdate.getTime() + 720 * 60000);
    ...
    $('#at_hospitals_ambulance1').datetimepicker({
        ...
        timeFormat: "HH:mm:ss",
        minDate: $athospdate,
        maxDate: $athospdate_limit
            // minTime: jsDate[1],

    });
});
$(document).on("change", "#start_from_base", function() {
        var $at_scene_dateime = $("#inc_datetime").val();
        var $at_hospitals_ambulance1 = $("#start_from_base").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
...
$(document).on("change", "#at_scene", function() {
        var $at_scene_dateime = $("#start_from_base").val();
        var $at_hospitals_ambulance1 = $("#at_scene").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
...
$(document).on("change", "#from_scene", function() {
        var $at_scene_dateime = $("#at_scene").val();
        var $at_hospitals_ambulance1 = $("#from_scene").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
           $('#from_scene').addClass('has_error');
        }else{
            $('#from_scene').removeClass('has_error');
        }
});
$(document).on("change", "#at_hospitals_ambulance1", function() {
        var $at_scene_dateime = $("#at_scene").val();
        var $at_hospitals_ambulance1 = $("#at_hospitals_ambulance1").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
           $('#at_hospitals_ambulance1').addClass('has_error');
        }else{
            $('#at_hospitals_ambulance1').removeClass('has_error');
        }
});
$(document).on("change", "#hand_over", function() {
        var $at_scene_dateime = $("#at_hospitals_ambulance1").val();
        var $at_hospitals_ambulance1 = $("#hand_over").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
           $('#hand_over').addClass('has_error');
        }else{
            $('#hand_over').removeClass('has_error');
        }
});
$(document).on("change", "#back_to_base_epcr", function() {
        var $at_scene_dateime = $("#hand_over").val();
        var $at_hospitals_ambulance1 = $("#back_to_base_epcr").val();
        
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
           $('#back_to_base_epcr').addClass('has_error');
        }else{
            $('#back_to_base_epcr').removeClass('has_error');
        }
});
$(document).on("change", "#back_to_base_not", function() {
        var $at_scene_dateime = $("#hand_over").val();
        var $at_hospitals_ambulance1 = $("#back_to_base_not").val();
        if((new Date($at_hospitals_ambulance1).getTime()< new Date($at_scene_dateime).getTime())){
           $('#back_to_base_not').addClass('has_error');
        }else{
            $('#back_to_base_not').removeClass('has_error');
        }
});
...
$(document).on("focus", "#hand_over", function() {
    ...
    var $handoverdate_limit = new Date($handoverdate.getTime() + 15 * 60000);
    ...
    $('.HandoverDate').datetimepicker({
        ...
        maxDate: $handoverdate_limit
            // minTime: jsDate[1],

    });
});

$(document).on("focus", "#back_to_base_epcr", function() {
    $('#back_to_base_epcr').val("");
    $("#back_to_base_epcr").datepicker( "destroy" );   
    var $back_to_base_dateime = $("#hand_over").val();
    if ($back_to_base_dateime == '') {
        var $back_to_base_dateime = $("#at_scene").val();
    }
   

    var $hospitals_ambulance =  $("#at_hospitals_ambulance1").val(); 
    var $backtobasedate = new Date($hospitals_ambulance);
    var $backtobasedate_limit = new Date($backtobasedate.getTime() + 720 * 60000);
    

    $('#back_to_base_epcr').datetimepicker({
        dateFormat: "yy-mm-dd",
        timeFormat: "HH:mm:ss",
        minDate: $backtobasedate,
        maxDate: $backtobasedate_limit
            // minTime: jsDate[1],
...
$(document).on("focus", "#back_to_base_not", function() {
...
function epcr_view_change() {
    ...
    var $inc_ref_id = $("#inc_ref_id").val();
    var $reopen = $("#reopen").val();
    var $ambt_id = $("#ambt_id").val();
    xhttprequest($(this), base_url + 'Job_closer/epcr_view_change', 'epcr_call_type=' + $epcr_call_type + '&inc_ref_id=' + $inc_ref_id + '&reopen=' + $reopen + '&ambt_id=' + $ambt_id);
...
function remove_mandatory_fields_new() {
    ...
    if ($provider == '31' || $provider == '26' || $provider == '16' || $provider == '25') {
        ...
        //$('#inc_area_type').addClass('filter_required');
...
function serch_by_amb_no(ft) {
    ...
    $('#get_ambu_details').attr('href', base_url + 'inc/get_inc_ambu?amb_id=' + $ft_id + '&showprocess=yes&inc_type=' + $inc_type + '&amb_tp=' + $amb_type + '&lat=' + $lat + '&lng=' + $lng + '&inc_status=' + $status);
    $("#get_ambu_details").click();
}

function serch_by_baselocation_no(ft) {
    $ft_id = ft['id'];
    xhttprequest($(this), base_url + 'amb/load_baselocation_amb', 'output_position=content&base_id=' + $ft_id);
    $ft_id = ft['id'];
    var $lat = $("#lat").val();
    console.log($lat);
    var $lng = $("#lng").val();
    ...
    $('#get_ambu_details').attr('href', base_url + 'inc/get_inc_ambu?base_id=' + $ft_id + '&showprocess=yes&inc_type=' + $inc_type + '&amb_tp=' + $amb_type + '&lat=' + $lat + '&lng=' + $lng + '&inc_status=' + $status);
    $("#get_ambu_details").click();
}

function show_default_ambulance(amb) {
    var $lat = $("#lat").val();
    console.log($lat);
    var $lng = $("#lng").val();
    ...
    $('#get_ambu_details').attr('href', base_url + 'inc/get_inc_ambu?base_id=' + amb + '&showprocess=yes&inc_type=' + $inc_type + '&amb_tp=' + $amb_type + '&lat=' + $lat + '&lng=' + $lng + '&inc_status=' + $status);
    $("#get_ambu_details").click();
}
...
function base_pvt_hos_baselocation(ft) {
    $ft_id = ft['id'];
    var inc_lat = $('#add_inc_details #lat').val();
    var inc_lng = $('#add_inc_details #lng').val();
    var inc_amb = $('#base_selected_amb').val();

    var base_lat = $('#selected_ambulance_address_block #base_lat').val();
    var base_lng = $('#selected_ambulance_address_block #base_lng').val();

    xhttprequest($(this), base_url + 'amb/pvt_load_baselocation_amb_address', 'output_position=content&base_id=' + $ft_id + '&inc_lat=' + inc_lat + '&inc_lng=' + inc_lng + '&base_lat=' + base_lat + '&base_lng=' + base_lng + '&inc_amb=' + inc_amb);
}

function hospital_avaibility() {
    //return true;
    var $host = $("#host_one").val();
    console.log($host);
...
function hospital_avaibility_new() {
    //return true;
    var $host = $("#host_one").val();
    console.log($host);
    if ($host == 'Other' || $host == 0) {
        ...
        xhttprequest($(this), base_url + 'hp/ero_other_hospital', 'output_position=hospital_details');
         ...
         xhttprequest($(this), base_url + 'hp/ero_hospital_new', 'output_position=hospital_details&host='+$host);
    }
}

function hospital_avaibility_two() {
    //return true;
    var $host = $("#host_two").val();
    //console.log($host);
    if ($host == 'Other' || $host == 0) {

        xhttprequest($(this), base_url + 'hp/ero_other_hospital_two', 'output_position=hospital_details_two');
    } else {
         xhttprequest($(this), base_url + 'hp/ero_hospital1', 'output_position=hospital_details_two&host='+$host);
    }
}
function hospital_avaibility_two_new() {
    //return true;
    var $host = $("#host_two").val();
    //console.log($host);
    if ($host == 'Other' || $host == 0) {
        ...
        xhttprequest($(this), base_url + 'hp/ero_other_hospital_two', 'output_position=hospital_details_two');
         ...
         xhttprequest($(this), base_url + 'hp/ero_hospital1_new', 'output_position=hospital_details_two&host='+$host);
    }
}
...
function show_emso_id() {
    ...
    var $emt_ref_id = $("#emt_list").val();
    //console.log($emt_ref_id);
    if ($emt_ref_id == 'Other' || $emt_ref_id == 0 || $emt_ref_id == 'Not Available') {
...
function district_wise_hospital(ft) {
    ...
    $chief_complete = $("#inter_chief_complete_outer .mi_autocomplete ").val();
    xhttprequest($(this), base_url + 'hp/district_wise_hospital', 'output_position=current_facility_box&district_id=' + $district_id + '&chief_complete=' + $chief_complete);
}
...
function drop_district_wise_hospital(ft) {
    ...
    var $district_id = ft['id'];
    $chief_complete = $("#inter_chief_complete_outer .mi_autocomplete ").val();
    xhttprequest($(this), base_url + 'hp/drop_district_wise_hospital', 'output_position=current_facility_box&district_id=' + $district_id + '&chief_complete=' + $chief_complete);
}
...
function district_wise_hospital_new(ft) {
    ...
    var $district_id = ft['id'];
    $chief_complete = $("#inter_chief_complete_outer .mi_autocomplete ").val();
    xhttprequest($(this), base_url + 'hp/district_wise_hospital_new', 'output_position=new_facility_box&district_id=' + $district_id + '&chief_complete=' + $chief_complete);
}
...
function district_wise_ambulance(ft) {

    var $district_id = ft['id'];;
    xhttprequest($(this), base_url + 'auto/get_dist_ambs', 'output_position=ambulancelist&district_id=' + $district_id);
}

function ambulance_wise_baselocation(ft) {

    var $district_id = ft['id'];;
    xhttprequest($(this), base_url + 'auto/get_dist_amb', 'output_position=ambulancelist&district_id=' + $district_id);
}
...
function ero_standard_summary_change(ft) {
    ...
    if (ft['id'] == '69') {
        ...
        $("#sum").val("Caller wants to complaint against the Madhya Pradesh  EMS services, call transferred to Grievance Desk");
        $('#problem_reporting_call .forward_button').removeClass('hide');
        $('#problem_reporting_call .save_button').addClass('hide');
    } else if (ft['id'] == '70') {
        $("#sum").val("call transferred to FDA Desk");
...
function get_lbs_data(){
    
     var $caller_no = $("#caller_no").val();
      xhttprequest($(this), base_url + 'calls/save_call_details', "caller[cl_mobile_number]="+$caller_no+"&caller[parent_purpose]=EMG");
}
...
function change_purpose_call() {
    ...
    if ($parent_purpose != 'EMG') {
        ...
        $('#caller_relation').removeClass('has_error');
        $('#caller_relation').removeClass('filter_required');
        $('#caller_relation_div').addClass('hide');
    } else {
        
        $('#caller_relation').addClass('has_error');
        $('#caller_relation').addClass('filter_required');
        $('#caller_relation_div').removeClass('hide');
    }
...
$(document).ready(function() {
    ...
    if (window.File && window.FileList && window.FileReader) {
        ...
        $("body").on("change", '.files_amb_photo', function(e) {
            ...
            $(this).parents(".upload_images_block").find('.pip').remove();
            for (var i = 0; i < filesLength; i++) {
                var f = files[i]
                var fileReader = new FileReader();
                fileReader.onload = (function(e) {
...
function police_cheif_complaint_filter() {
    ...
    if ($police_chief_comp == '19' || $police_chief_comp == '9' || $police_chief_comp == '17' || $police_chief_comp == '8' || $police_chief_comp == '12' || $police_chief_comp == '11' || $police_chief_comp == '14') {
        ...
        $('#help_complete').parent().find('input').addClass('filter_required');
        $('#ambulance_state').find('input').addClass('filter_required');
        $('#incient_dist').find('input').addClass('filter_required');
        $('#pc_mobile_no').addClass('filter_required');
        $('#pc_call_receiver_name').addClass('filter_required');
        $('#service').addClass('filter_required');

        $('#pc_assign_time').addClass('has_error');
        $('#pc_mobile_no').addClass('has_error');
        $('#service').addClass('has_error');
        $('#incient_police').parent().find('input').addClass('has_error');
        ...
        $('#help_complete').parent().find('input').removeClass('filter_required');
        $('#ambulance_state').find('input').removeClass('filter_required');
        $('#incient_dist').find('input').removeClass('filter_required');
        $('#pc_mobile_no').removeClass('filter_required');
        $('#pc_call_receiver_name').removeClass('filter_required');
...
function denialamb(amb_no, amb_district, hp_name, amb_default_mobile, amb_pilot_mobile) {
    ...
    $(this).val('check all');
    $("#conversation_done_emso option:selected").removeAttr("selected");
    $("#conversation_emso input").val('');
    $("#denial_remark").val('');
...
function showerc() {
    document.getElementById("emso_challenge").value = "";
    document.getElementById("pilot_challenge").value = "";
    document.getElementById("equipment_challenge").value = "";
    document.getElementById("tech_challenge").value = "";
    $("#erc").show();
    //$("#erc_emso").show();
    //$("#erc_pilot").hide();
    $("#prc").hide();
...
function onscene_ambulance_change() {
    //  alert(ft);

    var $amb_id = $("#amb_id").val();
    xhttprequest($(this), base_url + 'fleet/onscene_care_baselocation', 'amb_id=' + $amb_id);
}

function copy_text(copy_div) {

    var $temp = $("<input>");
    $("body").append($temp);
    $temp.val($('#' + copy_div).text()).select();
    document.execCommand("copy");
    $temp.remove();

    /* Get the text field */
    //  
    //  var copyText = document.getElementById(copy_div).innerHTML;
