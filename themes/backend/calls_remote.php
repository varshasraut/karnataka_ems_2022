...
<div class="contentpan remote_content">
    ...
    <div class="hide_button show_button" style="left: 53px;"></div>
        <div id="rightsidecontent" style="margin-left: 50px;">
          <div class="content" align="left" >
              ...
              <div id="procesing_lbs" style="position: absolute;background: #fff;top: 0px;bottom: 0px;width: 100%;opacity: 0.8;font-size: 20px;color: #000;line-height: 500px;text-align: center;z-index: 10000000; display:none;">Waiting for address...</div>
